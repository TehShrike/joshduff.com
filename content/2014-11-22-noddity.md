...
I've been a Wikipedia editor for years, and my first instinct when I see poor grammar or overly-long paragraphs is to click an "edit" button and fix the problem.  Most sites with typos don't have an edit button.

My posts have typos, and I want anyone to be able to feel the catharsis of fixing someone else's mistakes on the internet.
...
This is, in my mind, MediaWiki/Wikipedia's killer feature.  Any page can be embedded in any other page - and since you can pass parameters to the embedded document, you can use this single feature to build domain-specific languages for writing content.
...
Since writing it, I've realied that expire-unused-keys is a great low-level building block in many caching solutions.  I'm kind of proud of that library.
...
I feel a special lift when I get to be a multiplier to someone else.  When I play with a band I can make sweet rock and roll.  When I write software I can give people a tool they can use to solve their own problems.
...
I have no expectation of making money from Noddity, but I still have things I want to improve - easier theming, easier plugins, better parsing of wiki-links in the Markdown content.
