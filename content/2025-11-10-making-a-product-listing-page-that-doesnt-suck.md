...
That's right, the One Weird Trick Computer Scientists Don't Want You To Know: if you have fewer than ~10,000 items, your listing pages don't actually need to query a fancy database with indexes, you can keep have the entire list in memory locally and loop over it in the dumbest possible way pulling out the items that match your filters.
