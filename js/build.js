...
t.createKeyStream().on("data",function(e){t.del(e)})}}},{"level-js":6,levelup:28}],2:[function(t){var e,n=t("noddity-butler"),r=t("levelup"),i=t("level-js"),o=t("noddity-linkifier"),s=t("localstorage-down"),a=t("./routing"),u=t("./mainViewModel"),c=t("level-sublevel"),h=t("bowser").browser,f=noddityConfig,l=h.msie&&"11.0"===h.version
window.indexedDB&&!l?(e=i,console.log("Storing Noddity content in an IndexedDB")):(e=function(t){return new s(t)},console.log("Storing Noddity content in localstorage"))
var p=c(r("noddity-content",{db:e})),d=f.title.replace(/[^\w]+/g,""),g=f.debug?{refreshEvery:3e4}:void 0,v=new n(f.noddityRoot,p.sublevel(d),g),m=new o(f.pathPrefix+f.pagePathPrefix),y=new u(v,m),b=a()
b.on("current",y.setCurrent),f.debug&&(window.debug=t("./debug"))},{"./debug":1,"./mainViewModel":3,"./routing":4,bowser:5,"level-js":6,"level-sublevel":14,levelup:28,"localstorage-down":52,"noddity-butler":63,"noddity-linkifier":89}],3:[function(t,e){function n(){}var r=t("ractive"),i=noddityConfig,o=t("noddity-renderer")
...
return i.sidebar&&t.getPost(i.sidebar,function(t,e){t?g.set("html",t.message):h.populateRootRactive(e,g)}),e.on("link",function(e){t.getPost(e,n)}),t.on("post changed",c),t.on("index changed",a),{setCurrent:u}}},{"noddity-renderer":90,ractive:100}],4:[function(t,e){var n=noddityConfig,r=t("events").EventEmitter
...
return setTimeout(e.go.bind(e),0),t}},{events:105}],5:[function(t,e){!function(t,n){"undefined"!=typeof e&&e.exports?e.exports.browser=n():"function"==typeof define?define(n):this[t]=n()}("bowser",function(){function t(t){function n(e){var n=t.match(e)
return n&&n.length>1&&n[1]||""}var r,i=n(/(ipod|iphone|ipad)/i).toLowerCase(),o=/like android/i.test(t),s=!o&&/android/i.test(t),a=n(/version\/(\d+(\.\d+)?)/i),u=/tablet/i.test(t),c=!u&&/[^-]mobi/i.test(t);/opera|opr/i.test(t)?r={name:"Opera",opera:e,version:a||n(/(?:opera|opr)[\s\/](\d+(\.\d+)?)/i)}:/windows phone/i.test(t)?r={name:"Windows Phone",windowsphone:e,msie:e,version:n(/iemobile\/(\d+(\.\d+)?)/i)}:/msie|trident/i.test(t)?r={name:"Internet Explorer",msie:e,version:n(/(?:msie |rv:)(\d+(\.\d+)?)/i)}:/chrome|crios|crmo/i.test(t)?r={name:"Chrome",chrome:e,version:n(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)}:i?(r={name:"iphone"==i?"iPhone":"ipad"==i?"iPad":"iPod"},a&&(r.version=a)):/sailfish/i.test(t)?r={name:"Sailfish",sailfish:e,version:n(/sailfish\s?browser\/(\d+(\.\d+)?)/i)}:/seamonkey\//i.test(t)?r={name:"SeaMonkey",seamonkey:e,version:n(/seamonkey\/(\d+(\.\d+)?)/i)}:/firefox|iceweasel/i.test(t)?(r={name:"Firefox",firefox:e,version:n(/(?:firefox|iceweasel)[ \/](\d+(\.\d+)?)/i)},/\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(t)&&(r.firefoxos=e)):/silk/i.test(t)?r={name:"Amazon Silk",silk:e,version:n(/silk\/(\d+(\.\d+)?)/i)}:s?r={name:"Android",version:a}:/phantom/i.test(t)?r={name:"PhantomJS",phantom:e,version:n(/phantomjs\/(\d+(\.\d+)?)/i)}:/blackberry|\bbb\d+/i.test(t)||/rim\stablet/i.test(t)?r={name:"BlackBerry",blackberry:e,version:a||n(/blackberry[\d]+\/(\d+(\.\d+)?)/i)}:/(web|hpw)os/i.test(t)?(r={name:"WebOS",webos:e,version:a||n(/w(?:eb)?osbrowser\/(\d+(\.\d+)?)/i)},/touchpad\//i.test(t)&&(r.touchpad=e)):r=/bada/i.test(t)?{name:"Bada",bada:e,version:n(/dolfin\/(\d+(\.\d+)?)/i)}:/tizen/i.test(t)?{name:"Tizen",tizen:e,version:n(/(?:tizen\s?)?browser\/(\d+(\.\d+)?)/i)||a}:/safari/i.test(t)?{name:"Safari",safari:e,version:a}:{},/(apple)?webkit/i.test(t)?(r.name=r.name||"Webkit",r.webkit=e,!r.version&&a&&(r.version=a)):!r.opera&&/gecko\//i.test(t)&&(r.name=r.name||"Gecko",r.gecko=e,r.version=r.version||n(/gecko\/(\d+(\.\d+)?)/i)),s||r.silk?r.android=e:i&&(r[i]=e,r.ios=e)
var h=""
i?(h=n(/os (\d+([_\s]\d+)*) like mac os x/i),h=h.replace(/[_\s]/g,".")):s?h=n(/android[ \/-](\d+(\.\d+)*)/i):r.windowsphone?h=n(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i):r.webos?h=n(/(?:web|hpw)os\/(\d+(\.\d+)*)/i):r.blackberry?h=n(/rim\stablet\sos\s(\d+(\.\d+)*)/i):r.bada?h=n(/bada\/(\d+(\.\d+)*)/i):r.tizen&&(h=n(/tizen[\/\s](\d+(\.\d+)*)/i)),h&&(r.osversion=h)
var f=h.split(".")[0]
return u||"ipad"==i||s&&(3==f||4==f&&!c)||r.silk?r.tablet=e:(c||"iphone"==i||"ipod"==i||s||r.blackberry||r.webos||r.bada)&&(r.mobile=e),r.msie&&r.version>=10||r.chrome&&r.version>=20||r.firefox&&r.version>=20||r.safari&&r.version>=6||r.opera&&r.version>=10||r.ios&&r.osversion&&r.osversion.split(".")[0]>=6?r.a=e:r.msie&&r.version<10||r.chrome&&r.version<20||r.firefox&&r.version<20||r.safari&&r.version<6||r.opera&&r.version<10||r.ios&&r.osversion&&r.osversion.split(".")[0]<6?r.c=e:r.x=e,r}var e=!0,n=t("undefined"!=typeof navigator?navigator.userAgent:"")
return n._detect=t,n})},{}],6:[function(t,e){function n(t){if(!(this instanceof n))return new n(t)
...
"DESC"===this._order?t=o:e=o}else i&&(t=this._start,e=this._end,this._start>this._end&&(t=this._end,e=this._start));(t||e)&&(this._keyRange=this.options.keyRange||this.db.makeKeyRange({lower:t,upper:e})),this.iterator=this.db.iterate(this.onItem.bind(this),{keyRange:this._keyRange,autoContinue:!1,order:this._order,onError:function(t){console.log("horrible error",t)}})},n.prototype.onItem=function(t,e){return!e&&this.callback?(this.callback(),void(this.callback=!1)):(this._limit&&this._limit>0?this._limit>this._count&&this.callback(!1,e.key,e.value):this.callback(!1,e.key,e.value),this._limit&&this._count++,void(e&&e.continue()))},n.prototype._next=function(t){return t?(this._started||(this.createIterator(),this._started=!0),void(this.callback=t)):new Error("next() requires a callback argument")}},{"abstract-leveldown":10,util:132}],8:[function(t,e){(function(t){function n(t){this._db=t,this._operations=[],this._written=!1}n.prototype._checkWritten=function(){if(this._written)throw new Error("write() already called on this batch")},n.prototype.put=function(t,e){this._checkWritten()
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Jd0h76"))},{Jd0h76:111}],9:[function(t,e){(function(t){function n(t){this.db=t,this._ended=!1,this._nexting=!1}n.prototype.next=function(e){var n=this
...
return this._ended?e(new Error("end() already called on iterator")):(this._ended=!0,"function"==typeof this._end?this._end(e):void t.nextTick(e))},e.exports=n}).call(this,t("Jd0h76"))},{Jd0h76:111}],10:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
...
if(this._isBuffer(t)){if(0===t.length)return new Error(e+" cannot be an empty Buffer")}else if(""===String(t))return new Error(e+" cannot be an empty String")},e.exports.AbstractLevelDOWN=i,e.exports.AbstractIterator=o}).call(this,t("Jd0h76"),t("buffer").Buffer)},{"./abstract-chained-batch":8,"./abstract-iterator":9,Jd0h76:111,buffer:102}],11:[function(t,e){!function(t,n,r){"function"==typeof define?define(n):"undefined"!=typeof e&&e.exports?e.exports=n():r[t]=n()}("IDBStore",function(){"use strict"
...
return t}
return e.version=e.prototype.version,e},this)},{}],12:[function(t,e){function n(t){return r.isBuffer(t)||/\[object (.+Array|Array.+)\]/.test(Object.prototype.toString.call(t))}var r=t("buffer").Buffer
e.exports=n},{buffer:102}],13:[function(t,e){function n(t,e,n,r){var i={type:t,key:e,value:n,options:r}
...
i.clear=function(){this._operations=[]},i.write=function(t){this._sdb.batch(this._operations,t)},e.exports=r},{}],14:[function(t,e){(function(n){var r=(t("events").EventEmitter,n.nextTick,t("./sub")),i=t("./batch"),o=t("level-fix-range"),s=t("level-hooks")
...
var h=u.batch
return u.batch=function(t,e,n){return Array.isArray(t)?(t.forEach(function(t){t.prefix&&("function"==typeof t.prefix.prefix?t.key=t.prefix.prefix(t.key):"string"==typeof t.prefix&&(t.key=t.prefix+t.key))}),void h.call(u,t,e,n)):new i(u)},u}}).call(this,t("Jd0h76"))},{"./batch":13,"./sub":25,Jd0h76:111,events:105,"level-fix-range":15,"level-hooks":17}],15:[function(t,e){var n=t("clone")
e.exports=function(t){t=n(t)
var e=t.reverse,r=t.max||t.end,i=t.min||t.start,o=[i,r]
return null!=i&&null!=r&&o.sort(),e&&(o=o.reverse()),t.start=o[0],t.end=o[1],delete t.min,delete t.max,t}},{clone:16}],16:[function(t,e){(function(t){"use strict"
...
var e=function(){}
return e.prototype=t,new e}}).call(this,t("buffer").Buffer)},{buffer:102}],17:[function(t,e){var n=t("string-range")
...
return a(!1,r,e,n)},t.batch=function(t,e,n){return a(!0,t,e,n)}}}},{"string-range":18}],18:[function(t,e,n){{var r=n.range=function(t){return null==t?{}:"string"==typeof r?{min:r,max:r+"ÿ"}:t},i=(n.prefix=function(t,e,r){t=n.range(t)
var i={}
...
n.satisfies=function(t,e){return i(e)(t)}}},{}],19:[function(t,e){function n(t){return null!==t&&("object"==typeof t||"function"==typeof t)}e.exports=n},{}],20:[function(t,e){function n(){for(var t={},e=0;e<arguments.length;e++){var n=arguments[e]
if(i(n))for(var o=r(n),s=0;s<o.length;s++){var a=o[s]
t[a]=n[a]}}return t}var r=t("object-keys"),i=t("./has-keys")
e.exports=n},{"./has-keys":19,"object-keys":21}],21:[function(t,e){e.exports=Object.keys||t("./shim")},{"./shim":24}],22:[function(t,e){var n=Object.prototype.hasOwnProperty,r=Object.prototype.toString
...
else for(var a in t)n.call(t,a)&&e.call(i,t[a],a,t)}},{}],23:[function(t,e){var n=Object.prototype,r=n.hasOwnProperty,i=n.toString,o=function(t){return t!==t},s={"boolean":1,number:1,string:1,undefined:1},a=e.exports={}
...
return r||t>=e&&n>=t},a.object=function(t){return t&&"[object Object]"===i.call(t)},a.hash=function(t){return a.object(t)&&t.constructor===Object&&!t.nodeType&&!t.setInterval},a.regexp=function(t){return"[object RegExp]"===i.call(t)},a.string=function(t){return"[object String]"===i.call(t)}},{}],24:[function(t,e){!function(){"use strict"
...
return s&&o(a,function(e){r.call(t,e)&&n.push(e)}),n},e.exports=n}()},{foreach:22,is:23}],25:[function(t,e){function n(t,e,r){if("string"==typeof r&&(console.error("db.sublevel(name, seperator<string>) is depreciated"),console.error("use db.sublevel(name, {sep: separator})) if you must"),r={sep:r}),!(this instanceof n))return new n(t,e,r)
...
e.exports=n},{"./batch":13,events:105,"level-fix-range":15,"string-range":18,util:132,xtend:20}],26:[function(t,e){function n(t){this._levelup=t,this.batch=t.db.batch(),this.ops=[]}var r=t("./util"),i=t("./errors").WriteError,o=r.getOptions,s=r.dispatchError
...
try{this.batch.write(function(r){return r?s(e,new i(r),t):(e.emit("batch",n),void(t&&t()))})}catch(r){throw new i(r)}},e.exports=n},{"./errors":27,"./util":30}],27:[function(t,e){var n=t("errno").create,r=n("LevelUPError"),i=n("NotFoundError",r)
i.prototype.notFound=!0,i.prototype.status=404,e.exports={LevelUPError:r,InitializationError:n("InitializationError",r),OpenError:n("OpenError",r),ReadError:n("ReadError",r),WriteError:n("WriteError",r),NotFoundError:i,EncodingError:n("EncodingError",r)}},{errno:38}],28:[function(t,e){(function(n){function r(t,e){return"function"==typeof t?t:e}function i(t,e,r){if(!(this instanceof i))return new i(t,e,r)
var o
...
return t=u(this.options,t),new m(t,this,function(t){return e.db.iterator(t)})},i.prototype.keyStream=i.prototype.createKeyStream=function(t){return this.createReadStream(u(t,{keys:!0,values:!1}))},i.prototype.valueStream=i.prototype.createValueStream=function(t){return this.createReadStream(u(t,{keys:!1,values:!0}))},i.prototype.writeStream=i.prototype.createWriteStream=function(t){return new y(u(t),this)},i.prototype.toString=function(){return"LevelUP"},e.exports=i,e.exports.copy=b.copy,e.exports.destroy=o("destroy"),e.exports.repair=o("repair")}).call(this,t("Jd0h76"))},{"./batch":26,"./errors":27,"./read-stream":29,"./util":30,"./write-stream":31,Jd0h76:111,"deferred-leveldown":33,events:105,prr:39,util:132,xtend:50}],29:[function(t,e){function n(t,e,i){if(!(this instanceof n))return new n(t,e,i)
...
e.exports={defaultOptions:w,copy:i,getOptions:o,getLevelDOWN:s,dispatchError:a,encodeKey:h,encodeValue:f,isValueAsBuffer:d,isKeyAsBuffer:g,decodeValue:p,decodeKey:l}}).call(this,t("Jd0h76"),t("buffer").Buffer)},{"../package.json":51,"./errors":27,Jd0h76:111,buffer:102,leveldown:101,"leveldown/package":101,semver:101,xtend:50}],31:[function(t,e){(function(n,r){function i(t,e){if(!(this instanceof i))return new i(t,e)
...
e&&t.pipe(u(function(t,r){return t?(n.writable=!1,n.emit("error",t)):(n._options.fstreamRoot&&e.indexOf(n._options.fstreamRoot)>-1&&(e=e.substr(n._options.fstreamRoot.length+1)),void n.write({key:e,value:r.slice(0)}))}))},i.prototype.toString=function(){return"LevelUP.WriteStream"},e.exports=i}).call(this,t("Jd0h76"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./util":30,Jd0h76:111,bl:32,stream:129,util:132,xtend:50}],32:[function(t,e){(function(n){function r(t){if(!(this instanceof r))return new r(t)
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._write?this._write(n):"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Jd0h76"))},{Jd0h76:111}],35:[function(t,e){e.exports=t(9)},{Jd0h76:111}],36:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
if("string"!=typeof t)throw new Error("constructor requires a location string argument")
...
return n})},{}],40:[function(t,e){(function(n){function r(t){return this instanceof r?(u.call(this,t),c.call(this,t),t&&t.readable===!1&&(this.readable=!1),t&&t.writable===!1&&(this.writable=!1),this.allowHalfOpen=!0,t&&t.allowHalfOpen===!1&&(this.allowHalfOpen=!1),void this.once("end",i)):new r(t)}function i(){this.allowHalfOpen||this._writableState.ended||n.nextTick(this.end.bind(this))}function o(t,e){for(var n=0,r=t.length;r>n;n++)e(t[n],n)}e.exports=r
...
a.inherits(r,u),o(s(c.prototype),function(t){r.prototype[t]||(r.prototype[t]=c.prototype[t])})}).call(this,t("Jd0h76"))},{"./_stream_readable":42,"./_stream_writable":44,Jd0h76:111,"core-util-is":45,inherits:46}],41:[function(t,e){function n(t){return this instanceof n?void r.call(this,t):new n(t)}e.exports=n
var r=t("./_stream_transform"),i=t("core-util-is")
i.inherits=t("inherits"),i.inherits(n,r),n.prototype._transform=function(t,e,n){n(null,t)}},{"./_stream_transform":43,"core-util-is":45,inherits:46}],42:[function(t,e){(function(n){function r(e){e=e||{}
var n=e.highWaterMark
this.highWaterMark=n||0===n?n:16384,this.highWaterMark=~~this.highWaterMark,this.buffer=[],this.length=0,this.pipes=null,this.pipesCount=0,this.flowing=!1,this.ended=!1,this.endEmitted=!1,this.reading=!1,this.calledRead=!1,this.sync=!0,this.needReadable=!1,this.emittedReadable=!1,this.readableListening=!1,this.objectMode=!!e.objectMode,this.defaultEncoding=e.defaultEncoding||"utf8",this.ranOut=!1,this.awaitDrain=0,this.readingMore=!1,this.decoder=null,this.encoding=null,e.encoding&&(T||(T=t("string_decoder/").StringDecoder),this.decoder=new T(e.encoding),this.encoding=e.encoding)}function i(t){return this instanceof i?(this._readableState=new r(t,this),this.readable=!0,void O.call(this)):new i(t)}function o(t,e,n,r,i){var o=c(e,n)
if(o)t.emit("error",o)
...
var O=t("stream"),A=t("core-util-is")
A.inherits=t("inherits")
var T
A.inherits(i,O),i.prototype.push=function(t,e){var n=this._readableState
...
null!==t.writechunk&&t.writecb&&!t.transforming?(t.transforming=!0,this._transform(t.writechunk,t.writeencoding,t.afterTransform)):t.needTransform=!0}},{"./_stream_duplex":40,"core-util-is":45,inherits:46}],44:[function(t,e){(function(n){function r(t,e,n){this.chunk=t,this.encoding=e,this.callback=n}function i(t,e){t=t||{}
...
"function"==typeof t?(n=t,t=null,e=null):"function"==typeof e&&(n=e,e=null),"undefined"!=typeof t&&null!==t&&this.write(t,e),r.ending||r.finished||b(this,r,n)}}).call(this,t("Jd0h76"))},{"./_stream_duplex":40,Jd0h76:111,buffer:102,"core-util-is":45,inherits:46,stream:129}],45:[function(t,e,n){(function(t){function e(t){return Array.isArray(t)}function r(t){return"boolean"==typeof t}function i(t){return null===t}function o(t){return null==t}function s(t){return"number"==typeof t}function a(t){return"string"==typeof t}function u(t){return"symbol"==typeof t}function c(t){return void 0===t}function h(t){return f(t)&&"[object RegExp]"===m(t)}function f(t){return"object"==typeof t&&null!==t}function l(t){return f(t)&&"[object Date]"===m(t)}function p(t){return f(t)&&("[object Error]"===m(t)||t instanceof Error)}function d(t){return"function"==typeof t}function g(t){return null===t||"boolean"==typeof t||"number"==typeof t||"string"==typeof t||"symbol"==typeof t||"undefined"==typeof t}function v(e){return t.isBuffer(e)}function m(t){return Object.prototype.toString.call(t)}n.isArray=e,n.isBoolean=r,n.isNull=i,n.isNullOrUndefined=o,n.isNumber=s,n.isString=a,n.isSymbol=u,n.isUndefined=c,n.isRegExp=h,n.isObject=f,n.isDate=l,n.isError=p,n.isFunction=d,n.isPrimitive=g,n.isBuffer=v}).call(this,t("buffer").Buffer)},{buffer:102}],46:[function(t,e){e.exports="function"==typeof Object.create?function(t,e){t.super_=e,t.prototype=Object.create(e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}})}:function(t,e){t.super_=e
var n=function(){}
n.prototype=e.prototype,t.prototype=new n,t.prototype.constructor=t}},{}],47:[function(t,e){e.exports=Array.isArray||function(t){return"[object Array]"==Object.prototype.toString.call(t)}},{}],48:[function(t,e,n){function r(t){if(t&&!u(t))throw new Error("Unknown encoding: "+t)}function i(t){return t.toString(this.encoding)}function o(t){var e=this.charReceived=t.length%2
...
e+=r.slice(0,n).toString(i)}return e}},{buffer:102}],49:[function(t,e,n){n=e.exports=t("./lib/_stream_readable.js"),n.Readable=n,n.Writable=t("./lib/_stream_writable.js"),n.Duplex=t("./lib/_stream_duplex.js"),n.Transform=t("./lib/_stream_transform.js"),n.PassThrough=t("./lib/_stream_passthrough.js")},{"./lib/_stream_duplex.js":40,"./lib/_stream_passthrough.js":41,"./lib/_stream_readable.js":42,"./lib/_stream_transform.js":43,"./lib/_stream_writable.js":44}],50:[function(t,e){function n(){for(var t={},e=0;e<arguments.length;e++){var n=arguments[e]
for(var r in n)n.hasOwnProperty(r)&&(t[r]=n[r])}return t}e.exports=n},{}],51:[function(t,e){e.exports={name:"levelup",description:"Fast & simple storage - a Node.js-style LevelDB wrapper",version:"0.18.6",contributors:[{name:"Rod Vagg",email:"r@va.gg",url:"https://github.com/rvagg"},{name:"John Chesley",email:"john@chesl.es",url:"https://github.com/chesles/"},{name:"Jake Verbaten",email:"raynos2@gmail.com",url:"https://github.com/raynos"},{name:"Dominic Tarr",email:"dominic.tarr@gmail.com",url:"https://github.com/dominictarr"},{name:"Max Ogden",email:"max@maxogden.com",url:"https://github.com/maxogden"},{name:"Lars-Magnus Skog",email:"lars.magnus.skog@gmail.com",url:"https://github.com/ralphtheninja"},{name:"David Björklund",email:"david.bjorklund@gmail.com",url:"https://github.com/kesla"},{name:"Julian Gruber",email:"julian@juliangruber.com",url:"https://github.com/juliangruber"},{name:"Paolo Fragomeni",email:"paolo@async.ly",url:"https://github.com/hij1nx"},{name:"Anton Whalley",email:"anton.whalley@nearform.com",url:"https://github.com/No9"},{name:"Matteo Collina",email:"matteo.collina@gmail.com",url:"https://github.com/mcollina"},{name:"Pedro Teixeira",email:"pedro.teixeira@gmail.com",url:"https://github.com/pgte"},{name:"James Halliday",email:"mail@substack.net",url:"https://github.com/substack"}],repository:{type:"git",url:"https://github.com/rvagg/node-levelup.git"},homepage:"https://github.com/rvagg/node-levelup",keywords:["leveldb","stream","database","db","store","storage","json"],main:"lib/levelup.js",dependencies:{bl:"~0.8.1","deferred-leveldown":"~0.2.0",errno:"~0.1.1",prr:"~0.0.0","readable-stream":"~1.0.26",semver:"~2.3.1",xtend:"~3.0.0"},devDependencies:{leveldown:"~0.10.0",bustermove:"*",tap:"*",referee:"*",rimraf:"*",async:"*",fstream:"*",tar:"*",mkfiletree:"*",readfiletree:"*","slow-stream":">=0.0.4",delayed:"*",boganipsum:"*",du:"*",memdown:"*","msgpack-js":"*"},browser:{leveldown:!1,"leveldown/package":!1,semver:!1},scripts:{test:"tap test/*-test.js --stderr",functionaltests:"node ./test/functional/fstream-test.js && node ./test/functional/binary-data-test.js && node ./test/functional/compat-test.js",alltests:"npm test && npm run-script functionaltests"},license:"MIT",gitHead:"213e989e2b75273e2b44c23f84f95e35bff7ea11",bugs:{url:"https://github.com/rvagg/node-levelup/issues"},_id:"levelup@0.18.6",_shasum:"e6a01cb089616c8ecc0291c2a9bd3f0c44e3e5eb",_from:"levelup@~0.18.2",_npmVersion:"1.4.14",_npmUser:{name:"rvagg",email:"rod@vagg.org"},maintainers:[{name:"rvagg",email:"rod@vagg.org"}],dist:{shasum:"e6a01cb089616c8ecc0291c2a9bd3f0c44e3e5eb",tarball:"http://registry.npmjs.org/levelup/-/levelup-0.18.6.tgz"},directories:{},_resolved:"https://registry.npmjs.org/levelup/-/levelup-0.18.6.tgz",readme:"ERROR: No README data found!"}},{}],52:[function(t,e){(function(n,r,i){function o(t,e){f.call(this,t)
new i(0)
...
this._put(o,s,e,l)}}p(n)},s.prototype._iterator=function(t){return new o(this,t)},s.destroy=function(t,e){try{Object.keys(localStorage).forEach(function(e){e.substring(0,t.length+1)==t+"!"&&localStorage.removeItem(e)}),e()}catch(n){}},e.exports=s}).call(this,t("Jd0h76"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},t("buffer").Buffer)},{"./localstorage":53,Jd0h76:111,"abstract-leveldown":56,buffer:102,util:132}],53:[function(t,e,n){function r(t){this._partition=t,this._keys=[]
...
for(var e=this._keys.length;e>=0;e--)this._keys[e]===t&&(this._keys.splice(e,1),window.localStorage.removeItem(t))},r.prototype.clear=function(){window.localStorage.clear()},r.prototype.length=function(){return this._keys.length},n.localStorage=r},{}],54:[function(t,e){e.exports=t(34)},{Jd0h76:111}],55:[function(t,e){e.exports=t(9)},{Jd0h76:111}],56:[function(t,e,n){arguments[4][36][0].apply(n,arguments)},{"./abstract-chained-batch":54,"./abstract-iterator":55,Jd0h76:111,buffer:102,xtend:58}],57:[function(t,e){e.exports=t(19)},{}],58:[function(t,e,n){arguments[4][20][0].apply(n,arguments)},{"./has-keys":57,"object-keys":60}],59:[function(t,e){var n=Object.prototype.hasOwnProperty,r=Object.prototype.toString,i=function(t){var e="function"==typeof t&&!(t instanceof RegExp)||"[object Function]"===r.call(t)
...
else for(o in t)n.call(t,o)&&(null===u?e(t[o],o,t):e.call(u,t[o],o,t))}},{}],60:[function(t,e,n){arguments[4][21][0].apply(n,arguments)},{"./shim":62}],61:[function(t,e){var n=Object.prototype.toString
e.exports=function r(t){var e=n.call(t),r="[object Arguments]"===e
return r||(r="[object Array]"!==e&&null!==t&&"object"==typeof t&&"number"==typeof t.length&&t.length>=0&&"[object Function]"===n.call(t.callee)),r}},{}],62:[function(t,e){!function(){"use strict"
...
return i=r(),i.noConflict=function(){return e&&(e[t]=o),i},i})},{}],68:[function(t,e){function n(t){if(!t||"[object Object]"!==i.call(t)||t.nodeType||t.setInterval)return!1
...
return u}},{}],69:[function(t,e){var n=t("stringmap"),r=t("level-sublevel"),i=t("asynquence"),o=t("events").EventEmitter,s=t("expire-unused-keys"),a=t("extend")
...
return v.on("expire",f),g.on("expire",h),y.stop=c,y.get=function(t,e){d.get(t,function(n,r){n&&n.notFound?f(t,l(t,e)):e&&l(t,e)(n,r)})},y.getLocal=function(t,e){d.get(t,l(t,e))},y.refresh=function(t,e){f(t,l(t,e))},y}},{asynquence:67,events:105,"expire-unused-keys":70,extend:68,"level-sublevel":14,stringmap:71}],70:[function(t,e){function n(t){function e(){n=!1}var n=!1
...
return o.touch=o.emit.bind(o,"touch"),o.forget=o.emit.bind(o,"forget"),o.stop=function(){clearInterval(u)},o}},{events:105}],71:[function(t,e){var n=function(){"use strict"
...
"undefined"!=typeof e&&"undefined"!=typeof e.exports&&(e.exports=n)},{}],72:[function(t,e){var n=t("http"),r=t("url"),i=(t("concat-stream"),t("text-metadata-parser"))
...
e.exports.toByteArray=t,e.exports.fromByteArray=n}()},{}],76:[function(t,e){function n(t,e,n){e=void 0===e?0:e,n=void 0===n?t.length:n
...
var s=t("base64-js"),a={hex:r,utf8:i,base64:o}},{"base64-js":75}],80:[function(t,e){e.exports=function(t){return t instanceof Uint8Array}},{}],81:[function(t,e){function n(t,e){if(!t.length)return new Uint8Array(0)
...
return e}e.exports=n},{}],82:[function(t,e){function n(t){return new DataView(t.buffer,0)}function r(t){var e=o.get(t.buffer)
return e||o.set(t.buffer,e=new DataView(t.buffer,0)),e}var i,o
e.exports=i={},o="undefined"==typeof WeakMap?null:new WeakMap,i.get=o?r:n},{}],83:[function(t,e){function n(t,e){return t[e]}function r(t,e){var n=t[e]
...
var v=t("./mapped.js")},{"./mapped.js":82}],84:[function(t,e){function n(t,e,n){return t.subarray(e||0,n||t.length)}e.exports=n},{}],85:[function(t,e){function n(t,e){return u[e||"utf8"](t)}function r(t){for(var e,n="",r=0,i=t.length;i>r;++r)e=t[r],n+=((240&e)>>>4).toString(16),n+=(15&e).toString(16)
return n}function i(t){return a(t)}function o(t){return s.fromByteArray(t)}e.exports=n
var s=t("base64-js"),a=t("to-utf8"),u={hex:r,utf8:i,base64:o}},{"base64-js":75,"to-utf8":76}],86:[function(t,e){function n(t,e,n){return t[n]=e}function r(t,e,n){return t[n]=0>e?e+256:e}function i(t,e,n){var r=v.get(t)
...
var v=t("./mapped.js")},{"./mapped.js":82}],87:[function(t,e){function n(t){for(var e=t.split("\n"),n=!1,r=!1,i={content:"",metadata:{}},o=0;o<e.length&&!r;o++)if(n)r||(r=!/^\s*$/.test(e[o]))
else{var s=/^([^:]+):\s*([^\r\n]+)\s*$/.exec(e[o])
...
e.exports=function(t){return u.extend(t)}},{extend:68}],89:[function(t,e){function n(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
...
return e.linkify=r.bind(null,e,t),e}},{events:105}],90:[function(t,e){function n(t,e){function n(t){u.mixinHtml(t),u.parseTemplate(t),u.mixinChildPosts(t),u.mixinRenderedHtmlEmitter(t),t.on("all child posts fetched",function(t){t.templateElements.forEach(n)})}function i(t,e){var r=u.makeNewMixinObject(t)
...
e.exports=n},{"./mixins":91}],91:[function(t,e){(function(n){function r(t){try{return new d({el:null,data:t.data,template:t.renderedHtml||t.html,preserveWhitespace:!0}).toHTML()}catch(e){return t.emit("error",e),e.message}}function i(t){var e=Object.create(new p)
...
e.exports=function(e,n){return{mixinHtml:a.bind(null,n),makeNewMixinObject:i,mixinRenderedHtmlEmitter:u,parseTemplate:t("./parseTemplate"),mixinChildPosts:s.bind(null,e.getPost),updateEmitterMixin:g(e),mixinTemplateRactive:c,mixinTeardownChildren:h}}}).call(this,t("Jd0h76"))},{"./parseTemplate":94,"./templateToolbox.js":95,"./updateEmitterMixin.js":96,Jd0h76:111,events:105,ractive:92}],92:[function(t,e){!function(t){"use strict"
...
while(a=a.parent)
return v||t._parent&&!t.isolated?n.call(t.data,s)?s:void 0!==i(t,s)?s:void 0:s}}(w,v,k,S),A=function(t){var e,n,r,i,o=[""]
...
for(h();v;){for(v=!1;t=A.pop();)t.update()
...
var f,l,p,d,g,v=!1,m=!1,y=0,b=null,w=[],E=[],_=[],x=[],k=[],S=[],O=[],A=[],T=[],N={},C=[],R=[],I=[],L=[]
return f={start:function(t,e){this.addInstance(t),m||(y+=1,g=a(e,g))},end:function(){return m?void h():(--y||(m=!0,c(),m=!1,u()),g.init(),void(g=g._previous))},trigger:function(){return y||m?void h():(m=!0,c(),m=!1,void u())},focus:function(t){b=t},addInstance:function(t){t&&!L[t._guid]&&(L.push(t),L[L._guid]=!0)},addLiveQuery:function(t){w.push(t)},addDecorator:function(t){E.push(t)},addTransition:function(t){t._manager=g,g.push(t),_.push(t)},addObserver:function(t){x.push(t)},addAttribute:function(t){k.push(t)},addBinding:function(t){t.active=!0,S.push(t)},scheduleCssUpdate:function(){y||m?d=!0:e.update()},addEvaluator:function(t){v=!0,O.push(t)},addComputation:function(t){v=!0,A.push(t)},addSelectValue:function(t){v=!0,T.push(t)},addCheckbox:function(t){N[t.keypath]||(v=!0,C.push(t))},addRadio:function(t){v=!0,R.push(t)},addUnresolved:function(t){v=!0,I.push(t)},removeUnresolved:function(t){n(I,t)},detachWhenReady:function(t){g.detachQueue.push(t)}},t.runloop=f,f}(w,_,E,x,O,A,T,N),R=function(t,e,n){var r=[],i={tick:function(){var o,s,a
...
return t.push(function(){s=t.get}),t.set=o,o}(w,d,D,B,T),V=function(t,e,n,r){return function(i,o,s,a){var u,c,h,f,l,p,d,g,v,m
...
for(e=c.length;e--;)delete t[c[e]]}),s.unpatch=a,s}(C,c,P,M,V),q=function(t,e,n){var r,i,o
...
i=e.root,o=e.keypath,s=e.priority,n=i._deps[s]||(i._deps[s]={}),r=n[o]||(n[o]=[]),r.push(e),e.registered=!0,o&&t(i,o)}}(),J=function(){function t(t,e){var n,r,i
...
i=n+"="+r,s=t.bindings,s[i]||(s[i]=!0,o=t.instance,a=t.parentFragment.priority,c=new u(e,n,o,r,a),s.push(c),o.twoway&&(h=new u(o,r,e,n,1),s.push(h),c.counterpart=h,h.counterpart=c))}}(w,C,I,d,K,J),Q=function(t,e,n){function r(t,r,i,o,s){n(r,o,s,!0),e(r.component,t,i,o)}var i
...
while(o=o.parent)
return a=i(n,e),void 0!==a?(r(n,t,e,e,a),a):void 0}}(w,G,U),X={FAILED_LOOKUP:!0},Y=function(t,e,n,r,i,o){function s(t,e,n){var s,u,c,h,f=t._cache
...
return a=i.split("."),u=a.pop(),c=a.join("."),h=s(t,c),(p=t._wrapped[c])&&(h=p.get()),null!==h&&void 0!==h?((f=t._cacheMap[c])?-1===f.indexOf(i)&&f.push(i):t._cacheMap[c]=[i],"object"!=typeof h||u in h?(d=!e.call(h,u),l=d?n(h[u]):h[u],l=r(t,i,l,!1),t._cache[i]=l,l):t._cache[i]=o):void 0}return t.get=s,s}(w,k,L,$,Q,X),Z=function(){return"undefined"!=typeof console&&"function"==typeof console.warn&&"function"==typeof console.warn.apply?function(){console.warn.apply(console,arguments)}:function(){}}(),te=function(){var t=Object.prototype.toString
...
this.running=!1,e=this.root._animations.indexOf(this),-1===e&&t("Animation was not found"),this.root._animations.splice(e,1)}},i}(Z,C,ne,U),ie=function(t,e,n,r,i,o){function s(e,s,a,c){var h,f,l,p
...
y&&y.stop()}}}return r=r||{},r.complete&&i.then(r.complete),r.complete=o,c=s(this,t,n,r),i.stop=function(){c.stop()},i}}(d,g,v,R,Y,re),oe=function(){return this.fragment.detach()},se=function(t){return this.el?this.fragment.find(t):null},ae=function(t,e,n){var r,i,o,s,a,u,c
...
r(t,this.ref),t._unresolvedImplicitDependencies[this.ref]=!1,e(t._unresolvedImplicitDependencies,this)},teardown:function(){n.removeUnresolved(this)}},s}(w,E,C,T),Ee=function(t,e,n){var r={isTopLevel:!0}
...
e&&e.forEach(s)}),o||e(n,r+".length",!0)}}(F,T),Oe=function(t,e,n,r,i,o,s){function a(t){return JSON.stringify(t)}function u(t){if(t===!0)return a
...
return v=o(l,p),m=new r(function(t){y=t}),t.start(this,y),i(this,a,c,!0),s(this,a,v,g),t.end(),h&&h.complete&&m.then(h.complete),m}}(C,Z,I,g,U,ke,Se),Ae=function(t,e,n){var r=function(t,e,n,r){var i=this
...
if(t=this.value,r=n(this.root,this.keypath),this.value=r,!this.updating){if(this.updating=!0,!e(r,t)||!this.ready)try{this.callback.call(this.context,r,t,this.keypath)}catch(i){if(this.debug||this.root.debug)throw i}this.updating=!1}}},r}(C,d,Y),Te=function(t){return function(e,n){var r,i,o,s,a,u,c
...
return this.proxies[t]||(this.proxies[t]={update:function(){e.reallyUpdate(t)}}),this.proxies[t]}},i}(C,d,Y,Te),Ce=function(t,e,n,r,i){var o=/\*/,s={}
...
l&&(t=a._patternObservers.indexOf(f),-1!==t&&a._patternObservers.splice(t,1)),n(f)}}}}(v,K,J,Ae,Ne),Re=function(t,e){return function(n,r,i){var o,s,a,u
if(t(n)){i=r,s=n,o=[]
...
"function"!=typeof t||t._nowrap||(t=o(t,this.root,this.evaluator)),e(t,this.value)||(this.evaluator.values[this.argNum]=t,this.evaluator.bubble(),this.value=t)},teardown:function(){i(this)}},s}(F,d,c,K,J),Je=function(t,e,n){var r=function(t,n,r){this.root=t,this.keypath=n,this.priority=r.priority,this.evaluator=r,e(this)}
return r.prototype={update:function(){var e=this.root.get(this.keypath)
t(e,this.value)||(this.evaluator.bubble(),this.value=e)},teardown:function(){n(this)}},r}(d,K,J),Ge=function(t,e,n,r,i,o,s,a){function u(t,e){var n,r
...
this.selfUpdating=this.refs.length+this.softRefs.length<=1}},c}(C,Z,d,B,T,$,Ke,Je),Qe=function(t,e,n,r,i){function o(t,e){return t.replace(/\$\{([0-9]+)\}/g,function(t,n){return e[n]?e[n].value||e[n].keypath:"undefined"})}function s(t){return"${"+t.replace(/[\.\[\]]/g,"-")+"}"}var a=function(r,i,o,s){var a,u,c,h=this
...
s.keypath&&(a=i(s.keypath,n,r))?(s.keypath=a,o=!0):s.indexRef===t&&(s.value=e,o=!0)}),o&&this.bubble()}},a}(E,O,$e,Ge,Be),Xe=function(t,e,n,r,i,o,s){var a=function(i,o,a){var c,h,f,l,p,d=this
...
this.keypath=r,e(this),this.update()}}}(F,K,J),en=function(t){return function(e,n,r,i){var o,s
...
return s+='"',JSON.parse(s)}}}(xn),Sn=function(t){return t('"')}(kn),On=function(t){return t("'")}(kn),An=function(t,e,n){return function(r){var i,o
return i=r.pos,r.getStringMatch('"')?(o=n(r),r.getStringMatch('"')?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):r.getStringMatch("'")?(o=e(r),r.getStringMatch("'")?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):null}}(F,Sn,On),Tn=function(t,e){var n=e(/^(?:[+-]?)(?:(?:(?:0|[1-9]\d*)?\.\d+)|(?:(?:0|[1-9]\d*)\.)|(?:0|[1-9]\d*))(?:[eE][+-]?\d+)?/)
...
return function(i){var o
return(o=t(i))?r.test(o.v)?o.v:'"'+o.v.replace(/"/g,'\\"')+'"':(o=e(i))?o.v:(o=n(i))?o:void 0}}(An,Tn,Nn),Rn=function(t,e,n,r){function i(t){var e,n,i
...
return n.result?{value:n.result.v,remaining:n.remaining()}:null}}(En,_n,An,Cn),In=function(t,e,n){function r(t){return"string"==typeof t?t:JSON.stringify(t)}var i=function(e){this.type=t.INTERPOLATOR,n.init(this,e)}
...
t(s),this.argsList=[i]}this.dirty=!1}return this.argsList}}(Z,Rn),Mn=function(t,e,n,r,i,o,s,a){var u=function(t){n.init(this,t)}
...
if("value"!==this.name||"select"!==this.element.lcName)return"name"===this.name&&"input"===this.element.lcName&&(e=this.interpolator)?"name={{"+(e.keypath||e.ref)+"}}":this.fragment?(t=this.fragment.toString(),this.name+"="+JSON.stringify(t)):this.name+"="+JSON.stringify(this.value)}},c}(C,F,dn,gn,vn,mn,bn,wn,Mn),Bn=function(t){return function(e,n,r){var i=new t({element:e,name:n,value:r,root:e.root,pNode:e.node})
...
while(e=e._parent)},Jn=function(){if(this._inited)throw new Error("Cannot initialize a transition more than once")
...
break}return r[t]}}(u,m,a),Qn=function(t,e,n,r){var i
...
return i}}(r,u,I,Gn),Xn=function(t){return function(e,n){var r
...
return void t(u)}},u.prototype={init:n,getStyle:r,setStyle:i,animateStyle:o,processParams:s,resetStyle:a},u}(Z,Mn,Jn,Qn,Xn,rr,or,sr),ur=function(t,e){return function(n,r,i,o){var s,a,u
...
while(t=t.parent)}return function(y,b,w){var E,_,x,k,S,O,A,T,N,C,R,I
if(y.type=e.ELEMENT,E=y.parentFragment=b.parentFragment,_=E.pNode,x=y.descriptor=b.descriptor,y.parent=b.pElement,y.root=C=E.root,y.index=b.index,y.lcName=x.e.toLowerCase(),y.eventListeners=[],y.customEventListeners=[],y.cssDetachQueue=[],_&&(k=y.namespace=u(x,_),S=k!==n.html?v(x.e):x.e,y.node=s(S,k),C.css&&_===C.el&&y.node.setAttribute("data-rvcguid",C.constructor._guid||C._guid),i(y.node,"_ractive",{value:{proxy:y,keypath:a(E),index:E.indexRefs,events:r(null),root:C}})),O=h(y,x.a),x.f){if(y.node&&y.node.getAttribute("contenteditable")&&y.node.innerHTML){if(I="A pre-populated contenteditable element should not have children",C.debug)throw new Error(I)
o(I)}f(y,y.node,x,w)}w&&x.v&&p(y,x.v),w&&(C.twoway&&(y.bind(),y.node.getAttribute("contenteditable")&&y.node._ractive.binding&&y.node._ractive.binding.update()),O.name&&!O.name.twoway&&O.name.update(),"IMG"===y.node.tagName&&((A=y.attributes.width)||(T=y.attributes.height))&&y.node.addEventListener("load",N=function(){A&&(y.node.width=A.value),T&&(y.node.height=T.value),y.node.removeEventListener("load",N,!1)},!1),w.appendChild(y.node),x.o&&l(x.o,C,y),x.t1&&g(x.t1,C,y,!0),"OPTION"===y.node.tagName&&("SELECT"===_.tagName&&(R=_._ractive.binding)&&R.deferUpdate(),O.value||c(y,"value",x.f),y.node._ractive.value==_._ractive.value&&(y.node.selected=!0)),y.node.autofocus&&t.focus(y.node)),"option"===y.lcName&&(y.select=m(y.parent)),d(y)}}(C,F,s,je,c,Z,a,S,ln,Bn,Dn,Wn,zn,$n,Kn,ur,pn),hr=function(t,e){function n(t){var e,n,r,i,o
...
return n?(t.pos+=1,n):null}}(F),Ar=function(t,e,n){function r(e){for(var n=[];e.t===t.MEMBER&&e.r.t===t.REFINEMENT;)n.unshift(e.r),e=e.x
...
return h.t===t.REFERENCE?u.ref=h.n:h.t===t.NUMBER_LITERAL&&o.test(h.v)?u.ref=h.v:(g=r(h))?u.keypathExpression=g:u.expression=h,f=i(e),null!==f&&(u.indexRef=f),u}}(F,xn,Or),Tr=function(t,e,n){function r(r,i){var o,s,a=r.pos
...
return r(this,t)||r(this,!t)}}(F,Sr,Ar),Nr=function(t){return function(){var e,n,r
if(!this.getStringMatch("<!--"))return null
...
return r=n.pos,n.allowWhitespace(),i=e(n),null===i?(n.pos=r,null):(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),o=n.getExpression(),null===o?(n.pos=r,null):{t:t.KEY_VALUE_PAIR,k:i,v:o}):(n.pos=r,null))}}(F,Cn),Pr=function(t){return function e(n){var r,i,o,s
...
return s}}(Tn,Lr,An,Mr,Br),Ur=function(t,e,n){var r,i,o,s
...
return(i=e(n))?(r=n.pos,n.allowWhitespace(),n.getStringMatch("?")?(n.allowWhitespace(),(o=n.getExpression())?(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),s=n.getExpression(),s?{t:t.CONDITIONAL,o:[i,o,s]}:(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):null}}(F,$r),Jr=function(t){return function(){return t(this)}}(Kr),Gr=function(t,e,n,r,i,o,s){var a
...
a[u]=r(i.substr(0,h.index),e),i=i.substring(h.index+h[0].length)}return{main:r(n,e),partials:a}},r}(Qr,F,yi),wi=function(){function t(t,e){var r=n.exec(e)[0]
...
this.component.instance.set(this.key,t),this.value=t},teardown:function(){this.fragment.teardown()}},n}(C,Mn),Si=function(t,e,n,r,i){function o(o,s,a,u){var c,h,f,l,p,d
...
return i}}(F,Rn,O,Y,ki),Oi=function(){function t(t,e){var n,r,i
...
d=[],p=n(a,l.data||{},u.descriptor.a,d),r(a,l,p,c,u.descriptor.f),i(a,d),o(a,u.descriptor.v),(u.descriptor.t1||u.descriptor.t2||u.descriptor.o)&&e('The "intro", "outro" and "decorator" directives have no effect on components'),s(a)}}(F,Z,Si,Oi,Ai,Ti,Ni),Ri=function(t,e){function n(t){var e,n
e=t.root
...
return s=new t(function(t){a=t}),o&&s.then(o),e.start(this,a),(u=this._wrapped[""])&&u.reset?u.reset(i)===!1&&(this.data=i):this.data=i,n(this,""),r(this,""),e.end(),this.fire("reset",i),s}}(g,C,B,T),Fi=function(t,e,n,r,i){return function(o,s,a){var u,c,h
...
return"function"==typeof i?(o=i,i=""):i=i||"",s=new e(function(t){a=t}),t.start(this,a),n(this,i),r(this,i),t.end(),this.fire("update",i),o&&s.then(o.bind(this)),s}}(C,g,B,T),qi=function(t,e,n){function r(t,i,o,s,a){var u,c,h,f,l,p
...
this.set(i)}}(x,yn,d),zi=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v,m,y,b,w,E,_,x){return{add:t,animate:e,detach:n,find:r,findAll:i,findAllComponents:o,findComponent:s,fire:a,get:u,insert:c,merge:h,observe:f,off:l,on:p,render:d,renderHTML:g,reset:v,set:m,subtract:y,teardown:b,toHTML:w,toggle:E,update:_,updateModel:x}}(p,ie,oe,se,ve,me,ye,be,Ee,xe,Oe,Re,Ie,Le,ji,Pi,Mi,Fi,Bi,Di,Ui,Vi,Wi,qi),Hi={},$i={linear:function(t){return t},easeIn:function(t){return Math.pow(t,3)},easeOut:function(t){return Math.pow(t-1,3)+1},easeInOut:function(t){return(t/=.5)<1?.5*Math.pow(t,3):.5*(Math.pow(t-2,3)+2)}},Ki=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(t){var e,n
return e=16*Math.random()|0,n="x"==t?e:3&e|8,n.toString(16)})},Ji=function(t){for(var e,n,r=Array.prototype.slice.call(arguments,1);n=r.shift();)for(e in n)n.hasOwnProperty(e)&&(t[e]=n[e])
return t},Gi=["adaptors","components","decorators","easing","events","interpolators","partials","transitions","data"],Qi=function(){function t(t){return t.trim?t.trim():t.replace(/^\s+/,"").replace(/\s+$/,"")}function e(t){return t.str}var n=/(?:^|\})?\s*([^\{\}]+)\s*\{/g,r=/\/\*.*?\*\//g,i=/((?:(?:\[[^\]+]\])|(?:[^\s\+\>\~:]))+)((?::[^\s\+\>\~]+)?\s*[\s\+\>\~]?)\s*/g
...
return r=n.split(",").map(t),i=r.map(u).join(", ")+" ",e.replace(n,i)})}}(),Xi=function(t,e,n,r){return function(i,o){t.forEach(function(t){o[t]&&(i[t]=e(o[t]))}),n(i,"defaults",{value:e(o.defaults)}),o.css&&n(i,"css",{value:o.defaults.noCssTransform?o.css:r(o.css,i._guid)})}}(Gi,je,c,Qi),Yi=function(t,e){return/_super/.test(t)?function(){var n,r=this._super
...
u.css&&n(a,"css",{value:a.defaults.noCssTransform?u.css:o(u.css,a._guid)})}}(i,Gi,c,Yi,Zi,Qi),eo=function(t,e){return function(n,r){t(n.defaults.template)&&(n.partials||(n.partials={}),e(n.partials,n.defaults.template.partials),r.partials&&e(n.partials,r.partials),n.defaults.template=n.defaults.template.main)}}(te,Zi),no=function(t,e,n){return function(r){var i
...
e=this.root.get(this.keypath),t(e,this.value)||this.computation.bubble()},teardown:function(){n(this)}},r}(d,K,J),so=function(t,e,n,r){function i(t,e,n){var i,o,s
...
if(b.eventDefinitions&&(i("ractive.eventDefinitions has been deprecated in favour of ractive.events. Support will be removed in future versions"),b.events=b.eventDefinitions),r.forEach(function(t){y.constructor[t]?y[t]=s(o(y.constructor[t]),b[t]):b[t]&&(y[t]=b[t])}),y.data||(y.data={}),O=w.computed?s(o(w.computed),b.computed):b.computed,O&&v(y,O),E=b.template,"string"==typeof E){if(!g)throw new Error(e.missingParser)
...
return h.template&&(a(l),s(l,h),u(l)),l}}(je,h,Ki,Ji,Xi,to,eo,no,ro,co,w),fo=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p){var d=function(t){l(this,t)}
...
"undefined"!=typeof e&&e.exports?e.exports=lo:"function"==typeof define&&define.amd&&define(function(){return lo}),t.Ractive=lo,lo.noConflict=function(){return t.Ractive=n,lo}}("undefined"!=typeof window?window:this)},{}],93:[function(t,e){e.exports=function(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
return n}},{}],94:[function(t,e){function n(){return Object.create(new a)}function r(t,e){var n=Object.create(t),r=0
...
e.exports=i},{"./numberOfOccurrances":93,"./templateToolbox":95,events:105}],95:[function(t,e){function n(t){return t.metadata.markdown!==!1?h.makeHtml(t.content):t.content}function r(){return"xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g,function(t){var e=16*Math.random()|0,n="x"==t?e:3&e|8
...
e.exports={generateId:i,getPostName:o,generatePostDiv:a,isAPostDiv:s,getTemplateDataObject:u,htmlify:n}},{pagedown:99}],96:[function(t,e){e.exports=function(t){var e={}
return t.on("post changed",function(t,n){e[t]&&e[t].forEach(function(t){t.emit("post changed",n)})}),function(t){"undefined"==typeof e[t.postName]&&(e[t.postName]=[]),e[t.postName].push(t),t.ractive.on("teardown",function(){e[t.postName]=e[t.postName].filter(function(e){return e!==t})})}}},{}],97:[function(t,e,n){var r
...
var r="<hr />\n"
return t=t.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm,r),t=t.replace(/^[ ]{0,2}([ ]?-[ ]?){3,}[ \t]*$/gm,r),t=t.replace(/^[ ]{0,2}([ ]?_[ ]?){3,}[ \t]*$/gm,r),t=d(t),t=v(t),t=E(t),t=L.postBlockGamut(t,B),t=e(t),t=_(t,n)}function s(t){return t=L.preSpanGamut(t),t=y(t),t=a(t),t=k(t),t=h(t),t=u(t),t=O(t),t=t.replace(/~P/g,"://"),t=x(t),t=w(t),t=t.replace(/  +\n/g," <br>\n"),t=L.postSpanGamut(t)}function a(t){var e=/(<[a-z\/!$]("[^"]*"|'[^']*'|[^'">])*>|<!(--(?:|(?:[^>-]|-[^>])(?:[^-]|-[^-])*)--)>)/gi
...
l=j.get(h),void 0!=P.get(h)&&(p=P.get(h))}c=R(f(c),"*_[]()"),l=R(l,"*_")
...
r=r.replace(u,function(t){return a=t,""})}return"<"+n+r+">"+a}function O(t){t=t.replace(/(="|<)?\b(https?|ftp)(:\/\/[-A-Z0-9+&@#\/%?=~_|\[\]\(\)!:,\.;]*[-A-Z0-9+&@#\/%=~_|\[\])])(?=$|\W)/gi,S)
var e=function(t,e){return'<a href="'+e+'">'+L.plainLinkText(e)+"</a>"}
return t=t.replace(/<((https?|ftp):[^'">\s]+)>/gi,e)}function A(t){return t=t.replace(/~E(\d+)E/g,function(t,e){var n=parseInt(e)
...
return j=new i,P=new i,M=[],F=0,n=L.preConversion(n),n=n.replace(/~/g,"~T"),n=n.replace(/\$/g,"~D"),n=n.replace(/\r\n/g,"\n"),n=n.replace(/\r/g,"\n"),n="\n\n"+n+"\n\n",n=N(n),n=n.replace(/^[ \t]+$/gm,""),n=L.postNormalization(n),n=e(n),n=t(n),n=o(n),n=A(n),n=n.replace(/~D/g,"$$"),n=n.replace(/~T/g,"~"),n=L.postConversion(n),M=P=j=null,n}
var B=function(t){return o(t)},D={ol:"\\d+[.]",ul:"[*+-]"},U=/(?:["'*()[\]:]|~D)/g}}()},{}],98:[function(t,e,n){!function(){function e(t){return t.replace(/<[^>]*>?/gi,r)}function r(t){return t.match(a)||t.match(u)||t.match(c)?t:""}function i(t){if(""==t)return""
...
var a=/^(<\/?(b|blockquote|code|del|dd|dl|dt|em|h1|h2|h3|i|kbd|li|ol|p|pre|s|sup|sub|strong|strike|ul)>|<(br|hr)\s?\/?>)$/i,u=/^(<a\shref="((https?|ftp):\/\/|\/)[-A-Za-z0-9+&@#\/%?=~_|!:,.;\(\)]+"(\stitle="[^"<>]+")?\s?>|<\/a>)$/i,c=/^(<img\ssrc="(https?:\/\/|\/)[-A-Za-z0-9+&@#\/%?=~_|!:,.;\(\)]+"(\swidth="\d{1,3}")?(\sheight="\d{1,3}")?(\salt="[^"<>]*")?(\stitle="[^"<>]*")?\s?\/?>)$/i}()},{"./Markdown.Converter":97}],99:[function(t,e,n){n.Converter=t("./Markdown.Converter").Converter,n.getSanitizingConverter=t("./Markdown.Sanitizer").getSanitizingConverter},{"./Markdown.Converter":97,"./Markdown.Sanitizer":98}],100:[function(t,e){!function(t){"use strict"
...
return this.updating?!1:(t=Object.getOwnPropertyDescriptor(this.obj,this.prop),e=t&&t.set,void(e&&(r=e._ractiveWrappers,i=r.indexOf(this),-1!==i&&r.splice(i,1),r.length||(n=this.obj[this.prop],Object.defineProperty(this.obj,this.prop,this.originalDescriptor||{writable:!0,enumerable:!0,configurable:!0}),this.obj[this.prop]=n))))}}}catch(s){i=!1}return i}(w,E,a),x=function(t){return!!t}(_),k={html:"http://www.w3.org/1999/xhtml",mathml:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"},S=function(t,e){var n
return n=t?function(t,n){return n&&n!==e.html?document.createElementNS(n,t):document.createElement(t)}:function(t,n){if(n&&n!==e.html)throw"This browser does not support namespaces other than http://www.w3.org/1999/xhtml. The most likely cause of this error is that you're trying to render SVG in an older browser. See http://docs.ractivejs.org/latest/svg-and-older-browsers for more information"
return document.createElement(t)}}(f,k),O=function(){var t="object"==typeof document
return t}(),A=function(t){var e
try{Object.defineProperty({},"test",{value:0}),t&&Object.defineProperty(document.createElement("div"),"test",{value:0}),e=Object.defineProperty}catch(n){e=function(t,e,n){t[e]=n.value}}return e}(O),T=function(t,e,n){var r
...
for(r in n)n.hasOwnProperty(r)&&e(t,r,n[r])}}return r}(S,A,O),N=function(t){return function(e,n,r){var i
if("string"!=typeof n||!t(r))throw new Error("Bad arguments")
if(i=+e.get(n)||0,!t(i))throw new Error("Cannot add to a non-numeric value")
...
return t="undefined"!=typeof window&&window.performance&&"function"==typeof window.performance.now?function(){return window.performance.now()}:function(){return Date.now()}}(),P=function(t,e,n){var r=[],i={tick:function(){var o,s,a
for(a=e(),n.start(),o=0;o<r.length;o+=1)s=r[o],s.tick(a)||r.splice(o--,1)
n.end(),r.length?t(i.tick):i.running=!1},add:function(e){r.push(e),i.running||(i.running=!0,t(i.tick))},abort:function(t,e){for(var n,i=r.length;i--;)n=r[i],n.root===e&&n.keypath===t&&n.stop()}}
return i}(L,j,w),M=function(){var t,e={}
...
return s+='"',JSON.parse(s)}}}(),J=function(t){return t('"')}(K),G=function(t){return t("'")}(K),Q=function(t,e,n){return function(r){var i,o
return i=r.pos,r.matchString('"')?(o=n(r),r.matchString('"')?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):r.matchString("'")?(o=e(r),r.matchString("'")?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):null}}(W,J,G),X={name:/^[a-zA-Z_$][a-zA-Z_$0-9]*/},Y=function(t,e,n){var r=/^[a-zA-Z_$][a-zA-Z_$0-9]*$/
return function(i){var o
return(o=t(i))?r.test(o.v)?o.v:'"'+o.v.replace(/"/g,'\\"')+'"':(o=e(i))?o.v:(o=i.matchPattern(n.name))?o:void 0}}(Q,H,X),Z=function(t,e){return function(n){var r,i,o
return r=n.pos,n.allowWhitespace(),i=e(n),null===i?(n.pos=r,null):(n.allowWhitespace(),n.matchString(":")?(n.allowWhitespace(),o=n.readExpression(),null===o?(n.pos=r,null):{t:t.KEY_VALUE_PAIR,k:i,v:o}):(n.pos=r,null))}}(W,Y),te=function(t){return function e(n){var r,i,o,s
return r=n.pos,o=t(n),null===o?null:(i=[o],n.matchString(",")?(s=e(n),s?i.concat(s):(n.pos=r,null)):i)}}(Z),ee=function(t,e){return function(n){var r,i
...
return s}}(H,$,Q,ee,re),oe=function(t,e){var n,r,i,o,s
...
return r.matchString("(")&&(p=f.lastIndexOf("."),-1!==p?(f=f.substr(0,p),r.pos=a+f.length):r.pos-=1),{t:t.REFERENCE,n:f.replace(/^this\./,"./").replace(/^this$/,".")}}}(W,X),se=function(t,e){return function(n){var r,i
...
r.error("Expected a property name")}return r.matchString("[")?(r.allowWhitespace(),s=r.readExpression(),s||r.error(e.expectedExpression),r.allowWhitespace(),r.matchString("]")||r.error("Expected ']'"),{t:t.REFINEMENT,x:s}):null}}(W,z,X),ce=function(t,e,n,r,i){return function(o){var s,a,u,c
...
for(n=e.length;n--;){if(r=t.indexOf(e[n]),!r)return 0;-1!==r&&(!i||i>r)&&(i=r)}return i||-1},Se=function(){function t(t){return t?10===t?32:128>t?t:159>=t?n[t-128]:55296>t?t:57343>=t?65533:65535>=t?t:65533:65533}var e,n,r,i,o
...
return s=n.replace(r,function(t,n){return e[n]?String.fromCharCode(e[n]):t}),s=s.replace(i,function(e,n){return String.fromCharCode(t(parseInt(n,16)))}),s=s.replace(o,function(e,n){return String.fromCharCode(t(n))})}}(be),Oe=function(t,e){return function(n){var r,i,o,s
return i=n.remaining(),s=n.inside?"</"+n.inside:"<",n.inside&&!n.interpolate[n.inside]?r=i.indexOf(s):(o=[s,n.delimiters[0],n.tripleDelimiters[0],n.staticDelimiters[0],n.staticTripleDelimiters[0]],n.inAttribute===!0?o.push('"',"'","=",">","`"):n.inAttribute&&o.push(n.inAttribute),r=t(i,o)),r?(-1===r&&(r=i.length),n.pos+=r,e(i.substr(0,r))):null}}(ke,Se),Ae=function(t){var e=/^([a-zA-Z]{1,}:?[a-zA-Z0-9\-]*)\s*\>/
return function(n){var r
return n.matchString("</")?(r=n.matchPattern(e))?{t:t.CLOSING_TAG,e:r}:(n.pos-=2,void n.error("Illegal closing tag")):null}}(W),Te=function(t,e){function n(t){var e,n,i
...
return n.result}}(de,Q,Y),Ce=function(t){return function(e){var n,r,i,o,s,a
...
return c=[n,r,u,i,o],u}(W,xe,Ee,_e,Oe,Ae,Te,Ce),Ie=function(){var t=/^[ \t\f\r\n]+/,e=/[ \t\f\r\n]+$/
...
return f}(V,O,je,q,Me),Be=function(t,e){function n(t){var e,n=t._config.template
...
return r}(Pe,De),Ve=function(){},We=function(t){function e(e,n){var r
if(n in e){var i=e[n]
...
return l.keys=Object.keys(n).concat(o.map(function(t){return t.name})).concat(["css"]),l.parseOptions=i,l.registries=o,l.extend=function(t,e,n){c("extend",t,e,n)},l.init=function(t,e,n){c("init",t,e,n),e._config&&(e._config.options=n)},l.reset=function(t){return l.filter(function(e){return e.reset&&e.reset(t)}).map(function(t){return t.name})},l}(B,U,r,Be,Me,Ue,We,qe),He=function(t,e,n,r){function i(t){return function(){return t}}var o=function(t,o,s,a){if(t===o)return i(o)
...
return t.interpolate=o,o}(o,M,h,ze),$e=function(t,e,n){var r=function(t){var e
this.startTime=Date.now()
for(e in t)t.hasOwnProperty(e)&&(this[e]=t[e])
this.interpolator=n(this.from,this.to,this.root,this.interpolator),this.running=!0}
...
this.running=!1,e=this.root._animations.indexOf(this),-1===e&&t("Animation was not found"),this.root._animations.splice(e,1)}},r}(M,w,He),Ke=function(t,e,n,r,i){function o(e,o,s,u){var c,h,f,l
...
y&&y.stop()}}}return r=r||{},r.complete&&i.then(r.complete),r.complete=a,c=o(this,t,n,r),i.stop=function(){c.stop()},i}}(v,p,R,P,$e),Je=function(t){return function(){return this.el&&t(this.el.__ractive_instances__,this),this.fragment.detach()}}(l),Ge=function(t){return this.el?this.fragment.find(t):null},Qe=function(t,e,n){var r,i,o,s,a,u,c,h
...
return r}(O,I,S),Xe=function(t){return function(e,n){var r=this._isComponentQuery?!this.selector||e.name===this.selector:t(e.node,this.selector)
return r?(this.push(e.node||e.instance),n||this._makeDirty(),!0):void 0}}(Qe),Ye=function(){var t,e,n
t=this._root[this._isComponentQuery?"liveComponentQueries":"liveQueries"],e=this.selector,n=t.indexOf(e),-1!==n&&(t.splice(n,1),t[e]=null)},Ze=function(){function t(t){var e
return(e=t.parentFragment)?e.owner:t.component&&(e=t.component.parentFragment)?e.owner:void 0}function e(e){var n,r
for(n=[e],r=t(e);r;)n.push(r),r=t(r)
return n}return function(t,n){var r,i,o,s,a,u,c,h,f,l
for(r=e(t.component||t._ractive.proxy),i=e(n.component||n._ractive.proxy),o=r[r.length-1],s=i[i.length-1];o&&o===s;)r.pop(),i.pop(),a=o,o=r[r.length-1],s=i[i.length-1]
...
return e.compareDocumentPosition?(r=e.compareDocumentPosition(n),2&r?1:-1):t(e,n)}}(Ze),en=function(t,e){return function(){this.sort(this._isComponentQuery?e:t),this._dirty=!1}}(tn,Ze),nn=function(t){return function(){var e=this
...
return t(h,{selector:{value:a},live:{value:u},_isComponentQuery:{value:c},_test:{value:e}}),u?(t(h,{cancel:{value:n},_root:{value:s},_sort:{value:r},_makeDirty:{value:i},_remove:{value:o},_dirty:{value:!1,writable:!0}}),h):h}}(T,Xe,Ye,en,nn,rn),sn=function(t){return function(e,n){var r,i
...
case"push":return[t.length,0].concat(n)
case"shift":return[0,1]
case"unshift":return[0,0].concat(n)}},Sn=function(t,e){var n,r,i,o,s,a
return e?(n=+(e[0]<0?t.length+e[0]:e[0]),o=Math.max(0,e.length-2),s=void 0!==e[1]?e[1]:t.length-n,s=Math.min(s,t.length-n),a=o-s,i=t.length+a,r=a?Math.max(t.length,i):n+o,{rangeStart:n,rangeEnd:r,balance:a,added:o,removed:s}):null},On=function(t,e,n,r){var i=Array.prototype
...
return u=n(a,o,l),c=r(a,u),i[o].apply(a,l),h=e.start(this,!0),c?this.viewmodel.splice(s,c):this.viewmodel.mark(s),e.end(),h}}}(a,w,kn,Sn),An=function(t){return t("pop")}(On),Tn=function(t){return t("push")}(On),Nn=function(t,e,n){var r,i,o,s,a,u,c,h="/* Ractive.js component styles */\n",f={},l=[]
...
return e},Pn=function(t,e){var n,r,i
if(this.items)for(r=this.items.length,n=0;r>n;n+=1)i=this.items[n],i.findAllComponents&&i.findAllComponents(t,e)
return e},Mn=function(t){var e,n,r,i
if(this.items){for(e=this.items.length,n=0;e>n;n+=1)if(r=this.items[n],r.findComponent&&(i=r.findComponent(t)))return i
...
return e.prototype={teardown:function(){t.removeUnresolved(this)}},e}(w),Jn=function(t,e){return t.substr(0,e.length+1)===e+"."},Gn=function(t){return function(e,n,r){return e===n?r:t(e,n)?e.replace(n+".",r+"."):void 0}}(Jn),Qn=function(t,e){function n(t){var n=e[t.message]||t.message||""
...
return i}(M,V),Xn=function(t,e,n){var r,i
...
t.dependencies=n.slice()},Yn=function(t,e,n,r){function i(t,e){var n,r
...
this.explicitDependencies.concat(this.dependencies).forEach(function(e){return t.viewmodel.unregister(e,t,"computed")}),this.root.viewmodel.evaluators[this.keypath]=null}},a}(Qn,v,A,Xn),Zn=function(t,e,n,r,i){function o(t,e){return t.replace(/\$\{([0-9]+)\}/g,function(t,n){var r=e[n]
...
this.args.forEach(function(s){var a
s&&(s.keypath&&(a=i(s.keypath,n,r))?(s.keypath=a,o=!0):s.indexRef&&s.indexRef===t&&(s.value=e,o=!0))}),o&&this.bubble()}},a}(l,y,Kn,Yn,Gn),tr=function(t,e,n,r,i){var o=function(r,o,s){var a,u,c,h,f,l=this
...
c=n(o.root,u,o.parentFragment),void 0!==c?o.resolve(c):(o.ref=u,e.addUnresolved(o))}s.template.x&&(o.resolver=new i(o,l,s.template.x,a)),s.template.rx&&(o.resolver=new r(o,s.template.rx,a)),o.template.n!==t.SECTION_UNLESS||o.hasOwnProperty("value")||o.setValue(void 0)}}(W,w,y,er,Zn),rr=function(t){var e,n,r
...
if(this.docFrag){for(t=this.nodes.length,e=0;t>e;e+=1)this.docFrag.appendChild(this.nodes[e])
return this.docFrag}},Sr=function(t){return function(e){var n,r,i,o
for(r=this.nodes.length,n=0;r>n;n+=1)if(i=this.nodes[n],1===i.nodeType){if(t(i,e))return i
if(o=i.querySelector(e))return o}return null}}(Qe),Or=function(t){return function(e,n){var r,i,o,s,a,u
for(i=this.nodes.length,r=0;i>r;r+=1)if(o=this.nodes[r],1===o.nodeType&&(t(o,e)&&n.push(o),s=o.querySelectorAll(e)))for(a=s.length,u=0;a>u;u+=1)n.push(s[u])}}(Qe),Ar=function(){return this.rendered&&this.nodes[0]?this.nodes[0]:this.parentFragment.findNextNode(this)},Tr=function(t,e){function n(t){return o[t]||(o[t]=e(t))}var r,i,o={}
...
if(r&&"SELECT"===o.tagName)for(f=l.length;f--;)l[f]!==c&&(l[f].selected=!1)}return l}}(k,S),Nr=function(t){for(var e=[],n=t.length;n--;)e[n]=t[n]
...
return this.docFrag=document.createDocumentFragment(),this.nodes=t(this.value,this.parentFragment.getNode(),this.docFrag),e(this.pElement),this.rendered=!0,this.docFrag}}(Tr,Cr),Ir=function(t){return function(e){var n;(n=this.root.viewmodel.wrapped[this.keypath])&&(e=n.get()),e!==this.value&&(this.value=e,this.parentFragment.bubble(),this.rendered&&t.addView(this))}}(w),Lr=function(){return void 0!=this.value?this.value:""},jr=function(t){return function(e){this.rendered&&e&&(this.nodes.forEach(t),this.rendered=!1)}}(Wn),Pr=function(t,e){return function(){var n,r
if(this.rendered){for(;this.nodes&&this.nodes.length;)n=this.nodes.pop(),n.parentNode.removeChild(n)
r=this.parentFragment.getNode(),this.nodes=t(this.value,r,this.docFrag),r.insertBefore(this.docFrag,this.parentFragment.findNextNode(this)),e(this.pElement)}}}(Tr,Cr),Mr=function(t,e,n,r,i,o,s,a,u,c,h,f){var l=function(n){this.type=t.TRIPLE,e.init(this,n)}
return l.prototype={detach:n,find:r,findAll:i,firstNode:o,getValue:e.getValue,rebind:e.rebind,render:s,resolve:e.resolve,setValue:a,toString:u,unbind:f,unrender:c,update:h},l}(W,or,kr,Sr,Or,Ar,Rr,Ir,Lr,jr,Pr,Hn),Fr=function(){this.parentFragment.bubble()},Br=function(){var t,e=this.node
return e?((t=e.parentNode)&&t.removeChild(e),e):void 0},Dr=function(t){return function(e){return t(this.node,e)?this.node:this.fragment&&this.fragment.find?this.fragment.find(e):void 0}}(Qe),Ur=function(t,e){e._test(this,!0)&&e.live&&(this.liveQueries||(this.liveQueries=[])).push(e),this.fragment&&this.fragment.findAll(t,e)},Vr=function(t,e){this.fragment&&this.fragment.findAllComponents(t,e)},Wr=function(t){return this.fragment?this.fragment.findComponent(t):void 0},qr=function(){return null},zr=function(){return this.node},Hr=function(t){return this.attributes&&this.attributes[t]?this.attributes[t].value:void 0},$r=function(){var t,e,n,r
return t="altGlyph altGlyphDef altGlyphItem animateColor animateMotion animateTransform clipPath feBlend feColorMatrix feComponentTransfer feComposite feConvolveMatrix feDiffuseLighting feDisplacementMap feDistantLight feFlood feFuncA feFuncB feFuncG feFuncR feGaussianBlur feImage feMerge feMergeNode feMorphology feOffset fePointLight feSpecularLighting feSpotLight feTile feTurbulence foreignObject glyphRef linearGradient radialGradient textPath vkern".split(" "),e="attributeName attributeType baseFrequency baseProfile calcMode clipPathUnits contentScriptType contentStyleType diffuseConstant edgeMode externalResourcesRequired filterRes filterUnits glyphRef gradientTransform gradientUnits kernelMatrix kernelUnitLength keyPoints keySplines keyTimes lengthAdjust limitingConeAngle markerHeight markerUnits markerWidth maskContentUnits maskUnits numOctaves pathLength patternContentUnits patternTransform patternUnits pointsAtX pointsAtY pointsAtZ preserveAlpha preserveAspectRatio primitiveUnits refX refY repeatCount repeatDur requiredExtensions requiredFeatures specularConstant specularExponent spreadMethod startOffset stdDeviation stitchTiles surfaceScale systemLanguage tableValues targetX targetY textLength viewBox viewTarget xChannelSelector yChannelSelector zoomAndPan".split(" "),n=function(t){for(var e={},n=t.length;n--;)e[t[n].toLowerCase()]=t[n]
return e},r=n(t.concat(e)),function(t){var e=t.toLowerCase()
return r[e]||e}}(),Kr=function(t){return function(){var e=this.fragment.getValue()
e!==this.value&&(this.value=e,"value"===this.name&&this.node&&(this.node._ractive.value=e),this.rendered&&t.addView(this))}}(w),Jr=function(t,e){return function(n,r){var i,o
...
if(1===n.length)return n[0].type===t.INTERPOLATOR?n[0]:void 0}}(W),Qr=function(t){var e={"accept-charset":"acceptCharset",accesskey:"accessKey",bgcolor:"bgColor","class":"className",codebase:"codeBase",colspan:"colSpan",contenteditable:"contentEditable",datetime:"dateTime",dirname:"dirName","for":"htmlFor","http-equiv":"httpEquiv",ismap:"isMap",maxlength:"maxLength",novalidate:"noValidate",pubdate:"pubDate",readonly:"readOnly",rowspan:"rowSpan",tabindex:"tabIndex",usemap:"useMap"}
return function(n,r){var i
!n.pNode||n.namespace||r.pNode.namespaceURI&&r.pNode.namespaceURI!==t.html||(i=e[n.name]||n.name,void 0!==r.pNode[i]&&(n.propertyName=i),("boolean"==typeof r.pNode[i]||"value"===i)&&(n.useProperty=!0))}}(k),Xr=function(t,e,n,r,i){var o
return i.push(function(){o=i.Fragment}),function(i){return this.type=t.ATTRIBUTE,this.element=i.element,this.root=i.root,e(this,i.name),i.value&&"string"!=typeof i.value?(this.parentFragment=this.element.parentFragment,this.fragment=new o({template:i.value,root:this.root,owner:this}),this.value=this.fragment.getValue(),this.interpolator=n(this),this.isBindable=!!this.interpolator,r(this,i),void(this.ready=!0)):void(this.value=i.value||!0)}}(W,Jr,Gr,Qr,o),Yr=function(t,e,n,r){this.fragment&&this.fragment.rebind(t,e,n,r)},Zr=function(t){var e={"accept-charset":"acceptCharset",accesskey:"accessKey",bgcolor:"bgColor","class":"className",codebase:"codeBase",colspan:"colSpan",contenteditable:"contentEditable",datetime:"dateTime",dirname:"dirName","for":"htmlFor","http-equiv":"httpEquiv",ismap:"isMap",maxlength:"maxLength",novalidate:"noValidate",pubdate:"pubDate",readonly:"readOnly",rowspan:"rowSpan",tabindex:"tabIndex",usemap:"useMap"}
return function(n){var r
...
return a.prototype={bubble:t,init:e,rebind:n,render:r,toString:i,unbind:o,update:s},a}(Kr,Xr,Yr,Zr,ti,ei,di),vi=function(t){return function(e,n){var r,i,o=[]
...
return e=function(t){o.call(this,t),this.init&&this.init()},e.prototype=n(i.prototype),r(e.prototype,t),e.extend=o.extend,e},o}(w,M,q,mi,l),bi=function(){this._ractive.binding.handleChange()},wi=function(t,e){var n=t.extend({getInitialValue:function(){return this.element.fragment?this.element.fragment.toString():""},render:function(){var t=this.element.node
...
return a}(a,l,yi,Ei,bi),Si=function(t,e){var n=t.extend({name:"checked",render:function(){var t=this.element.node
...
return n}(yi,bi),Oi=function(t,e,n){var r=e.extend({getInitialValue:function(){var t,e,n=this.element.options
...
return r}(w,yi,bi),Ai=function(t){return function(e,n){var r
if(!t(e)||!t(n))return!1
if(e.length!==n.length)return!1
for(r=e.length;r--;)if(e[r]!==n[r])return!1
return!0}}(a),Ti=function(t,e,n,r){var i=n.extend({getInitialValue:function(){return this.element.options.filter(function(t){return t.getAttribute("selected")}).map(function(t){return t.getAttribute("value")})},render:function(){var t
...
return i}(w,Ai,Oi,bi),Ni=function(t,e){var n=t.extend({render:function(){this.element.node.addEventListener("change",e,!1)},unrender:function(){this.element.node.removeEventListener("change",e,!1)},getValue:function(){return this.element.node.files}})
...
this.element=t,this.root=t.root,this.name=i,this.proxies=[],s=o.n||o,"string"!=typeof s&&(s=new r({template:s,root:this.root,owner:this.element})),this.action=s,o.d?(this.dynamicParams=new r({template:o.d,root:this.root,owner:this.element}),this.fire=n):o.a&&(this.params=o.a,this.fire=e)}}(o),Pi=function(t,e,n,r){"string"!=typeof this.action&&this.action.rebind(t,e,n,r),this.dynamicParams&&this.dynamicParams.rebind(t,e,n,r)},Mi=function(t){var e,n
...
this.node=this.element.node,(i=e.registries.events.find(this.root,o))?this.custom=i(this.node,r(o)):("on"+o in this.node||window&&"on"+o in window||t('Missing "'+this.name+'" event. You may need to download a plugin via http://docs.ractivejs.org/latest/plugins#events'),this.node.addEventListener(o,n,!1)),this.node._ractive.events[o]=this}}(M,ze,Mi),Bi=function(){"string"!=typeof this.action&&this.action.teardown(),this.dynamicParams&&this.dynamicParams.teardown()},Di=function(t){return function(){this.custom?this.custom.teardown():this.node.removeEventListener(this.name,t,!1)}}(Mi),Ui=function(t,e,n,r,i,o){var s=function(t,e,n){this.init(t,e,n)}
return s.prototype={fire:t,init:e,rebind:n,render:r,teardown:i,unrender:o},s}(Li,ji,Pi,Fi,Bi,Di),Vi=function(t){return function(e,n){var r,i,o,s,a=[]
...
r.actual=e,r.ready=!0},update:function(){this.actual.update?this.actual.update.apply(this.root,this.params):(this.actual.teardown(!0),this.init())},teardown:function(t){this.actual.teardown(),!t&&this.fragment&&this.fragment.unbind()}},o}(Qn,o,ze),qi=function(t){function e(t,e){for(var n=t.length;n--;)if(t[n]==e)return!0}return function(n){var r,i,o,s,a
...
this.type=t.ELEMENT,h=this.parentFragment=u.parentFragment,f=this.template=u.template,this.parent=u.pElement||h.pElement,this.root=l=h.root,this.index=u.index,this.name=e(f.e),"option"===this.name&&a(this,f),"select"===this.name&&(this.options=[],this.bubble=s),this.attributes=n(this,f.a),f.f&&(this.fragment=new c({template:f.f,root:l,owner:this,pElement:this})),l.twoway&&(p=r(this,f.a))&&(this.binding=p,d=this.root._twowayBindings[p.keypath]||(this.root._twowayBindings[p.keypath]=[]),d.push(p)),f.v&&(this.eventHandlers=i(this,f.v)),f.o&&(this.decorator=new o(this,f.o)),this.intro=f.t0||f.t1,this.outro=f.t0||f.t2}}(W,$r,vi,Ii,Vi,Wi,zi,$i,o),Ji=function(t){return function(e,n){return e===n||t(e,n)}}(Jn),Gi=function(t,e){return function(n,r,i,o){var s=n[r]
s&&!t(s,o)&&t(s,i)&&(n[r]=e(s,i,o))}}(Ji,Gn),Qi=function(t){return function(e,n,r,i){function o(t){t.rebind(e,n,r,i)}var s,a,u,c
...
this.node&&(a=this.node._ractive)&&(t(a,"keypath",r,i),void 0!=e&&(a.index[e]=n))}}(Gi),Xi=function(t){var e,n,r;((e=t.getAttribute("width"))||(n=t.getAttribute("height")))&&t.node.addEventListener("load",r=function(){e&&(t.node.width=e.value),n&&(t.node.height=n.value),t.node.removeEventListener("load",r,!1)},!1)},Yi=function(t,e,n){var r,i={}
return n.push(function(){r=n.Fragment}),function(n,o,s){var a,u,c,h=this
return h.element=n,h.root=a=n.root,h.isIntro=s,u=o.n||o,"string"!=typeof u&&(c=new r({template:u,root:a,owner:n}),u=c.toString(),c.unbind()),h.name=u,o.a?h.params=o.a:o.d&&(c=new r({template:o.d,root:a,owner:n}),h.params=c.getValue(i),c.unbind()),h._fn=e.registries.transitions.find(a,u),h._fn?void 0:void t.error({debug:a.debug,message:"missingPlugin",args:{plugin:"transition",name:u}})}}(Qn,ze,o),Zi=function(t){return t.replace(/-([a-zA-Z])/g,function(t,e){return e.toUpperCase()})},to=function(t,e,n,r){var i,o,s
...
break}return o[t]}):i=null,i}(O,I,S,Zi),eo=function(t,e,n,r){var i,o
...
return i}):i=null,i}(be,O,a,to),no=function(t){return function(e,n){var r
if("string"==typeof e)this.node.style[t(e)]=n
else for(r in e)e.hasOwnProperty(r)&&(this.node.style[t(r)]=e[r])
return this}}(to),ro=function(t,e,n){function r(t){return t}var i=function(i){var o
this.duration=i.duration,this.step=i.step,this.complete=i.complete,"string"==typeof i.easing?(o=i.root.easing[i.easing],o||(t('Missing easing function ("'+i.easing+'"). You may need to download a plugin from [TODO]'),o=r)):o="function"==typeof i.easing?i.easing:r,this.easing=o,this.start=e(),this.end=this.start+this.duration,this.running=!0,n.add(this)}
return i.prototype={tick:function(t){var e,n
return this.running?t>this.end?(this.step&&this.step(1),this.complete&&this.complete(1),!1):(e=t-this.start,n=this.easing(e/this.duration),this.step&&this.step(n),!0):!1},stop:function(){this.abort&&this.abort(),this.running=!1}},i}(M,j,P),io=function(t){var e=new RegExp("^-(?:"+t.join("|")+")-")
...
for(r=k.length;r--;)n=k[r],t.node.style[n.name]=n.interpolator(e)+n.suffix},complete:function(){w=!0,_()}}):w=!0,h.length||(t.node.removeEventListener(l,x,!1),E=!0,_())},0)},c.delay||0)}):c=null,c}(O,M,S,Zi,He,ro,to,io,oo),ao=function(t){function e(){u.hidden=document[i]}function n(){u.hidden=!0}function r(){u.hidden=!1}var i,o,s,a,u
...
return h&&(n("t.animateStyle returns a Promise as of 0.4.0. Transition authors should do t.animateStyle(...).then(callback)"),p.then(h)),p}):a=null,a}(be,O,M,p,to,so,ao),co=function(t,e){var n
for(n in e)!e.hasOwnProperty(n)||n in t||(t[n]=e[n])
...
return s.push(function(){a=s.Fragment}),u=function(t,e,n){this.init(t,e,n)},u.prototype={init:t,start:o,getStyle:e,setStyle:n,animateStyle:r,processParams:i},u}(Yi,eo,no,uo,ho,fo,o),po=function(t,e,n,r,i,o,s,a,u,c,h){function f(e){var n,r,i
...
a.registerTransition(m),a.scheduleTask(function(){return m.start()})}return"option"===this.name&&l(this),this.node.autofocus&&a.scheduleTask(function(){return n.node.focus()}),p(this),this.node}}(k,a,M,q,S,A,Ve,w,g,Xi,lo),go=function(t,e){function n(t){var n,r,i
...
return g.prototype={bubble:t,detach:e,find:n,findAll:r,findAllComponents:i,findComponent:o,findNextNode:s,firstNode:a,getAttribute:u,init:c,rebind:h,render:f,toString:l,unbind:p,unrender:d},g}(Fr,Br,Dr,Ur,Vr,Wr,qr,zr,Hr,Ki,Qi,po,go,mo,yo),wo=function(){function t(t,e){var r=n.exec(e)[0]
return null===t||r.length<t.length?r:t}var e=/^\s*$/,n=/^\s*/
return function(n){var r,i,o,s
...
return e.partials[o]=a.t}return t.error({debug:e.debug,message:"noTemplateForPartial",args:{name:o}}),[]}}(Qn,ze,Fe,wo),_o=function(t,e){var n
...
return o=t.parentFragment,a=t.root,s={content:r||[]},i=new e({append:!0,data:n,partials:s,magic:a.magic||e.defaults.magic,modifyArrays:a.modifyArrays,_parent:a,_component:t,adapt:a.adapt})},Po=function(t){return function(e,n){n.forEach(function(n){var r,i
t(e,e.root,n.parentKeypath,n.childKeypath),r=e.instance.viewmodel.get(n.childKeypath),i=e.root.viewmodel.get(n.parentKeypath),void 0!==r&&void 0===i&&e.root.viewmodel.set(n.parentKeypath,r)})}}(m),Mo=function(t){function e(e,n,r,i){"string"!=typeof i&&t.error({debug:n.debug,message:"noComponentEventArguments"}),e.on(r,function(){var t=Array.prototype.slice.call(arguments)
t.unshift(i),n.fire.apply(n,t)})}return function(t,n){var r
for(r in n)n.hasOwnProperty(r)&&e(t.instance,t.root,r,n[r])}}(Qn),Fo=function(t){var e,n
...
return p.prototype={detach:t,find:e,findAll:n,findAllComponents:r,findComponent:i,findNextNode:o,firstNode:s,init:a,rebind:u,render:c,toString:h,unbind:f,unrender:l},p}(So,Oo,Ao,To,No,Co,Ro,Bo,Do,Uo,Vo,Wo,qo),Ho=function(t,e){var n=function(e){this.type=t.COMMENT,this.value=e.template.c}
...
default:throw new Error("Something very strange happened. Please file an issue at https://github.com/ractivejs/ractive/issues. Thanks!")}}}(W,zn,sr,xr,Mr,bo,xo,ko,zo,Ho),Ko=function(t,e,n){return function(r){var i,o,s,a=this
...
for(s in o)this.indexRefs[s]=o[s]}this.priority=i?i.priority+1:1,r.indexRef&&(this.indexRefs||(this.indexRefs={}),this.indexRefs[r.indexRef]=r.index),"string"==typeof r.template?r.template=[r.template]:r.template||(r.template=[]),this.items=r.template.map(function(t,e){return n({parentFragment:a,pElement:r.pElement,template:t,index:e})}),this.value=this.argsList=null,this.dirtyArgs=this.dirtyValue=!0,this.inited=!0}}(W,q,$o),Jo=function(t){return function(e,n,r,i){t(this,"context",r,i),this.indexRefs&&void 0!==this.indexRefs[e]&&(this.indexRefs[e]=n),this.items.forEach(function(t){t.rebind&&t.rebind(e,n,r,i)})}}(Gi),Go=function(){var t
return 1===this.items.length?t=this.items[0].render():(t=document.createDocumentFragment(),this.items.forEach(function(e){t.appendChild(e.render())})),this.rendered=!0,t},Qo=function(t){return this.items?this.items.map(function(e){return e.toString(t)}).join(""):""},Xo=function(){function t(t){t.unbind&&t.unbind()}return function(){this.items.forEach(t)}}(),Yo=function(t){if(!this.rendered)throw new Error("Attempted to unrender a fragment that was not rendered")
this.items.forEach(function(e){return e.unrender(t)})},Zo=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v){var m=function(t){this.init(t)}
return m.prototype={bubble:t,detach:e,find:n,findAll:r,findAllComponents:i,findComponent:o,findNextNode:s,firstNode:a,getNode:u,getValue:c,init:h,rebind:f,render:l,toString:p,unbind:d,unrender:g},v.Fragment=m,m}(Rn,In,Ln,jn,Pn,Mn,Fn,Bn,Dn,Un,Ko,Jo,Go,Qo,Xo,Yo,o),ts=function(t,e,n){var r=["template","partials","components","decorators","events"]
...
return t.end(),a&&c.then(a.bind(this)),c}}(w,u,R,gn),is=function(t){return t("shift")}(On),os=function(t){return t("sort")}(On),ss=function(t){return t("splice")}(On),as=function(t){return function(e,n){return t(this,e,void 0===n?-1:-n)}}(N),us=function(t){return function(e){var n
...
return"string"!=typeof e&&t.errorOnly({debug:this.debug,messsage:"badArguments",arg:{arguments:e}}),r=this.get(e),this.set(e,!r,n)}}(Qn),hs=function(){return this.fragment.toString(!0)},fs=function(t,e,n){return function(){var r,i,o=this
...
return this.fragment.unrender(i),this.rendered=!1,t(this.el.__ractive_instances__,this),e.end(),r}}(l,w,Nn),ls=function(t){return t("unshift")}(On),ps=function(t){return function(e,n){var r
...
return"string"!=typeof t&&(t="",e=!0),n(this,t,r={},e),this.set(r)}}(Ai,v),gs=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v,m,y,b,w,E,_,x,k,S,O,A,T,N,C,R){return{add:t,animate:e,detach:n,find:r,findAll:i,findAllComponents:o,findComponent:s,fire:a,get:u,insert:c,merge:h,observe:f,off:l,on:p,pop:d,push:g,render:v,reset:m,resetTemplate:y,reverse:b,set:w,shift:E,sort:_,splice:x,subtract:k,teardown:S,toggle:O,toHTML:A,unrender:T,unshift:N,update:C,updateModel:R}}(C,Ke,Je,Ge,sn,an,un,cn,hn,ln,pn,bn,_n,xn,An,Tn,Cn,ts,es,ns,rs,is,os,ss,as,us,cs,hs,fs,ls,ps,ds),vs=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(t){var e,n
...
e(u,o,{value:s})}),o={},o.__proto__?(s=function(t){t.__proto__=u},a=function(t){t.__proto__=Array.prototype}):(s=function(t){var n,r
for(n=c.length;n--;)r=c[n],e(t,r,{value:u[r],configurable:!0})},a=function(t){var e
for(e=c.length;e--;)delete t[c[e]]}),s.unpatch=a,s}(w,A,kn,Sn,ys),ws=function(t,e,n){var r,i,o
return r={filter:function(t){return e(t)&&(!t._ractive||!t._ractive.setting)},wrap:function(t,e,n){return new i(t,e,n)}},i=function(e,r,i){this.root=e,this.value=r,this.keypath=i,r._ractive||(t(r,"_ractive",{value:{wrappers:[],instances:[],setting:!1},configurable:!0}),n(r)),r._ractive.instances[e._guid]||(r._ractive.instances[e._guid]=0,r._ractive.instances.push(e)),r._ractive.instances[e._guid]+=1,r._ractive.wrappers.push(this)},i.prototype={get:function(){return this.value},teardown:function(){var t,e,r,i,s
if(t=this.value,e=t._ractive,r=e.wrappers,i=e.instances,e.setting)return!1
if(s=r.indexOf(this),-1===s)throw new Error(o)
if(r.splice(s,1),r.length){if(i[this.root._guid]-=1,!i[this.root._guid]){if(s=i.indexOf(this.root),-1===s)throw new Error(o)
i.splice(s,1)}}else delete t._ractive,n.unpatch(this.value)}},o="Something went wrong in a rather interesting way",r}(A,a,bs),Es=function(t,e){var n,r
...
return n=e.split("."),r=t(n.length),i=function(t,e){return t?"*":n[e]},o=r.map(function(t){return t.map(i).join(".")})}}(),Ss=function(t){function e(e,i,o){var s
...
return e}(ks),Os=function(t,e){function n(t){t.update()}function r(t,e,n){var r,i;(r=o(t,e,n))&&(i=t.get(e),r.forEach(function(t){return t.setValue(i)}))}function i(t,e,n){function r(t){t.forEach(i),t.forEach(s)}function i(e){var r=o(t,e,n)
...
f=n(u,c),f.forEach(function(e,n){-1===e&&p.mark(t+"."+n)}),this.set(t,s,!0),(l=this.deps["default"][t])&&l.filter(r).forEach(function(t){return t.merge(f)}),i.length!==s.length&&this.mark(t+".length",!0)}}(W,M,Ls),Ps=function(){function t(t,e,n){var r,i,o,s
...
void 0===r&&(r="default")
var i,o,s
n.isStatic||(i=this.deps[r]||(this.deps[r]={}),o=i[e]||(i[e]=[]),o.push(n),e&&((s=this.evaluators[e])&&(s.dependants||s.wake(),s.dependants+=1),t(this,e,r)))}}(),Ms=function(){return this.capturing=!1,this.captured},Fs=function(t,e){return function(n,r,i){var o,s,a,u,c,h,f,l
...
this.compute()&&!e(this.value,t)&&this.ractive.viewmodel.mark(this.key)}},r}(Qn,v,Xn),qs=function(t,e){return function(n,r){var i,o
...
void 0===n&&(n={}),a(e,n),t.init(e.constructor,e,n),e.viewmodel=new i(e),e.viewmodel.compute(),e.template&&(e.fragment=new o({template:e.template,root:e,owner:e})),e.viewmodel.applyChanges(),s(e)}}(ze,q,fn,ms,Hs,Zo),Ks=function(t){return function(e,n,r){e.beforeInit&&e.beforeInit(r),t(e,r)}}($s),Js=function(t,e,n,r){function i(e,n,r){for(var i in r)if(!(i in u)&&r.hasOwnProperty(i)){var o=r[i]
...
return p}(r,i,h,f,x,T,gs,p,mi,Gs,je,$s,o)
"undefined"!=typeof e&&e.exports?e.exports=Qs:"function"==typeof define&&define.amd&&define(function(){return Qs}),t.Ractive=Qs,Qs.noConflict=function(){return t.Ractive=n,Qs}}("undefined"!=typeof window?window:this)},{}],101:[function(){},{}],102:[function(t,e,n){function r(t,e,n){if(!(this instanceof r))return new r(t,e,n)
var i,o=typeof t
if("number"===o)i=t>0?t>>>0:0
else if("string"===o)"base64"===e&&(t=T(t)),i=r.byteLength(t,e)
...
return i}function a(t,e,n,r){return s(t,e,n,r)}function u(t,e,n,r){var i=F(M(e),t,n,r)
return i}function c(t,e,n,r){var i=F(P(e),t,n,r)
...
var o=t.length
if(!(n>=o))return e>=0?_(t,e,n,r,i):_(t,65535+e+1,n,r,i),n+2}function S(t,e,n,r,i){i||(W(void 0!==e&&null!==e,"missing value"),W("boolean"==typeof r,"missing or invalid endian"),W(void 0!==n&&null!==n,"missing offset"),W(n+3<t.length,"Trying to write beyond buffer length"),U(e,2147483647,-2147483648))
var o=t.length
if(!(n>=o))return e>=0?x(t,e,n,r,i):x(t,4294967295+e+1,n,r,i),n+4}function O(t,e,n,r,i){i||(W(void 0!==e&&null!==e,"missing value"),W("boolean"==typeof r,"missing or invalid endian"),W(void 0!==n&&null!==n,"missing offset"),W(n+3<t.length,"Trying to write beyond buffer length"),V(e,3.4028234663852886e38,-3.4028234663852886e38))
var o=t.length
if(!(n>=o))return z.write(t,e,n,r,23,4),n+4}function A(t,e,n,r,i){i||(W(void 0!==e&&null!==e,"missing value"),W("boolean"==typeof r,"missing or invalid endian"),W(void 0!==n&&null!==n,"missing offset"),W(n+7<t.length,"Trying to write beyond buffer length"),V(e,1.7976931348623157e308,-1.7976931348623157e308))
var o=t.length
if(!(n>=o))return z.write(t,e,n,r,52,8),n+8}function T(t){for(t=N(t).replace($,"");t.length%4!==0;)t+="="
...
return i}function M(t){return q.toByteArray(t)}function F(t,e,n,r){for(var i=0;r>i&&!(i+n>=e.length||i>=t.length);i++)e[i+n]=t[i]
...
var $=/[^+\/0-9A-z]/g},{"base64-js":103,ieee754:104}],103:[function(t,e,n){var r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
...
t.toByteArray=n,t.fromByteArray=i}("undefined"==typeof n?this.base64js={}:n)},{}],104:[function(t,e,n){n.read=function(t,e,n,r,i){var o,s,a=8*i-r-1,u=(1<<a)-1,c=u>>1,h=-7,f=n?i-1:0,l=n?-1:1,p=t[e+f]
...
for(e=Math.abs(e),isNaN(e)||1/0===e?(a=isNaN(e)?1:0,s=h):(s=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-s))<1&&(s--,u*=2),e+=s+f>=1?l/u:l*Math.pow(2,1-f),e*u>=2&&(s++,u/=2),s+f>=h?(a=0,s=h):s+f>=1?(a=(e*u-1)*Math.pow(2,i),s+=f):(a=e*Math.pow(2,f-1)*Math.pow(2,i),s=0));i>=8;t[n+p]=255&a,p+=d,a/=256,i-=8);for(s=s<<i|a,c+=i;c>0;t[n+p]=255&s,p+=d,s/=256,c-=8);t[n+p-d]|=128*g}},{}],105:[function(t,e){function n(){this._events=this._events||{},this._maxListeners=this._maxListeners||void 0}function r(t){return"function"==typeof t}function i(t){return"number"==typeof t}function o(t){return"object"==typeof t&&null!==t}function s(t){return void 0===t}e.exports=n,n.EventEmitter=n,n.prototype._events=void 0,n.prototype._maxListeners=void 0,n.defaultMaxListeners=10,n.prototype.setMaxListeners=function(t){if(!i(t)||0>t||isNaN(t))throw TypeError("n must be a positive number")
...
return n=t._events&&t._events[e]?r(t._events[e])?1:t._events[e].length:0}},{}],106:[function(t,e){var n=e.exports,r=(t("events").EventEmitter,t("./lib/request")),i=t("url")
...
return-1}},{"./response":108,Base64:109,inherits:110,stream:129}],108:[function(t,e){function n(t){for(var e=t.getAllResponseHeaders().split(/\r?\n/),n={},r=0;r<e.length;r++){var i=e[r]
...
var a=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)}},{stream:129,util:132}],109:[function(t,e,n){!function(){function t(t){this.message=t}var e="undefined"!=typeof n?n:this,r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
...
return a})}()},{}],110:[function(t,e){e.exports=t(46)},{}],111:[function(t,e){function n(){}var r=e.exports={}
...
r()}},!0),function(t){n.push(t),window.postMessage("process-tick","*")}}return function(t){setTimeout(t,0)}}(),r.title="browser",r.browser=!0,r.env={},r.argv=[],r.on=n,r.addListener=n,r.once=n,r.off=n,r.removeListener=n,r.removeAllListeners=n,r.emit=n,r.binding=function(){throw new Error("process.binding is not supported")},r.cwd=function(){return"/"},r.chdir=function(){throw new Error("process.chdir is not supported")}},{}],112:[function(t,e,n){(function(t){!function(r){function i(t){throw RangeError(L[t])}function o(t,e){for(var n=t.length;n--;)t[n]=e(t[n])
...
return P(r+(j+1)*t/(t+S))}function l(t){var e,n,r,o,s,a,h,l,p,d,g=[],v=t.length,m=0,y=T,b=A
...
for(t=a(t),v=t.length,e=T,n=0,s=A,u=0;v>u;++u)g=t[u],128>g&&w.push(M(g))
...
w.push(M(h(l,0))),s=f(n,m,r==o),n=0,++r}++n,++e}return w.join("")}function d(t){return s(t,function(t){return C.test(t)?l(t.slice(4).toLowerCase()):t})}function g(t){return s(t,function(t){return R.test(t)?"xn--"+p(t):t})}var v="object"==typeof n&&n,m="object"==typeof e&&e&&e.exports==v&&e,y="object"==typeof t&&t;(y.global===y||y.window===y)&&(r=y)
var b,w,E=2147483647,_=36,x=1,k=26,S=38,O=700,A=72,T=128,N="-",C=/^xn--/,R=/[^ -~]/,I=/\x2E|\u3002|\uFF0E|\uFF61/g,L={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},j=_-x,P=Math.floor,M=String.fromCharCode
...
else r.punycode=b}(this)}).call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],113:[function(t,e){"use strict"
...
var r=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)}},{}],114:[function(t,e){"use strict"
...
return e}},{}],115:[function(t,e,n){"use strict"
n.decode=n.parse=t("./decode"),n.encode=n.stringify=t("./encode")},{"./decode":113,"./encode":114}],116:[function(t,e){e.exports=t("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":117}],117:[function(t,e){e.exports=t(40)},{"./_stream_readable":119,"./_stream_writable":121,Jd0h76:111,"core-util-is":122,inherits:110}],118:[function(t,e){e.exports=t(41)},{"./_stream_transform":120,"core-util-is":122,inherits:110}],119:[function(t,e){e.exports=t(42)},{Jd0h76:111,buffer:102,"core-util-is":122,events:105,inherits:110,isarray:123,stream:129,"string_decoder/":124}],120:[function(t,e){e.exports=t(43)},{"./_stream_duplex":117,"core-util-is":122,inherits:110}],121:[function(t,e){e.exports=t(44)},{"./_stream_duplex":117,Jd0h76:111,buffer:102,"core-util-is":122,inherits:110,stream:129}],122:[function(t,e){e.exports=t(45)},{buffer:102}],123:[function(t,e){e.exports=t(47)},{}],124:[function(t,e){e.exports=t(48)},{buffer:102}],125:[function(t,e){e.exports=t("./lib/_stream_passthrough.js")},{"./lib/_stream_passthrough.js":118}],126:[function(t,e){e.exports=t(49)},{"./lib/_stream_duplex.js":117,"./lib/_stream_passthrough.js":118,"./lib/_stream_readable.js":119,"./lib/_stream_transform.js":120,"./lib/_stream_writable.js":121}],127:[function(t,e){e.exports=t("./lib/_stream_transform.js")},{"./lib/_stream_transform.js":120}],128:[function(t,e){e.exports=t("./lib/_stream_writable.js")},{"./lib/_stream_writable.js":121}],129:[function(t,e){function n(){r.call(this)}e.exports=n
...
if(!g)for(var v=this.hostname.split(/\./),c=0,A=v.length;A>c;c++){var T=v[c]
if(T&&!T.match(E)){for(var N="",C=0,R=T.length;R>C;C++)N+=T.charCodeAt(C)>127?"x":T[C]
...
this.host=D+B,this.href+=this.host,g&&(this.hostname=this.hostname.substr(1,this.hostname.length-2),"/"!==r[0]&&(r="/"+r))}if(!x[o])for(var c=0,A=m.length;A>c;c++){var U=m[c],V=encodeURIComponent(U)
V===U&&(V=escape(U)),r=r.split(U).join(V)}var W=r.indexOf("#");-1!==W&&(this.hash=r.substr(W),r=r.slice(0,W))
var q=r.indexOf("?")
if(-1!==q?(this.search=r.substr(q),this.query=r.substr(q+1),e&&(this.query=O.parse(this.query)),r=r.slice(0,q)):e&&(this.search="",this.query={}),r&&(this.pathname=r),S[o]&&this.hostname&&!this.pathname&&(this.pathname="/"),this.pathname||this.search){var B=this.pathname||"",F=this.search||""
...
e&&(e=e[0],":"!==e&&(this.port=e.substr(1)),t=t.substr(0,t.length-e.length)),t&&(this.hostname=t)}},{punycode:112,querystring:115}],131:[function(t,e){e.exports=function(t){return t&&"object"==typeof t&&"function"==typeof t.copy&&"function"==typeof t.fill&&"function"==typeof t.readUInt8}},{}],132:[function(t,e,n){(function(e,r){function i(t,e){var r={seen:[],stylize:s}
...
if(0===s.length){if(O(e)){var v=e.name?": "+e.name:""
...
return i>60?n[0]+(""===e?"":e+"\n ")+" "+t.join(",\n  ")+" "+n[1]:n[0]+e+" "+t.join(", ")+" "+n[1]}function d(t){return Array.isArray(t)}function g(t){return"boolean"==typeof t}function v(t){return null===t}function m(t){return null==t}function y(t){return"number"==typeof t}function b(t){return"string"==typeof t}function w(t){return"symbol"==typeof t}function E(t){return void 0===t}function _(t){return x(t)&&"[object RegExp]"===T(t)}function x(t){return"object"==typeof t&&null!==t}function k(t){return x(t)&&"[object Date]"===T(t)}function S(t){return x(t)&&("[object Error]"===T(t)||t instanceof Error)}function O(t){return"function"==typeof t}function A(t){return null===t||"boolean"==typeof t||"number"==typeof t||"string"==typeof t||"symbol"==typeof t||"undefined"==typeof t}function T(t){return Object.prototype.toString.call(t)}function N(t){return 10>t?"0"+t.toString(10):t.toString(10)}function C(){var t=new Date,e=[N(t.getHours()),N(t.getMinutes()),N(t.getSeconds())].join(":")
return[t.getDate(),P[t.getMonth()],e].join(" ")}function R(t,e){return Object.prototype.hasOwnProperty.call(t,e)}var I=/%[sdj%]/g
...
return t}}).call(this,t("Jd0h76"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./support/isBuffer":131,Jd0h76:111,inherits:110}]},{},[2])
