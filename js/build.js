...
v.on("current",g.setCurrent),u.debug&&(window.debug=t("./debug"))},{"./debug":1,"./mainViewModel":3,"./routing":4,"level-sublevel":6,levelup:22,"localstorage-down":46,"noddity-butler":57,"noddity-linkifier":83}],3:[function(t,e){function n(){}var r=t("ractive"),i=noddityConfig,o=t("noddity-renderer")
...
return i.sidebar&&t.getPost(i.sidebar,function(t,e){t?g.set("html",t.message):h.populateRootRactive(e,g)}),e.on("link",function(e){t.getPost(e,n)}),t.on("post changed",c),t.on("index changed",s),{setCurrent:u}}},{"noddity-renderer":84,ractive:94}],4:[function(t,e){var n=noddityConfig,r=t("events").EventEmitter
...
return setTimeout(e.go.bind(e),0),t}},{events:100}],5:[function(t,e){function n(t,e,n,r){var i={type:t,key:e,value:n,options:r}
...
var h=u.batch
return u.batch=function(t,e,n){return Array.isArray(t)?(t.forEach(function(t){t.prefix&&("function"==typeof t.prefix.prefix?t.key=t.prefix.prefix(t.key):"string"==typeof t.prefix&&(t.key=t.prefix+t.key))}),void h.call(u,t,e,n)):new i(u)},u}}).call(this,t("Zh58VX"))},{"./batch":5,"./sub":17,Zh58VX:106,events:100,"level-fix-range":7,"level-hooks":9}],7:[function(t,e){var n=t("clone")
...
var e=function(){}
return e.prototype=t,new e}}).call(this,t("buffer").Buffer)},{buffer:96}],9:[function(t,e){var n=t("string-range")
...
e.exports=n},{"./batch":5,events:100,"level-fix-range":7,"string-range":10,util:127,xtend:12}],18:[function(t,e){function n(t,e){this._levelup=t,this._codec=e,this.batch=t.db.batch(),this.ops=[]}var r=t("./util"),i=t("./errors").WriteError,o=r.getOptions,a=r.dispatchError
...
return this.isOpen()?r.setIterator(e.db.iterator(t)):this.once("ready",function(){r.setIterator(e.db.iterator(t))}),r},i.prototype.keyStream=i.prototype.createKeyStream=function(t){return this.createReadStream(l(t,{keys:!0,values:!1}))},i.prototype.valueStream=i.prototype.createValueStream=function(t){return this.createReadStream(l(t,{keys:!1,values:!0}))},i.prototype.writeStream=i.prototype.createWriteStream=function(t){return new E(l(t),this)},i.prototype.toString=function(){return"LevelUP"},e.exports=i,e.exports.copy=_.copy,e.exports.destroy=u("destroy"),e.exports.repair=u("repair")}).call(this,t("Zh58VX"))},{"./batch":18,"./codec":19,"./errors":21,"./read-stream":23,"./util":24,"./write-stream":25,Zh58VX:106,"deferred-leveldown":27,events:100,prr:33,util:127,xtend:44}],23:[function(t,e){function n(t,e){return this instanceof n?(r.call(this,{objectMode:!0,highWaterMark:t.highWaterMark}),this._waiting=!1,this._options=t,void(this._makeData=e)):new n(t,e)}{var r=t("readable-stream").Readable,i=t("util").inherits,o=(t("xtend"),t("./errors").EncodingError)
...
return t}()
e.exports={defaultOptions:l,copy:n,getOptions:r,getLevelDOWN:i,dispatchError:o,isDefined:a}},{"../package.json":45,"./encodings":20,"./errors":21,leveldown:95,"leveldown/package":95,semver:95,xtend:44}],25:[function(t,e){(function(n,r){function i(t,e){if(!(this instanceof i))return new i(t,e)
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._write?this._write(n):"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:106}],29:[function(t,e){(function(t){function n(t){this.db=t,this._ended=!1,this._nexting=!1}n.prototype.next=function(e){var n=this
...
return this._ended?e(new Error("end() already called on iterator")):(this._ended=!0,"function"==typeof this._end?this._end(e):void t.nextTick(e))},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:106}],30:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
...
s.inherits(r,u),o(a(c.prototype),function(t){r.prototype[t]||(r.prototype[t]=c.prototype[t])})}).call(this,t("Zh58VX"))},{"./_stream_readable":36,"./_stream_writable":38,Zh58VX:106,"core-util-is":39,inherits:40}],35:[function(t,e){function n(t){return this instanceof n?void r.call(this,t):new n(t)}e.exports=n
...
for(var e=this._keys.length;e>=0;e--)this._keys[e]===t&&(this._keys.splice(e,1),window.localStorage.removeItem(t))},r.prototype.clear=function(){window.localStorage.clear()},r.prototype.length=function(){return this._keys.length},n.localStorage=r},{}],48:[function(t,e){e.exports=t(28)},{Zh58VX:106}],49:[function(t,e){e.exports=t(29)},{Zh58VX:106}],50:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
if("string"!=typeof t)throw new Error("constructor requires a location string argument")
this.location=t}var o=t("xtend"),a=t("./abstract-iterator"),s=t("./abstract-chained-batch")
i.prototype.open=function(t,e){if("function"==typeof t&&(e=t),"function"!=typeof e)throw new Error("open() requires a callback argument")
return"object"!=typeof t&&(t={}),"function"==typeof this._open?this._open(t,e):void n.nextTick(e)},i.prototype.close=function(t){if("function"!=typeof t)throw new Error("close() requires a callback argument")
...
return t=o(t),["start","end","gt","gte","lt","lte"].forEach(function(n){t[n]&&e._isBuffer(t[n])&&0===t[n].length&&delete t[n]}),t.reverse=!!t.reverse,t.reverse&&t.lt&&(t.start=t.lt),t.reverse&&t.lte&&(t.start=t.lte),!t.reverse&&t.gt&&(t.start=t.gt),!t.reverse&&t.gte&&(t.start=t.gte),(t.reverse&&t.lt&&!t.lte||!t.reverse&&t.gt&&!t.gte)&&(t.exclusiveStart=!0),t},i.prototype.iterator=function(t){return"object"!=typeof t&&(t={}),t=this._setupIteratorOptions(t),"function"==typeof this._iterator?this._iterator(t):new a(this)},i.prototype._chainedBatch=function(){return new s(this)},i.prototype._isBuffer=function(t){return r.isBuffer(t)},i.prototype._checkKeyValue=function(t,e){if(null===t||void 0===t)return new Error(e+" cannot be `null` or `undefined`")
if(null===t||void 0===t)return new Error(e+" cannot be `null` or `undefined`")
if(this._isBuffer(t)){if(0===t.length)return new Error(e+" cannot be an empty Buffer")}else if(""===String(t))return new Error(e+" cannot be an empty String")},e.exports.AbstractLevelDOWN=i,e.exports.AbstractIterator=a,e.exports.AbstractChainedBatch=s}).call(this,t("Zh58VX"),t("buffer").Buffer)},{"./abstract-chained-batch":48,"./abstract-iterator":49,Zh58VX:106,buffer:96,xtend:52}],51:[function(t,e){e.exports=t(11)},{}],52:[function(t,e,n){arguments[4][12][0].apply(n,arguments)},{"./has-keys":51,"object-keys":54}],53:[function(t,e){var n=Object.prototype.hasOwnProperty,r=Object.prototype.toString,i=function(t){var e="function"==typeof t&&!(t instanceof RegExp)||"[object Function]"===r.call(t)
...
return v.on("expire",l),g.on("expire",h),y.stop=c,y.get=function(t,e){p.get(t,function(n,r){n&&n.notFound?l(t,f(t,e)):e&&f(t,e)(n,r)})},y.getLocal=function(t,e){p.get(t,f(t,e))},y.refresh=function(t,e){l(t,f(t,e))},y}},{asynquence:61,events:100,"expire-unused-keys":64,extend:62,"level-sublevel":6,stringmap:65}],64:[function(t,e){function n(t){function e(){n=!1}var n=!1
...
return o.touch=o.emit.bind(o,"touch"),o.forget=o.emit.bind(o,"forget"),o.stop=function(){clearInterval(u)},o}},{events:100}],65:[function(t,e){var n=function(){"use strict"
...
"undefined"!=typeof e&&"undefined"!=typeof e.exports&&(e.exports=n)},{}],66:[function(t,e){var n=t("http"),r=t("url"),i=(t("concat-stream"),t("text-metadata-parser"))
...
e.exports.toByteArray=t,e.exports.fromByteArray=n}()},{}],70:[function(t,e){function n(t,e,n){e=void 0===e?0:e,n=void 0===n?t.length:n
...
var a=t("base64-js"),s={hex:r,utf8:i,base64:o}},{"base64-js":69}],74:[function(t,e){e.exports=function(t){return t instanceof Uint8Array}},{}],75:[function(t,e){function n(t,e){if(!t.length)return new Uint8Array(0)
...
return e}e.exports=n},{}],76:[function(t,e){function n(t){return new DataView(t.buffer,0)}function r(t){var e=o.get(t.buffer)
return e||o.set(t.buffer,e=new DataView(t.buffer,0)),e}var i,o
e.exports=i={},o="undefined"==typeof WeakMap?null:new WeakMap,i.get=o?r:n},{}],77:[function(t,e){function n(t,e){return t[e]}function r(t,e){var n=t[e]
...
var v=t("./mapped.js")},{"./mapped.js":76}],78:[function(t,e){function n(t,e,n){return t.subarray(e||0,n||t.length)}e.exports=n},{}],79:[function(t,e){function n(t,e){return u[e||"utf8"](t)}function r(t){for(var e,n="",r=0,i=t.length;i>r;++r)e=t[r],n+=((240&e)>>>4).toString(16),n+=(15&e).toString(16)
return n}function i(t){return s(t)}function o(t){return a.fromByteArray(t)}e.exports=n
var a=t("base64-js"),s=t("to-utf8"),u={hex:r,utf8:i,base64:o}},{"base64-js":69,"to-utf8":70}],80:[function(t,e){function n(t,e,n){return t[n]=e}function r(t,e,n){return t[n]=0>e?e+256:e}function i(t,e,n){var r=v.get(t)
...
var v=t("./mapped.js")},{"./mapped.js":76}],81:[function(t,e){function n(t){for(var e=t.split("\n"),n=!1,r=!1,i={content:"",metadata:{}},o=0;o<e.length&&!r;o++)if(n)r||(r=!/^\s*$/.test(e[o]))
else{var a=/^([^:]+):\s*([^\r\n]+)\s*$/.exec(e[o])
...
e.exports=function(t){return u.extend(t)}},{extend:62}],83:[function(t,e){function n(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
...
return e.linkify=r.bind(null,e,t),e}},{events:100}],84:[function(t,e){function n(t,e){function n(t){u.mixinHtml(t),u.parseTemplate(t),u.mixinChildPosts(t),u.mixinRenderedHtmlEmitter(t),t.on("all child posts fetched",function(t){t.templateElements.forEach(n)})}function i(t,e){var r=u.makeNewMixinObject(t)
...
e.exports=n},{"./mixins":85}],85:[function(t,e){(function(n){function r(t){try{return new p({el:null,data:t.data,template:t.renderedHtml||t.html,preserveWhitespace:!0}).toHTML()}catch(e){return t.emit("error",e),e.message}}function i(t){var e=Object.create(new d)
...
var l,f,d,p,g,v=!1,m=!1,y=0,b=null,w=[],E=[],_=[],x=[],k=[],S=[],O=[],T=[],A=[],N={},R=[],L=[],C=[],I=[]
return l={start:function(t,e){this.addInstance(t),m||(y+=1,g=s(e,g))},end:function(){return m?void h():(--y||(m=!0,c(),m=!1,u()),g.init(),void(g=g._previous))},trigger:function(){return y||m?void h():(m=!0,c(),m=!1,void u())},focus:function(t){b=t},addInstance:function(t){t&&!I[t._guid]&&(I.push(t),I[I._guid]=!0)},addLiveQuery:function(t){w.push(t)},addDecorator:function(t){E.push(t)},addTransition:function(t){t._manager=g,g.push(t),_.push(t)},addObserver:function(t){x.push(t)},addAttribute:function(t){k.push(t)},addBinding:function(t){t.active=!0,S.push(t)},scheduleCssUpdate:function(){y||m?p=!0:e.update()},addEvaluator:function(t){v=!0,O.push(t)},addComputation:function(t){v=!0,T.push(t)},addSelectValue:function(t){v=!0,A.push(t)},addCheckbox:function(t){N[t.keypath]||(v=!0,R.push(t))},addRadio:function(t){v=!0,L.push(t)},addUnresolved:function(t){v=!0,C.push(t)},removeUnresolved:function(t){n(C,t)},detachWhenReady:function(t){g.detachQueue.push(t)}},t.runloop=l,l}(w,_,E,x,O,T,A,N),L=function(t,e,n){var r=[],i={tick:function(){var o,a,s
...
return t.push(function(){a=t.get}),t.set=o,o}(w,p,B,D,A),W=function(t,e,n,r){return function(i,o,a,s){var u,c,h,l,f,d,p,g,v,m
...
m||(e(u,c+".length"),n(u,c+".length",!0))}}}(F,D,A,U),V=function(t,e,n,r,i){var o,a,s,u=[],c=["pop","push","reverse","shift","sort","splice","unshift"]
...
l=i.adapt[h]=t[l]}if(l.filter(s,a,i))return f=i._wrapped[a]=l.wrap(i,s,a,o(a)),f.value=s,s}return u||(i.magic?r.filter(s,a,i)?i._wrapped[a]=r.wrap(i,s,a):n.filter(s,a,i)&&(i._wrapped[a]=n.wrap(i,s,a)):i.modifyArrays&&e.filter(s,a,i)&&(i._wrapped[a]=e.wrap(i,s,a))),s}}(j,q,z,H),$=function(){function t(t,e){var n,r,i
...
i=n+"="+r,a=t.bindings,a[i]||(a[i]=!0,o=t.instance,s=t.parentFragment.priority,c=new u(e,n,o,r,s),a.push(c),o.twoway&&(h=new u(o,r,e,n,1),a.push(h),c.counterpart=h,h.counterpart=c))}}(w,R,C,p,$,G),X=function(t,e,n){function r(t,r,i,o,a){n(r,o,a,!0),e(r.component,t,i,o)}var i
...
return s=i.split("."),u=s.pop(),c=s.join("."),h=a(t,c),(d=t._wrapped[c])&&(h=d.get()),null!==h&&void 0!==h?((l=t._cacheMap[c])?-1===l.indexOf(i)&&l.push(i):t._cacheMap[c]=[i],"object"!=typeof h||u in h?(p=!e.call(h,u),f=p?n(h[u]):h[u],f=r(t,i,f,!1),t._cache[i]=f,f):t._cache[i]=o):void 0}return t.get=a,a}(w,k,I,K,X,Z),Q=function(){return"undefined"!=typeof console&&"function"==typeof console.warn&&"function"==typeof console.warn.apply?function(){console.warn.apply(console,arguments)}:function(){}}(),te=function(){var t=Object.prototype.toString
...
return v=o(f,d),m=new r(function(t){y=t}),t.start(this,y),i(this,s,c,!0),a(this,s,v,g),t.end(),h&&h.complete&&m.then(h.complete),m}}(R,Q,C,g,U,ke,Se),Te=function(t,e,n){var r=function(t,e,n,r){var i=this
...
f&&(t=s._patternObservers.indexOf(l),-1!==t&&s._patternObservers.splice(t,1)),n(l)}}}}(v,$,G,Te,Ne),Le=function(t,e){return function(n,r,i){var o,a,s,u
if(t(n)){i=r,a=n,o=[]
...
t(e,this.value)||(this.evaluator.bubble(),this.value=e)},teardown:function(){n(this)}},r}(p,$,G),Ye=function(t,e,n,r,i,o,a,s){function u(t,e){var n,r
...
this.selfUpdating=this.refs.length+this.softRefs.length<=1}},c}(R,Q,p,D,A,K,$e,Ge),Xe=function(t,e,n,r,i){function o(t,e){return t.replace(/\$\{([0-9]+)\}/g,function(t,n){return e[n]?e[n].value||e[n].keypath:"undefined"})}function a(t){return"${"+t.replace(/[\.\[\]]/g,"-")+"}"}var s=function(r,i,o,a){var s,u,c,h=this
...
a.keypath&&(s=i(a.keypath,n,r))?(a.keypath=s,o=!0):a.indexRef===t&&(a.value=e,o=!0)}),o&&this.bubble()}},s}(E,O,Ke,Ye,De),Ze=function(t,e,n,r,i,o,a){var s=function(i,o,s){var c,h,l,f,d,p=this
...
if(this.resolver?this.resolver.reassign(e,n,r,i):this.keypath?(o=t(this.keypath,r,i),o&&this.resolve(o)):void 0!==e&&this.indexRef===e&&(this.value=n,this.render(n)),this.fragments)for(a=this.fragments.length;a--;)this.fragments[a].reassign(e,n,r,i)}}(De),nn=function(t,e,n,r){return{init:t,update:e,resolve:n,reassign:r}}(Je,Qe,tn,en),rn=function(t,e,n,r){var i,o,a
...
return t.replace(o,"&lt;").replace(a,"&gt;")}},i}(F,He,nn,qe),on=function(){var t=[]
...
for(r=this.fragments.length,n=0;r>n;n+=1)this.fragments[n].findAllComponents(t,e)}},s}(F,nn,on,sn,cn,He,w),ln=function(t,e,n,r,i){var o=function(e,r){this.type=t.TRIPLE,r&&(this.nodes=[],this.docFrag=document.createDocumentFragment()),this.initialising=!0,n.init(this,e),r&&r.appendChild(this.docFrag),this.initialising=!1}
...
for(i=this.nodes.length,r=0;i>r;r+=1)if(o=this.nodes[r],1===o.nodeType&&(e(o,t)&&n.push(o),a=o.querySelectorAll(t)))for(s=a.length,u=0;s>u;u+=1)n.push(a[u])}},o}(F,se,nn,Ve,He),fn=function(t){return function(e,n){return e.a&&e.a.xmlns?e.a.xmlns:"svg"===e.e?t.svg:n.namespaceURI||t.html}}(a),dn=function(){var t,e,n,r
...
return function(i){var o
return(o=t(i))?r.test(o.v)?o.v:'"'+o.v.replace(/"/g,'\\"')+'"':(o=e(i))?o.v:(o=n(i))?o:void 0}}(Tn,An,Nn),Ln=function(t,e,n,r){function i(t){var e,n,i
...
return n.result?{value:n.result.v,remaining:n.remaining()}:null}}(En,_n,Tn,Rn),Cn=function(t,e,n){function r(t){return"string"==typeof t?t:JSON.stringify(t)}var i=function(e){this.type=t.INTERPOLATOR,n.init(this,e)}
return i.prototype={update:n.update,resolve:n.resolve,reassign:n.reassign,render:function(t){this.value=t,this.parentFragment.bubble()},teardown:function(){e(this)},toString:function(){return void 0==this.value?"":r(this.value)}},i}(F,He,nn),In=function(t,e,n,r,i){var o,a
...
if("value"!==this.name||"select"!==this.element.lcName)return"name"===this.name&&"input"===this.element.lcName&&(e=this.interpolator)?"name={{"+(e.keypath||e.ref)+"}}":this.fragment?(t=this.fragment.toString(),this.name+"="+JSON.stringify(t)):this.name+"="+JSON.stringify(this.value)}},c}(R,F,pn,gn,vn,mn,bn,wn,Mn),Dn=function(t){return function(e,n,r){var i=new t({element:e,name:n,value:r,root:e.root,pNode:e.node})
...
e.index=n.index,e.keypath=n.keypath,e.context=n.root.get(n.keypath),n.events[t].fire(e)}},n}(Q,Mn),Kn=function(t){return function(e,n){var r,i,o
for(i in n)if(n.hasOwnProperty(i))for(o=i.split("-"),r=o.length;r--;)t(e,o[r],n[i])}}(Hn),$n=function(t){var e,n,r,i,o
e=t.root
...
while(t=t.parent)}return function(y,b,w){var E,_,x,k,S,O,T,A,N,R,L,C
if(y.type=e.ELEMENT,E=y.parentFragment=b.parentFragment,_=E.pNode,x=y.descriptor=b.descriptor,y.parent=b.pElement,y.root=R=E.root,y.index=b.index,y.lcName=x.e.toLowerCase(),y.eventListeners=[],y.customEventListeners=[],y.cssDetachQueue=[],_&&(k=y.namespace=u(x,_),S=k!==n.html?v(x.e):x.e,y.node=a(S,k),R.css&&_===R.el&&y.node.setAttribute("data-rvcguid",R.constructor._guid||R._guid),i(y.node,"_ractive",{value:{proxy:y,keypath:s(E),index:E.indexRefs,events:r(null),root:R}})),O=h(y,x.a),x.f){if(y.node&&y.node.getAttribute("contenteditable")&&y.node.innerHTML){if(C="A pre-populated contenteditable element should not have children",R.debug)throw new Error(C)
o(C)}l(y,y.node,x,w)}w&&x.v&&d(y,x.v),w&&(R.twoway&&(y.bind(),y.node.getAttribute("contenteditable")&&y.node._ractive.binding&&y.node._ractive.binding.update()),O.name&&!O.name.twoway&&O.name.update(),"IMG"===y.node.tagName&&((T=y.attributes.width)||(A=y.attributes.height))&&y.node.addEventListener("load",N=function(){T&&(y.node.width=T.value),A&&(y.node.height=A.value),y.node.removeEventListener("load",N,!1)},!1),w.appendChild(y.node),x.o&&f(x.o,R,y),x.t1&&g(x.t1,R,y,!0),"OPTION"===y.node.tagName&&("SELECT"===_.tagName&&(L=_._ractive.binding)&&L.deferUpdate(),O.value||c(y,"value",x.f),y.node._ractive.value==_._ractive.value&&(y.node.selected=!0)),y.node.autofocus&&t.focus(y.node)),"option"===y.lcName&&(y.select=m(y.parent)),p(y)}}(R,F,a,je,c,Q,s,S,fn,Dn,Bn,Vn,zn,Kn,$n,ur,dn),hr=function(t,e){function n(t){var e,n,r,i,o
...
return o?(e.pos+=o,{type:t.TEXT,value:a.substr(0,o)}):null},r}(F,xn,Rr),Cr=function(t,e){return function(){var n,r,i
...
return r=n.pos,n.allowWhitespace(),i=e(n),null===i?(n.pos=r,null):(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),o=n.getExpression(),null===o?(n.pos=r,null):{t:t.KEY_VALUE_PAIR,k:i,v:o}):(n.pos=r,null))}}(F,Rn),Pr=function(t){return function e(n){var r,i,o,a
...
return r=n.pos,n.allowWhitespace(),n.getStringMatch("[")?(i=e(n),n.getStringMatch("]")?{t:t.ARRAY_LITERAL,m:i}:(n.pos=r,null)):(n.pos=r,null)}}(F,Fr),Br=function(t,e,n,r,i){return function(o){var a=t(o)||e(o)||n(o)||r(o)||i(o)
return a}}(An,Ir,Tn,Mr,Dr),Ur=function(t,e,n){var r,i,o,a
...
return n=e.pos,e.getStringMatch("(")?(e.allowWhitespace(),(r=e.getExpression())?(e.allowWhitespace(),e.getStringMatch(")")?{t:t.BRACKETED,x:r}:(e.pos=n,null)):(e.pos=n,null)):null}}(F),Vr=function(t,e,n){return function(r){return t(r)||e(r)||n(r)}}(Br,Ur,Wr),qr=function(t,e){return function(n){var r,i,o
if(r=n.pos,n.allowWhitespace(),n.getStringMatch(".")){if(n.allowWhitespace(),i=e(n))return{t:t.REFINEMENT,n:i}
n.expected("a property name")}return n.getStringMatch("[")?(n.allowWhitespace(),o=n.getExpression(),o||n.expected("an expression"),n.allowWhitespace(),n.getStringMatch("]")||n.expected('"]"'),{t:t.REFINEMENT,x:o}):null}}(F,Nn),zr=function(t,e,n,r){return function(i){var o,a,s,u
...
break}a={t:t.INVOCATION,x:a},u&&(a.o=u)}return a}}(F,Vr,Fr,qr),Hr=function(t,e){var n,r
...
n=s}(),n}(F,zr),Kr=function(t,e){var n,r
...
n=s}(),n}(F,Hr),$r=function(t,e){return function(n){var r,i,o,a
return(i=e(n))?(r=n.pos,n.allowWhitespace(),n.getStringMatch("?")?(n.allowWhitespace(),(o=n.getExpression())?(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),a=n.getExpression(),a?{t:t.CONDITIONAL,o:[i,o,a]}:(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):null}}(F,Kr),Gr=function(t){return function(){return t(this)}}($r),Yr=function(t,e,n,r,i,o,a){var s
...
return e=t.replace(i,function(t,e){return n[e]?String.fromCharCode(n[e]):t}),e=e.replace(o,function(t,e){return String.fromCharCode(s(parseInt(e,16)))}),e=e.replace(a,function(t,e){return String.fromCharCode(s(e))})},c=/\s+/g,e}(F),Jr=function(t,e){return function(n,r){return n.type===t.TEXT?(this.pos+=1,new e(n,r)):null}}(F,Zr),Qr=function(t){var e
...
return c=c.concat(i),r.name=1===u.length&&u[0].type===t.TEXT?u[0].value:u,c.length&&(1===c.length&&c[0].type===t.TEXT?(h=e("["+c[0].value+"]"),r.args=h?h.value:c[0].value):r.dynamicArgs=c),r}}(F,Ln),li=function(t,e){var n
...
return e},c}(F,fr,Q,ui,ci,hi,pi,gi,fi),mi=function(t){return function(e){return this.options.sanitize&&this.options.sanitize.elements&&-1!==this.options.sanitize.elements.indexOf(e.name.toLowerCase())?null:new t(e,this,this.preserveWhitespace)}}(vi),yi=function(t,e,n,r,i){var o
...
s[u]=r(i.substr(0,h.index),e),i=i.substring(h.index+h[0].length)}return{main:r(n,e),partials:s}},r}(Xr,F,yi),wi=function(){function t(t,e){var r=n.exec(e)[0]
...
return i}}(F,Ln,O,J,ki),Oi=function(){function t(t,e){var n,r,i
...
p=[],d=n(s,f.data||{},u.descriptor.a,p),r(s,f,d,c,u.descriptor.f),i(s,p),o(s,u.descriptor.v),(u.descriptor.t1||u.descriptor.t2||u.descriptor.o)&&e('The "intro", "outro" and "decorator" directives have no effect on components'),a(s)}}(F,Q,Si,Oi,Ti,Ai,Ni),Li=function(t,e){function n(t){var e,n
e=t.root
...
return a=new t(function(t){s=t}),o&&a.then(o),e.start(this,s),(u=this._wrapped[""])&&u.reset?u.reset(i)===!1&&(this.data=i):this.data=i,n(this,""),r(this,""),e.end(),this.fire("reset",i),a}}(g,R,D,A),Fi=function(t,e,n,r,i){return function(o,a,s){var u,c,h
...
return t.end(),s&&c.then(s.bind(this)),c}}(R,te,v,g,U),Di=function(t){return function(e,n){return t(this,e,void 0===n?-1:-n)}}(f),Bi=function(t,e,n,r,i){return function(o){var a,s,u,c,h,l,f,d
...
return n.end(),o&&s.then(o.bind(this)),s}}(F,_,R,g,D),Ui=function(){return this.fragment.toString()},Wi=function(t,e){var n
...
return"function"==typeof i?(o=i,i=""):i=i||"",a=new e(function(t){s=t}),t.start(this,s),n(this,i),r(this,i),t.end(),this.fire("update",i),o&&a.then(o.bind(this)),a}}(R,g,D,A),qi=function(t,e,n){function r(t,i,o,a,s){var u,c,h,l,f,d
...
return h.template&&(s(f),a(f,h),u(f)),f}}(je,h,$i,Gi,Zi,to,eo,no,ro,co,w),lo=function(t,e,n,r,i,o,a,s,u,c,h,l,f,d){var p=function(t){f(this,t)}
return p.prototype=r,n(p,{partials:{value:i},adaptors:{value:o},easing:{value:s},transitions:{value:{}},events:{value:{}},components:{value:a},decorators:{value:{}},interpolators:{value:u},defaults:{value:t.defaults},svg:{value:e},VERSION:{value:"0.4.0"}}),p.eventDefinitions=p.events,p.prototype.constructor=p,p.Promise=c,p.extend=h,p.parse=l,d.Ractive=p,p}(i,o,h,zi,Er,j,Hi,Ki,ee,g,ho,bi,uo,w),fo=function(t,e){for(var n="function";e.length;)e.pop()()
...
"undefined"!=typeof e&&e.exports?e.exports=fo:"function"==typeof define&&define.amd&&define(function(){return fo}),t.Ractive=fo,fo.noConflict=function(){return t.Ractive=n,fo}}("undefined"!=typeof window?window:this)},{}],87:[function(t,e){e.exports=function(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
return n}},{}],88:[function(t,e){function n(){return Object.create(new s)}function r(t,e){var n=Object.create(t),r=0
...
e.exports=i},{"./numberOfOccurrances":87,"./templateToolbox":89,events:100}],89:[function(t,e){function n(t){return t.metadata.markdown!==!1?h.makeHtml(t.content):t.content}function r(){return"xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g,function(t){var e=16*Math.random()|0,n="x"==t?e:3&e|8
...
e.exports={generateId:i,getPostName:o,generatePostDiv:s,isAPostDiv:a,getTemplateDataObject:u,htmlify:n}},{pagedown:93}],90:[function(t,e){e.exports=function(t){var e={}
return t.on("post changed",function(t,n){e[t]&&e[t].forEach(function(t){t.emit("post changed",n)})}),function(t){"undefined"==typeof e[t.postName]&&(e[t.postName]=[]),e[t.postName].push(t),t.ractive.on("teardown",function(){e[t.postName]=e[t.postName].filter(function(e){return e!==t})})}}},{}],91:[function(t,e,n){var r
...
return n=n.replace(/^\n+/,""),n=n.replace(/\n+$/g,""),n="\n\n~K"+(M.push(n)-1)+"K\n\n"}function o(t,n){t=I.preBlockGamut(t,D),t=d(t)
var r="<hr />\n"
return t=t.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm,r),t=t.replace(/^[ ]{0,2}([ ]?-[ ]?){3,}[ \t]*$/gm,r),t=t.replace(/^[ ]{0,2}([ ]?_[ ]?){3,}[ \t]*$/gm,r),t=p(t),t=v(t),t=E(t),t=I.postBlockGamut(t,D),t=e(t),t=_(t,n)}function a(t){return t=I.preSpanGamut(t),t=y(t),t=s(t),t=k(t),t=h(t),t=u(t),t=O(t),t=t.replace(/~P/g,"://"),t=x(t),t=w(t),t=t.replace(/  +\n/g," <br>\n"),t=I.postSpanGamut(t)}function s(t){var e=/(<[a-z\/!$]("[^"]*"|'[^']*'|[^'">])*>|<!(--(?:|(?:[^>-]|-[^>])(?:[^-]|-[^-])*)--)>)/gi
...
var D=function(t){return o(t)},B={ol:"\\d+[.]",ul:"[*+-]"},U=/(?:["'*()[\]:]|~D)/g}}()},{}],92:[function(t,e,n){!function(){function e(t){return t.replace(/<[^>]*>?/gi,r)}function r(t){return t.match(s)||t.match(u)||t.match(c)?t:""}function i(t){if(""==t)return""
...
var s=/^(<\/?(b|blockquote|code|del|dd|dl|dt|em|h1|h2|h3|i|kbd|li|ol|p|pre|s|sup|sub|strong|strike|ul)>|<(br|hr)\s?\/?>)$/i,u=/^(<a\shref="((https?|ftp):\/\/|\/)[-A-Za-z0-9+&@#\/%?=~_|!:,.;\(\)]+"(\stitle="[^"<>]+")?\s?>|<\/a>)$/i,c=/^(<img\ssrc="(https?:\/\/|\/)[-A-Za-z0-9+&@#\/%?=~_|!:,.;\(\)]+"(\swidth="\d{1,3}")?(\sheight="\d{1,3}")?(\salt="[^"<>]*")?(\stitle="[^"<>]*")?\s?\/?>)$/i}()},{"./Markdown.Converter":91}],93:[function(t,e,n){n.Converter=t("./Markdown.Converter").Converter,n.getSanitizingConverter=t("./Markdown.Sanitizer").getSanitizingConverter},{"./Markdown.Converter":91,"./Markdown.Sanitizer":92}],94:[function(t,e){!function(t){"use strict"
...
for(r in n)n.hasOwnProperty(r)&&e(t,r,n[r])}}return r}(T,N,A),L=function(t){return function(e,n,r){var i
if("string"!=typeof n||!t(r))throw new Error("Bad arguments")
if(i=+e.get(n)||0,!t(i))throw new Error("Cannot add to a non-numeric value")
...
try{Object.create(null),t=Object.create}catch(e){t=function(){var t=function(){}
return function(e,n){var r
return null===e?{}:(t.prototype=e,r=new t,n&&Object.defineProperties(r,n),r)}}()}return t}(),K={expectedExpression:"Expected a JavaScript expression",expectedParen:"Expected closing paren"},$=function(t){var e=/^(?:[+-]?)(?:(?:(?:0|[1-9]\d*)?\.\d+)|(?:(?:0|[1-9]\d*)\.)|(?:0|[1-9]\d*))(?:[eE][+-]?\d+)?/
...
return function(i){var o
return(o=t(i))?r.test(o.v)?o.v:'"'+o.v.replace(/"/g,'\\"')+'"':(o=e(i))?o.v:(o=i.matchPattern(n.name))?o:void 0}}(J,$,Q),ee=function(t,e){return function(n){var r,i,o
...
return i=n.pos,n.allowWhitespace(),a=n.readExpression(),null===a?null:(o=[a],n.allowWhitespace(),n.matchString(",")&&(s=e(n),null===s&&n.error(t.expectedExpression),s.forEach(r)),o)}}(K),oe=function(t,e){return function(n){var r,i
...
return a}}($,G,J,re,oe),se=function(t,e){var n,r,i,o,a
...
return r=n.pos,n.matchString("(")?(n.allowWhitespace(),i=n.readExpression(),i||n.error(e.expectedExpression),n.allowWhitespace(),n.matchString(")")||n.error(e.expectedParen),{t:t.BRACKETED,x:i}):null}}(z,K),ce=function(t,e,n){return function(r){return t(r)||e(r)||n(r)}}(ae,se,ue),he=function(t,e,n){return function(r){var i,o,a
if(i=r.pos,r.allowWhitespace(),r.matchString(".")){if(r.allowWhitespace(),o=r.matchPattern(n.name))return{t:t.REFINEMENT,n:o}
r.error("Expected a property name")}return r.matchString("[")?(r.allowWhitespace(),a=r.readExpression(),a||r.error(e.expectedExpression),r.allowWhitespace(),r.matchString("]")||r.error("Expected ']'"),{t:t.REFINEMENT,x:a}):null}}(z,K,Q),le=function(t,e,n,r,i){return function(o){var a,s,u,c
if(s=e(o),!s)return null
for(;s;)if(a=o.pos,u=r(o))s={t:t.MEMBER,x:s,r:u}
else{if(!o.matchString("("))break
o.allowWhitespace(),c=n(o),o.allowWhitespace(),o.matchString(")")||o.error(i.expectedParen),s={t:t.INVOCATION,x:s},c&&(s.o=c)}return s}}(z,ce,ie,he,K),fe=function(t,e,n){var r,i
...
r=s}(),r}(z,K,le),de=function(t,e){var n,r
return r=function(e,n){return function(r){var i,o,a
if(o=n(r),!o)return null
...
return(o=e(r))?(i=r.pos,r.allowWhitespace(),r.matchString("?")?(r.allowWhitespace(),a=r.readExpression(),a||r.error(n.expectedExpression),r.allowWhitespace(),r.matchString(":")||r.error('Expected ":"'),r.allowWhitespace(),s=r.readExpression(),s||r.error(n.expectedExpression),{t:t.CONDITIONAL,o:[o,a,s]}):(r.pos=i,o)):null}}(z,de,K),ge=function(t,e){function n(t){return JSON.stringify(String(t))}function r(n,i){var o,a
if(n.t===t.REFERENCE&&-1===i.indexOf(n.n)&&i.unshift(n.n),a=n.o||n.m)if(e(a))r(a,i)
else for(o=a.length;o--;)r(a[o],i)
...
return c=r}(Oe,xe,Ne),Le=function(t,e,n){function r(t){var e,r,i
...
return l}(q,A,Fe,H,Be),We=function(t,e){function n(t){var e,n=t._config.template
...
return a}(Ue,Fe),Ve=function(t){function e(t,e){this.name=t,this.useDefaults=e}function n(t,e){var r,i
...
return t.interpolate=a,o=a}(o,D,h,$e),Ye=function(t,e,n){var r=function(t){var e
this.startTime=Date.now()
for(e in t)t.hasOwnProperty(e)&&(this[e]=t[e])
...
this.running=!1,e=this.root._animations.indexOf(this),-1===e&&t("Animation was not found"),this.root._animations.splice(e,1)}},r}(D,_,Ge),Xe=function(t,e,n,r,i){function o(e,o,a,s){var c,h,l,f
...
y&&y.stop()},i}return r=r||{},r.complete&&i.then(r.complete),r.complete=a,c=o(this,t,n,r),i.stop=function(){c.stop()},i}}(y,g,I,F,Ye),Ze=function(t){return function(){return this.detached?this.detached:(this.el&&t(this.el.__ractive_instances__,this),this.detached=this.fragment.detach(),this.detached)}}(p),Je=function(t){return this.el?this.fragment.find(t):null},Qe=function(t,e,n){var r,i,o,a,s,u,c,h
...
return i}(D,q),tr=function(){var t={}
...
return t?n(e):e}},u}(z,_,zn,Hn,y,Gn,cr,Kn),lr=function(){this.parentFragment.bubble()},fr=function(){var t
...
return f.prototype={detach:n,find:r,findAll:i,firstNode:o,getValue:e.getValue,rebind:e.rebind,render:a,resolve:e.resolve,setValue:s,toString:u,unbind:l,unrender:c,update:h},f}(z,cr,Ar,Nr,Rr,Lr,Pr,Mr,Fr,Dr,Br,Gn),Wr=function(){this.parentFragment.bubble()},Vr=function(){var t,e=this.node
return e?((t=e.parentNode)&&t.removeChild(e),e):void 0},qr=function(t){return function(e){return t(this.node,e)?this.node:this.fragment&&this.fragment.find?this.fragment.find(e):void 0}}(Qe),zr=function(t,e){e._test(this,!0)&&e.live&&(this.liveQueries||(this.liveQueries=[])).push(e),this.fragment&&this.fragment.findAll(t,e)},Hr=function(t,e){this.fragment&&this.fragment.findAllComponents(t,e)},Kr=function(t){return this.fragment?this.fragment.findComponent(t):void 0},$r=function(){return null},Gr=function(){return this.node},Yr=function(t){return this.attributes&&this.attributes[t]?this.attributes[t].value:void 0},Xr=function(){var t,e,n,r
return t="altGlyph altGlyphDef altGlyphItem animateColor animateMotion animateTransform clipPath feBlend feColorMatrix feComponentTransfer feComposite feConvolveMatrix feDiffuseLighting feDisplacementMap feDistantLight feFlood feFuncA feFuncB feFuncG feFuncR feGaussianBlur feImage feMerge feMergeNode feMorphology feOffset fePointLight feSpecularLighting feSpotLight feTile feTurbulence foreignObject glyphRef linearGradient radialGradient textPath vkern".split(" "),e="attributeName attributeType baseFrequency baseProfile calcMode clipPathUnits contentScriptType contentStyleType diffuseConstant edgeMode externalResourcesRequired filterRes filterUnits glyphRef gradientTransform gradientUnits kernelMatrix kernelUnitLength keyPoints keySplines keyTimes lengthAdjust limitingConeAngle markerHeight markerUnits markerWidth maskContentUnits maskUnits numOctaves pathLength patternContentUnits patternTransform patternUnits pointsAtX pointsAtY pointsAtZ preserveAlpha preserveAspectRatio primitiveUnits refX refY repeatCount repeatDur requiredExtensions requiredFeatures specularConstant specularExponent spreadMethod startOffset stdDeviation stitchTiles surfaceScale systemLanguage tableValues targetX targetY textLength viewBox viewTarget xChannelSelector yChannelSelector zoomAndPan".split(" "),n=function(t){for(var e={},n=t.length;n--;)e[t[n].toLowerCase()]=t[n]
return e},r=n(t.concat(e)),function(t){var e=t.toLowerCase()
...
else if(r=r.substring(i+1),n.name=e(r),n.namespace=t[o.toLowerCase()],!n.namespace)throw'Unknown namespace ("'+o+'")'}}(O,Xr),ti=function(t){return function(e){var n=e.fragment.items
...
!r.pNode||r.namespace||i.pNode.namespaceURI&&i.pNode.namespaceURI!==t.html||(o=n[r.name]||r.name,void 0!==i.pNode[o]&&(r.propertyName=o),(e.test(o)||"value"===o)&&(r.useProperty=!0))}}(O,Jr),ni=function(t,e,n,r,i,o){var a
...
this.node=r,r.namespaceURI&&r.namespaceURI!==t.html||(i=n[this.name]||this.name,void 0!==r[i]&&(this.propertyName=i),(e.test(i)||"value"===i)&&(this.useProperty=!0),"value"===i&&(this.useProperty=!0,r._ractive.value=this.value)),this.rendered=!0,this.update()}}(O,Jr),oi=function(t){function e(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var n
...
return e=function(t){o.call(this,t),this.init&&this.init()},e.prototype=n(i.prototype),r(e.prototype,t),e.extend=o.extend,e},o}(_,D,H,xi,p),Si=function(){this._ractive.binding.handleChange()},Oi=function(t,e){var n=t.extend({getInitialValue:function(){return this.element.fragment?this.element.fragment.toString():""},render:function(){var t=this.element.node
...
return i}(p,ki,Si,Ti),Ri=function(t,e,n,r,i){function o(t){return t.isChecked}function a(t){return t.element.getAttribute("value")}var s=n.extend({name:"name",getInitialValue:function(){return this.noInitialValue=!0,[]},init:function(){var e,n,i
...
return s}(s,p,ki,Ti,Si),Li=function(t,e){var n=t.extend({name:"checked",render:function(){var t=this.element.node
...
this.invalid||((i=t.registries.events.find(this.root,o))?this.custom=i(this.node,r(o)):("on"+o in this.node||window&&"on"+o in window||n.error({debug:this.root.debug,message:"missingPlugin",args:{plugin:"event",name:o}}),this.node.addEventListener(o,e,!1)),this.hasListener=!0)}}($e,qi,Qn),Hi=function(t){return function(e,n,r,i){return this.method?void this.args.forEach(function(o){o.indexRef&&o.indexRef===e&&(o.value=n),o.keypath&&(i=t(o.keypath,r,i))&&(o.keypath=i)}):("string"!=typeof this.action&&this.action.rebind(e,n,r,i),void(this.dynamicParams&&this.dynamicParams.rebind(e,n,r,i)))}}(Jn),Ki=function(){this.node=this.element.node,this.node._ractive.events[this.name]=this,(this.method||this.getAction())&&this.listen()},$i=function(t,e){this.args[t]={keypath:e}},Gi=function(){function t(t){t.teardown()}var e
...
return h.prototype={bubble:t,fire:e,getAction:n,init:r,listen:i,rebind:o,render:a,resolve:s,unbind:u,unrender:c},h}(Bi,Ui,Wi,Vi,zi,Hi,Ki,$i,Gi,Yi),Zi=function(t){return function(e,n){var r,i,o,a,s=[]
...
r.actual=e,r.ready=!0},update:function(){this.actual.update?this.actual.update.apply(this.root,this.params):(this.actual.teardown(!0),this.init())},rebind:function(t,e,n,r){this.fragment&&this.fragment.rebind(t,e,n,r)},teardown:function(t){this.actual.teardown(),!t&&this.fragment&&this.fragment.unbind()}},o}(Qn,o,$e),Qi=function(t){function e(t,e){for(var n=t.length;n--;)if(t[n]==e)return!0}var n
...
this.type=t.ELEMENT,h=this.parentFragment=u.parentFragment,l=this.template=u.template,this.parent=u.pElement||h.pElement,this.root=f=h.root,this.index=u.index,this.name=e(l.e),"option"===this.name&&s(this,l),"select"===this.name&&(this.options=[],this.bubble=a),this.attributes=n(this,l.a),l.f&&(this.fragment=new c({template:l.f,root:f,owner:this,pElement:this})),f.twoway&&(d=r(this,l.a))&&(this.binding=d,p=this.root._twowayBindings[d.keypath]||(this.root._twowayBindings[d.keypath]=[]),p.push(d)),l.v&&(this.eventHandlers=i(this,l.v)),l.o&&(this.decorator=new o(this,l.o)),this.intro=l.t0||l.t1,this.outro=l.t0||l.t2}}(z,Xr,_i,Di,Zi,Ji,to,no,o),io=function(t){return function(e,n){return e===n||t(e,n)}}(Zn),oo=function(t,e){return function(n,r,i,o){var a=n[r]
...
for(r=k.length;r--;)n=k[r],t.node.style[n.name]=n.interpolator(e)+n.suffix},complete:function(){w=!0,_()}}):w=!0,h.length||(t.node.removeEventListener(f,x,!1),E=!0,_())},0)},c.delay||0)}):c=null,c}(A,D,T,co,Ge,po,ho,go,vo),yo=function(t){function e(){u.hidden=document[i]}function n(){u.hidden=!0}function r(){u.hidden=!1}var i,o,a,s,u
...
return h&&(n("t.animateStyle returns a Promise as of 0.4.0. Transition authors should do t.animateStyle(...).then(callback)"),d.then(h)),d}):s=null,s}(Ee,A,D,g,ho,mo,yo),wo=function(t,e){var n
for(n in e)!e.hasOwnProperty(n)||n in t||(t[n]=e[n])
...
s.registerTransition(m),s.scheduleTask(function(){return m.start()})}return"option"===this.name&&f(this),this.node.autofocus&&s.scheduleTask(function(){return n.node.focus()}),d(this),this.node}}(O,s,D,H,T,N,ze,_,m,so,xo),So=function(t,e,n){function r(t){var n,r,i
...
return g.prototype={bubble:t,detach:e,find:n,findAll:r,findAllComponents:i,findComponent:o,findNextNode:a,firstNode:s,getAttribute:u,init:c,rebind:h,render:l,toString:f,unbind:d,unrender:p},g}(Wr,Vr,qr,zr,Hr,Kr,$r,Gr,Yr,ro,ao,ko,So,To,Ao),Ro=function(){function t(t,e){var n=r.exec(e)[0]
...
return e.partials[o]=s.t}return t.error({debug:e.debug,message:"noTemplateForPartial",args:{name:o}}),[]}}(Qn,$e,Ue,Ro),Co=function(t,e){var n
...
return a=e.parentFragment,u=e.root,s={content:i||[]},n.defaults.el&&t.warn({debug:u.debug,message:"defaultElSpecified",args:{name:e.name}}),o=new n({el:null,append:!0,data:r,partials:s,magic:u.magic||n.defaults.magic,modifyArrays:u.modifyArrays,_parent:u,_component:e,adapt:u.adapt,"yield":{template:i,instance:u}})}}(Qn),Ko=function(t){return function(e,n){n.forEach(function(n){var r,i
...
return d.prototype={detach:t,find:e,findAll:n,findAllComponents:r,findComponent:i,findNextNode:o,firstNode:a,init:s,rebind:u,render:c,toString:h,unbind:l,unrender:f},d}(Po,Mo,Fo,Do,Bo,Uo,Wo,Yo,Xo,Zo,Jo,Qo,ta),na=function(t,e){var n=function(e){this.type=t.COMMENT,this.value=e.template.c}
return n.prototype={detach:e,firstNode:function(){return this.node},render:function(){return this.node||(this.node=document.createComment(this.value)),this.node},toString:function(){return"<!--"+this.value+"-->"},unrender:function(t){t&&this.node.parentNode.removeChild(this.node)}},n}(z,Kn),ra=function(t){var e
...
default:throw new Error("Something very strange happened. Please file an issue at https://github.com/ractivejs/ractive/issues. Thanks!")}}}(z,$n,hr,Tr,Ur,No,Io,jo,ea,na,ra),oa=function(t,e,n){return function(r){var i,o,a,s=this
...
return"string"!=typeof t&&(t="",e=!0),n(this,t,r={},e),this.set(r)}}(Ii,y),Ta=function(t,e,n,r,i,o,a,s,u,c,h,l,f,d,p,g,v,m,y,b,w,E,_,x,k,S,O,T,A,N,R,L){return{add:t,animate:e,detach:n,find:r,findAll:i,findAllComponents:o,findComponent:a,fire:s,get:u,insert:c,merge:h,observe:l,off:f,on:d,pop:p,push:g,render:v,reset:m,resetTemplate:y,reverse:b,set:w,shift:E,sort:_,splice:x,subtract:k,teardown:S,toggle:O,toHTML:T,unrender:A,unshift:N,update:R,updateModel:L}}(C,Xe,Ze,Je,cn,hn,ln,fn,dn,gn,vn,_n,Sn,On,Rn,Ln,In,fa,da,pa,ga,va,ma,ya,ba,wa,Ea,_a,xa,ka,Sa,Oa),Aa=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(t){var e,n
...
e(u,o,{value:a})}),o={},o.__proto__?(a=function(t){t.__proto__=u},s=function(t){t.__proto__=Array.prototype}):(a=function(t){var n,r
for(n=c.length;n--;)r=c[n],e(t,r,{value:u[r],configurable:!0})},s=function(t){var e
for(e=c.length;e--;)delete t[c[e]]}),a.unpatch=s,a}(_,N,Tn,An,Ra),Ca=function(t,e,n){var r,i,o
return r={filter:function(t){return e(t)&&(!t._ractive||!t._ractive.setting)},wrap:function(t,e,n){return new i(t,e,n)}},i=function(e,r,i){this.root=e,this.value=r,this.keypath=i,r._ractive||(t(r,"_ractive",{value:{wrappers:[],instances:[],setting:!1},configurable:!0}),n(r)),r._ractive.instances[e._guid]||(r._ractive.instances[e._guid]=0,r._ractive.instances.push(e)),r._ractive.instances[e._guid]+=1,r._ractive.wrappers.push(this)},i.prototype={get:function(){return this.value},teardown:function(){var t,e,r,i,a
if(t=this.value,e=t._ractive,r=e.wrappers,i=e.instances,e.setting)return!1
if(a=r.indexOf(this),-1===a)throw new Error(o)
if(r.splice(a,1),r.length){if(i[this.root._guid]-=1,!i[this.root._guid]){if(a=i.indexOf(this.root),-1===a)throw new Error(o)
...
c=l.adapt[u]=f}if(c.filter(a,i,l))return h=this.wrapped[i]=c.wrap(l,a,i,o(i)),h.value=a,a}return l.magic?r.filter(a,i,l)?this.wrapped[i]=r.wrap(l,a,i):n.filter(a,i,l)&&(this.wrapped[i]=n.wrap(l,a,i)):l.modifyArrays&&e.filter(a,i,l)&&(this.wrapped[i]=e.wrap(l,a,i)),a}}($e,Ca,k,Ia),Pa=function(t){var e,n,r,i,o=[""]
...
return i=e}(Ma),Da=function(t,e){function n(t){t.update()}function r(t,e,n){var r,i;(r=o(t,e,n))&&(i=t.get(e),r.forEach(function(t){return t.setValue(i)}))}function i(t,e,n){function r(t){t.forEach(i),t.forEach(a)}function i(e){var r=o(t,e,n)
...
return s=t(p),this.patternObservers.length&&(s.forEach(function(t){return e(f,t,!0)}),p.forEach(function(t){return e(f,t)})),u.forEach(function(t){f.deps[t]&&(s.forEach(function(e){return r(f,e,t)}),i(f,p,t))}),p.forEach(function(t){g[t]=f.get(t)}),this.implicitChanges={},g}}}(Pa,Fa),Ba=function(){this.capturing=!0,this.captured=[]},Ua=function(t,e){var n,r,i
...
do{if(a=e.indexOf(t,s),-1===a)return o=!0,-1
s=a+1}while(n[a]&&u>s)
return a===r&&(r+=1),a!==i&&(o=!0),n[a]=!0,a}),i.unchanged=!o,i},Ka=function(t,e,n){function r(e){return"function"==typeof e.merge&&(!e.subtype||e.subtype===t.SECTION_EACH)}function i(t){return JSON.stringify(t)}function o(t){if(t===!0)return i
...
l=n(u,c),l.forEach(function(e,n){-1===e&&d.mark(t+"."+n)}),this.set(t,a,!0),(f=this.deps["default"][t])&&f.filter(r).forEach(function(t){return t.merge(l)}),i.length!==a.length&&this.mark(t+".length",!0)}}(z,D,Ha),$a=function(){function t(t,e,n){var r,i,o,a
...
void 0===n&&(n={}),s(e,n),t.init(e.constructor,e,n),e.viewmodel=new i(e),e.viewmodel.compute(),e.template&&(e.fragment=new o({template:e.template,root:e,owner:e})),a(e)}}($e,H,pn,Na,rs,la),os=function(t){return function(e,n,r){e.beforeInit&&e.beforeInit(r),t(e,r)}}(is),as=function(t,e,n,r){function i(e,n,r){for(var i in r)if(!(i in c)&&r.hasOwnProperty(i)){var o=r[i]
...
return d}(r,i,h,l,S,R,Ta,g,xi,ss,Fe,is,o)
"undefined"!=typeof e&&e.exports?e.exports=us:"function"==typeof define&&define.amd&&define(function(){return us}),t.Ractive=us,us.noConflict=function(){return t.Ractive=n,us}}("undefined"!=typeof window?window:this)},{}],95:[function(){},{}],96:[function(t,e,n){function r(t,e,n){if(!(this instanceof r))return new r(t,e,n)
var i,o=typeof t
...
t[n+a]=s}return a}function o(t,e,n,r){var i=L(T(e),t,n,r)
...
var D=/[^+\/0-9A-z]/g},{"base64-js":97,ieee754:98,"is-array":99}],97:[function(t,e,n){var r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
...
t.toByteArray=n,t.fromByteArray=i}("undefined"==typeof n?this.base64js={}:n)},{}],98:[function(t,e,n){n.read=function(t,e,n,r,i){var o,a,s=8*i-r-1,u=(1<<s)-1,c=u>>1,h=-7,l=n?i-1:0,f=n?-1:1,d=t[e+l]
...
for(e=Math.abs(e),isNaN(e)||1/0===e?(s=isNaN(e)?1:0,a=h):(a=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-a))<1&&(a--,u*=2),e+=a+l>=1?f/u:f*Math.pow(2,1-l),e*u>=2&&(a++,u/=2),a+l>=h?(s=0,a=h):a+l>=1?(s=(e*u-1)*Math.pow(2,i),a+=l):(s=e*Math.pow(2,l-1)*Math.pow(2,i),a=0));i>=8;t[n+d]=255&s,d+=p,s/=256,i-=8);for(a=a<<i|s,c+=i;c>0;t[n+d]=255&a,d+=p,a/=256,c-=8);t[n+d-p]|=128*g}},{}],99:[function(t,e){var n=Array.isArray,r=Object.prototype.toString
e.exports=n||function(t){return!!t&&"[object Array]"==r.call(t)}},{}],100:[function(t,e){function n(){this._events=this._events||{},this._maxListeners=this._maxListeners||void 0}function r(t){return"function"==typeof t}function i(t){return"number"==typeof t}function o(t){return"object"==typeof t&&null!==t}function a(t){return void 0===t}e.exports=n,n.EventEmitter=n,n.prototype._events=void 0,n.prototype._maxListeners=void 0,n.defaultMaxListeners=10,n.prototype.setMaxListeners=function(t){if(!i(t)||0>t||isNaN(t))throw TypeError("n must be a positive number")
...
return n=t._events&&t._events[e]?r(t._events[e])?1:t._events[e].length:0}},{}],101:[function(t,e){var n=e.exports,r=(t("events").EventEmitter,t("./lib/request")),i=t("url")
...
var s=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)}},{stream:124,util:127}],104:[function(t,e,n){!function(){function t(t){this.message=t}var e="undefined"!=typeof n?n:this,r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
...
return s})}()},{}],105:[function(t,e){e.exports=t(40)},{}],106:[function(t,e){function n(){}var r=e.exports={}
...
r()}},!0),function(t){n.push(t),window.postMessage("process-tick","*")}}return function(t){setTimeout(t,0)}}(),r.title="browser",r.browser=!0,r.env={},r.argv=[],r.on=n,r.addListener=n,r.once=n,r.off=n,r.removeListener=n,r.removeAllListeners=n,r.emit=n,r.binding=function(){throw new Error("process.binding is not supported")},r.cwd=function(){return"/"},r.chdir=function(){throw new Error("process.chdir is not supported")}},{}],107:[function(t,e,n){(function(t){!function(r){function i(t){throw RangeError(I[t])}function o(t,e){for(var n=t.length;n--;)t[n]=e(t[n])
...
return P(r+(j+1)*t/(t+S))}function f(t){var e,n,r,o,a,s,h,f,d,p,g=[],v=t.length,m=0,y=A,b=T
...
var b,w,E=2147483647,_=36,x=1,k=26,S=38,O=700,T=72,A=128,N="-",R=/^xn--/,L=/[^ -~]/,C=/\x2E|\u3002|\uFF0E|\uFF61/g,I={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},j=_-x,P=Math.floor,M=String.fromCharCode
...
else r.punycode=b}(this)}).call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],108:[function(t,e){"use strict"
...
var r=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)}},{}],109:[function(t,e){"use strict"
...
return e}},{}],110:[function(t,e,n){"use strict"
n.decode=n.parse=t("./decode"),n.encode=n.stringify=t("./encode")},{"./decode":108,"./encode":109}],111:[function(t,e){e.exports=t("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":112}],112:[function(t,e){e.exports=t(34)},{"./_stream_readable":114,"./_stream_writable":116,Zh58VX:106,"core-util-is":117,inherits:105}],113:[function(t,e){e.exports=t(35)},{"./_stream_transform":115,"core-util-is":117,inherits:105}],114:[function(t,e){e.exports=t(36)},{Zh58VX:106,buffer:96,"core-util-is":117,events:100,inherits:105,isarray:118,stream:124,"string_decoder/":119}],115:[function(t,e){e.exports=t(37)},{"./_stream_duplex":112,"core-util-is":117,inherits:105}],116:[function(t,e){e.exports=t(38)},{"./_stream_duplex":112,Zh58VX:106,buffer:96,"core-util-is":117,inherits:105,stream:124}],117:[function(t,e){e.exports=t(39)},{buffer:96}],118:[function(t,e){e.exports=t(41)},{}],119:[function(t,e){e.exports=t(42)},{buffer:96}],120:[function(t,e){e.exports=t("./lib/_stream_passthrough.js")},{"./lib/_stream_passthrough.js":113}],121:[function(t,e){e.exports=t(43)},{"./lib/_stream_duplex.js":112,"./lib/_stream_passthrough.js":113,"./lib/_stream_readable.js":114,"./lib/_stream_transform.js":115,"./lib/_stream_writable.js":116,stream:124}],122:[function(t,e){e.exports=t("./lib/_stream_transform.js")},{"./lib/_stream_transform.js":115}],123:[function(t,e){e.exports=t("./lib/_stream_writable.js")},{"./lib/_stream_writable.js":116}],124:[function(t,e){function n(){r.call(this)}e.exports=n
...
var h=!1
return c.on("error",s),t.on("error",s),c.on("end",u),c.on("close",u),t.on("close",u),t.emit("pipe",c),t}},{events:100,inherits:105,"readable-stream/duplex.js":111,"readable-stream/passthrough.js":120,"readable-stream/readable.js":121,"readable-stream/transform.js":122,"readable-stream/writable.js":123}],125:[function(t,e,n){function r(){this.protocol=null,this.slashes=null,this.auth=null,this.host=null,this.port=null,this.hostname=null,this.hash=null,this.search=null,this.query=null,this.pathname=null,this.path=null,this.href=null}function i(t,e,n){if(t&&c(t)&&t instanceof r)return t
var i=new r
...
M.push(F.match(/[^A-Za-z0-9_-]/)?"xn--"+f.encode(F):F)}this.hostname=M.join(".")}var D=this.port?":"+this.port:"",B=this.hostname||""
this.host=B+D,this.href+=this.host,g&&(this.hostname=this.hostname.substr(1,this.hostname.length-2),"/"!==r[0]&&(r="/"+r))}if(!x[o])for(var c=0,T=m.length;T>c;c++){var U=m[c],W=encodeURIComponent(U)
W===U&&(W=escape(U)),r=r.split(U).join(W)}var V=r.indexOf("#");-1!==V&&(this.hash=r.substr(V),r=r.slice(0,V))
var q=r.indexOf("?")
if(-1!==q?(this.search=r.substr(q),this.query=r.substr(q+1),e&&(this.query=O.parse(this.query)),r=r.slice(0,q)):e&&(this.search="",this.query={}),r&&(this.pathname=r),S[o]&&this.hostname&&!this.pathname&&(this.pathname="/"),this.pathname||this.search){var D=this.pathname||"",F=this.search||""
...
e&&(e=e[0],":"!==e&&(this.port=e.substr(1)),t=t.substr(0,t.length-e.length)),t&&(this.hostname=t)}},{punycode:107,querystring:110}],126:[function(t,e){e.exports=function(t){return t&&"object"==typeof t&&"function"==typeof t.copy&&"function"==typeof t.fill&&"function"==typeof t.readUInt8}},{}],127:[function(t,e,n){(function(e,r){function i(t,e){var r={seen:[],stylize:a}
...
return t}}).call(this,t("Zh58VX"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./support/isBuffer":126,Zh58VX:106,inherits:105}]},{},[2])
