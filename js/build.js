...
t.createKeyStream().on("data",function(e){t.del(e)})}}},{"level-js":5,levelup:27}],2:[function(t){var e=t("noddity-butler"),n=t("levelup"),r=t("level-js"),i=t("noddity-linkifier"),o=t("localstorage-down"),s=t("./routing"),a=t("./mainViewModel"),u=t("level-sublevel"),c=noddityConfig,h=window.indexedDB?r:function(t){return new o(t)},f=u(n("noddity-content",{db:h})),l=c.title.replace(/[^\w]+/g,""),p=c.debug?{refreshEvery:3e4}:void 0,d=new e(c.noddityRoot,f.sublevel(l),p),g=new i(c.pathPrefix+c.pagePathPrefix),v=new a(d,g),m=s()
m.on("current",v.setCurrent),c.debug&&(window.debug=t("./debug"))},{"./debug":1,"./mainViewModel":3,"./routing":4,"level-js":5,"level-sublevel":13,levelup:27,"localstorage-down":51,"noddity-butler":62,"noddity-linkifier":88}],3:[function(t,e){function n(){}var r=t("ractive"),i=noddityConfig,o=t("noddity-renderer")
...
return i.sidebar&&t.getPost(i.sidebar,function(t,e){t?g.set("html",t.message):h.populateRootRactive(e,g)}),e.on("link",function(e){t.getPost(e,n)}),t.on("post changed",c),t.on("index changed",a),{setCurrent:u}}},{"noddity-renderer":89,ractive:99}],4:[function(t,e){var n=noddityConfig,r=t("events").EventEmitter
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:110}],8:[function(t,e){(function(t){function n(t){this.db=t,this._ended=!1,this._nexting=!1}n.prototype.next=function(e){var n=this
...
return this._ended?e(new Error("end() already called on iterator")):(this._ended=!0,"function"==typeof this._end?this._end(e):void t.nextTick(e))},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:110}],9:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
...
if(this._isBuffer(t)){if(0===t.length)return new Error(e+" cannot be an empty Buffer")}else if(""===String(t))return new Error(e+" cannot be an empty String")},e.exports.AbstractLevelDOWN=i,e.exports.AbstractIterator=o}).call(this,t("Zh58VX"),t("buffer").Buffer)},{"./abstract-chained-batch":7,"./abstract-iterator":8,Zh58VX:110,buffer:101}],10:[function(t,e){!function(t,n,r){"function"==typeof define?define(n):"undefined"!=typeof e&&e.exports?e.exports=n():r[t]=n()}("IDBStore",function(){"use strict"
...
e.exports=n},{buffer:101}],12:[function(t,e){function n(t,e,n,r){var i={type:t,key:e,value:n,options:r}
...
i.clear=function(){this._operations=[]},i.write=function(t){this._sdb.batch(this._operations,t)},e.exports=r},{}],13:[function(t,e){(function(n){var r=(t("events").EventEmitter,n.nextTick,t("./sub")),i=t("./batch"),o=t("level-fix-range"),s=t("level-hooks")
...
var h=u.batch
return u.batch=function(t,e,n){return Array.isArray(t)?(t.forEach(function(t){t.prefix&&("function"==typeof t.prefix.prefix?t.key=t.prefix.prefix(t.key):"string"==typeof t.prefix&&(t.key=t.prefix+t.key))}),void h.call(u,t,e,n)):new i(u)},u}}).call(this,t("Zh58VX"))},{"./batch":12,"./sub":24,Zh58VX:110,events:104,"level-fix-range":14,"level-hooks":16}],14:[function(t,e){var n=t("clone")
e.exports=function(t){t=n(t)
var e=t.reverse,r=t.max||t.end,i=t.min||t.start,o=[i,r]
return null!=i&&null!=r&&o.sort(),e&&(o=o.reverse()),t.start=o[0],t.end=o[1],delete t.min,delete t.max,t}},{clone:15}],15:[function(t,e){(function(t){"use strict"
...
var e=function(){}
return e.prototype=t,new e}}).call(this,t("buffer").Buffer)},{buffer:101}],16:[function(t,e){var n=t("string-range")
...
return a(!1,r,e,n)},t.batch=function(t,e,n){return a(!0,t,e,n)}}}},{"string-range":17}],17:[function(t,e,n){{var r=n.range=function(t){return null==t?{}:"string"==typeof r?{min:r,max:r+"ÿ"}:t},i=(n.prefix=function(t,e,r){t=n.range(t)
var i={}
...
n.satisfies=function(t,e){return i(e)(t)}}},{}],18:[function(t,e){function n(t){return null!==t&&("object"==typeof t||"function"==typeof t)}e.exports=n},{}],19:[function(t,e){function n(){for(var t={},e=0;e<arguments.length;e++){var n=arguments[e]
if(i(n))for(var o=r(n),s=0;s<o.length;s++){var a=o[s]
t[a]=n[a]}}return t}var r=t("object-keys"),i=t("./has-keys")
e.exports=n},{"./has-keys":18,"object-keys":20}],20:[function(t,e){e.exports=Object.keys||t("./shim")},{"./shim":23}],21:[function(t,e){var n=Object.prototype.hasOwnProperty,r=Object.prototype.toString
...
else for(var a in t)n.call(t,a)&&e.call(i,t[a],a,t)}},{}],22:[function(t,e){var n=Object.prototype,r=n.hasOwnProperty,i=n.toString,o=function(t){return t!==t},s={"boolean":1,number:1,string:1,undefined:1},a=e.exports={}
...
return r||t>=e&&n>=t},a.object=function(t){return t&&"[object Object]"===i.call(t)},a.hash=function(t){return a.object(t)&&t.constructor===Object&&!t.nodeType&&!t.setInterval},a.regexp=function(t){return"[object RegExp]"===i.call(t)},a.string=function(t){return"[object String]"===i.call(t)}},{}],23:[function(t,e){!function(){"use strict"
...
return s&&o(a,function(e){r.call(t,e)&&n.push(e)}),n},e.exports=n}()},{foreach:21,is:22}],24:[function(t,e){function n(t,e,r){if("string"==typeof r&&(console.error("db.sublevel(name, seperator<string>) is depreciated"),console.error("use db.sublevel(name, {sep: separator})) if you must"),r={sep:r}),!(this instanceof n))return new n(t,e,r)
...
e.exports=n},{"./batch":12,events:104,"level-fix-range":14,"string-range":17,util:131,xtend:19}],25:[function(t,e){function n(t){this._levelup=t,this.batch=t.db.batch(),this.ops=[]}var r=t("./util"),i=t("./errors").WriteError,o=r.getOptions,s=r.dispatchError
...
try{this.batch.write(function(r){return r?s(e,new i(r),t):(e.emit("batch",n),void(t&&t()))})}catch(r){throw new i(r)}},e.exports=n},{"./errors":26,"./util":29}],26:[function(t,e){var n=t("errno").create,r=n("LevelUPError"),i=n("NotFoundError",r)
i.prototype.notFound=!0,i.prototype.status=404,e.exports={LevelUPError:r,InitializationError:n("InitializationError",r),OpenError:n("OpenError",r),ReadError:n("ReadError",r),WriteError:n("WriteError",r),NotFoundError:i,EncodingError:n("EncodingError",r)}},{errno:37}],27:[function(t,e){(function(n){function r(t,e){return"function"==typeof t?t:e}function i(t,e,r){if(!(this instanceof i))return new i(t,e,r)
var o
...
return t=u(this.options,t),new m(t,this,function(t){return e.db.iterator(t)})},i.prototype.keyStream=i.prototype.createKeyStream=function(t){return this.createReadStream(u(t,{keys:!0,values:!1}))},i.prototype.valueStream=i.prototype.createValueStream=function(t){return this.createReadStream(u(t,{keys:!1,values:!0}))},i.prototype.writeStream=i.prototype.createWriteStream=function(t){return new y(u(t),this)},i.prototype.toString=function(){return"LevelUP"},e.exports=i,e.exports.copy=b.copy,e.exports.destroy=o("destroy"),e.exports.repair=o("repair")}).call(this,t("Zh58VX"))},{"./batch":25,"./errors":26,"./read-stream":28,"./util":29,"./write-stream":30,Zh58VX:110,"deferred-leveldown":32,events:104,prr:38,util:131,xtend:49}],28:[function(t,e){function n(t,e,i){if(!(this instanceof n))return new n(t,e,i)
...
e.exports={defaultOptions:w,copy:i,getOptions:o,getLevelDOWN:s,dispatchError:a,encodeKey:h,encodeValue:f,isValueAsBuffer:d,isKeyAsBuffer:g,decodeValue:p,decodeKey:l}}).call(this,t("Zh58VX"),t("buffer").Buffer)},{"../package.json":50,"./errors":26,Zh58VX:110,buffer:101,leveldown:100,"leveldown/package":100,semver:100,xtend:49}],30:[function(t,e){(function(n,r){function i(t,e){if(!(this instanceof i))return new i(t,e)
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._write?this._write(n):"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:110}],34:[function(t,e){e.exports=t(8)},{Zh58VX:110}],35:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
if("string"!=typeof t)throw new Error("constructor requires a location string argument")
...
return n})},{}],39:[function(t,e){(function(n){function r(t){return this instanceof r?(u.call(this,t),c.call(this,t),t&&t.readable===!1&&(this.readable=!1),t&&t.writable===!1&&(this.writable=!1),this.allowHalfOpen=!0,t&&t.allowHalfOpen===!1&&(this.allowHalfOpen=!1),void this.once("end",i)):new r(t)}function i(){this.allowHalfOpen||this._writableState.ended||n.nextTick(this.end.bind(this))}function o(t,e){for(var n=0,r=t.length;r>n;n++)e(t[n],n)}e.exports=r
...
a.inherits(r,u),o(s(c.prototype),function(t){r.prototype[t]||(r.prototype[t]=c.prototype[t])})}).call(this,t("Zh58VX"))},{"./_stream_readable":41,"./_stream_writable":43,Zh58VX:110,"core-util-is":44,inherits:45}],40:[function(t,e){function n(t){return this instanceof n?void r.call(this,t):new n(t)}e.exports=n
var r=t("./_stream_transform"),i=t("core-util-is")
i.inherits=t("inherits"),i.inherits(n,r),n.prototype._transform=function(t,e,n){n(null,t)}},{"./_stream_transform":42,"core-util-is":44,inherits:45}],41:[function(t,e){(function(n){function r(e){e=e||{}
...
null!==t.writechunk&&t.writecb&&!t.transforming?(t.transforming=!0,this._transform(t.writechunk,t.writeencoding,t.afterTransform)):t.needTransform=!0}},{"./_stream_duplex":39,"core-util-is":44,inherits:45}],43:[function(t,e){(function(n){function r(t,e,n){this.chunk=t,this.encoding=e,this.callback=n}function i(t,e){t=t||{}
...
e+=r.slice(0,n).toString(i)}return e}},{buffer:101}],48:[function(t,e,n){n=e.exports=t("./lib/_stream_readable.js"),n.Readable=n,n.Writable=t("./lib/_stream_writable.js"),n.Duplex=t("./lib/_stream_duplex.js"),n.Transform=t("./lib/_stream_transform.js"),n.PassThrough=t("./lib/_stream_passthrough.js")},{"./lib/_stream_duplex.js":39,"./lib/_stream_passthrough.js":40,"./lib/_stream_readable.js":41,"./lib/_stream_transform.js":42,"./lib/_stream_writable.js":43}],49:[function(t,e){function n(){for(var t={},e=0;e<arguments.length;e++){var n=arguments[e]
for(var r in n)n.hasOwnProperty(r)&&(t[r]=n[r])}return t}e.exports=n},{}],50:[function(t,e){e.exports={name:"levelup",description:"Fast & simple storage - a Node.js-style LevelDB wrapper",version:"0.18.6",contributors:[{name:"Rod Vagg",email:"r@va.gg",url:"https://github.com/rvagg"},{name:"John Chesley",email:"john@chesl.es",url:"https://github.com/chesles/"},{name:"Jake Verbaten",email:"raynos2@gmail.com",url:"https://github.com/raynos"},{name:"Dominic Tarr",email:"dominic.tarr@gmail.com",url:"https://github.com/dominictarr"},{name:"Max Ogden",email:"max@maxogden.com",url:"https://github.com/maxogden"},{name:"Lars-Magnus Skog",email:"lars.magnus.skog@gmail.com",url:"https://github.com/ralphtheninja"},{name:"David Björklund",email:"david.bjorklund@gmail.com",url:"https://github.com/kesla"},{name:"Julian Gruber",email:"julian@juliangruber.com",url:"https://github.com/juliangruber"},{name:"Paolo Fragomeni",email:"paolo@async.ly",url:"https://github.com/hij1nx"},{name:"Anton Whalley",email:"anton.whalley@nearform.com",url:"https://github.com/No9"},{name:"Matteo Collina",email:"matteo.collina@gmail.com",url:"https://github.com/mcollina"},{name:"Pedro Teixeira",email:"pedro.teixeira@gmail.com",url:"https://github.com/pgte"},{name:"James Halliday",email:"mail@substack.net",url:"https://github.com/substack"}],repository:{type:"git",url:"https://github.com/rvagg/node-levelup.git"},homepage:"https://github.com/rvagg/node-levelup",keywords:["leveldb","stream","database","db","store","storage","json"],main:"lib/levelup.js",dependencies:{bl:"~0.8.1","deferred-leveldown":"~0.2.0",errno:"~0.1.1",prr:"~0.0.0","readable-stream":"~1.0.26",semver:"~2.3.1",xtend:"~3.0.0"},devDependencies:{leveldown:"~0.10.0",bustermove:"*",tap:"*",referee:"*",rimraf:"*",async:"*",fstream:"*",tar:"*",mkfiletree:"*",readfiletree:"*","slow-stream":">=0.0.4",delayed:"*",boganipsum:"*",du:"*",memdown:"*","msgpack-js":"*"},browser:{leveldown:!1,"leveldown/package":!1,semver:!1},scripts:{test:"tap test/*-test.js --stderr",functionaltests:"node ./test/functional/fstream-test.js && node ./test/functional/binary-data-test.js && node ./test/functional/compat-test.js",alltests:"npm test && npm run-script functionaltests"},license:"MIT",gitHead:"213e989e2b75273e2b44c23f84f95e35bff7ea11",bugs:{url:"https://github.com/rvagg/node-levelup/issues"},_id:"levelup@0.18.6",_shasum:"e6a01cb089616c8ecc0291c2a9bd3f0c44e3e5eb",_from:"levelup@~0.18.2",_npmVersion:"1.4.14",_npmUser:{name:"rvagg",email:"rod@vagg.org"},maintainers:[{name:"rvagg",email:"rod@vagg.org"}],dist:{shasum:"e6a01cb089616c8ecc0291c2a9bd3f0c44e3e5eb",tarball:"http://registry.npmjs.org/levelup/-/levelup-0.18.6.tgz"},directories:{},_resolved:"https://registry.npmjs.org/levelup/-/levelup-0.18.6.tgz",readme:"ERROR: No README data found!"}},{}],51:[function(t,e){(function(n,r,i){function o(t,e){f.call(this,t)
new i(0)
...
for(var e=this._keys.length;e>=0;e--)this._keys[e]===t&&(this._keys.splice(e,1),window.localStorage.removeItem(t))},r.prototype.clear=function(){window.localStorage.clear()},r.prototype.length=function(){return this._keys.length},n.localStorage=r},{}],53:[function(t,e){e.exports=t(33)},{Zh58VX:110}],54:[function(t,e){e.exports=t(8)},{Zh58VX:110}],55:[function(t,e,n){arguments[4][35][0].apply(n,arguments)},{"./abstract-chained-batch":53,"./abstract-iterator":54,Zh58VX:110,buffer:101,xtend:57}],56:[function(t,e){e.exports=t(18)},{}],57:[function(t,e,n){arguments[4][19][0].apply(n,arguments)},{"./has-keys":56,"object-keys":59}],58:[function(t,e){var n=Object.prototype.hasOwnProperty,r=Object.prototype.toString,i=function(t){var e="function"==typeof t&&!(t instanceof RegExp)||"[object Function]"===r.call(t)
...
else for(o in t)n.call(t,o)&&(null===u?e(t[o],o,t):e.call(u,t[o],o,t))}},{}],59:[function(t,e,n){arguments[4][20][0].apply(n,arguments)},{"./shim":61}],60:[function(t,e){var n=Object.prototype.toString
e.exports=function r(t){var e=n.call(t),r="[object Arguments]"===e
return r||(r="[object Array]"!==e&&null!==t&&"object"==typeof t&&"number"==typeof t.length&&t.length>=0&&"[object Function]"===n.call(t.callee)),r}},{}],61:[function(t,e){!function(){"use strict"
...
return i=r(),i.noConflict=function(){return e&&(e[t]=o),i},i})},{}],67:[function(t,e){function n(t){if(!t||"[object Object]"!==i.call(t)||t.nodeType||t.setInterval)return!1
...
return u}},{}],68:[function(t,e){var n=t("stringmap"),r=t("level-sublevel"),i=t("asynquence"),o=t("events").EventEmitter,s=t("expire-unused-keys"),a=t("extend")
...
return v.on("expire",f),g.on("expire",h),y.stop=c,y.get=function(t,e){d.get(t,function(n,r){n&&n.notFound?f(t,l(t,e)):e&&l(t,e)(n,r)})},y.getLocal=function(t,e){d.get(t,l(t,e))},y.refresh=function(t,e){f(t,l(t,e))},y}},{asynquence:66,events:104,"expire-unused-keys":69,extend:67,"level-sublevel":13,stringmap:70}],69:[function(t,e){function n(t){function e(){n=!1}var n=!1
...
e.exports=function(t){return u.extend(t)}},{extend:67}],88:[function(t,e){function n(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
...
m||(e(u,c+".length"),n(u,c+".length",!0))}}}(F,B,T,U),q=function(t,e,n,r,i){var o,s,a,u=[],c=["pop","push","reverse","shift","sort","splice","unshift"]
...
for(e=c.length;e--;)delete t[c[e]]}),s.unpatch=a,s}(C,c,P,M,V),W=function(t,e,n){var r,i,o
...
i.splice(s,1)}}else delete t._ractive,n.unpatch(this.value)}},o="Something went wrong in a rather interesting way",r}(c,I,q),z=function(t,e,n,r,i){function o(e,n,o){function s(e){var o,s
...
i=n+"="+r,s=t.bindings,s[i]||(s[i]=!0,o=t.instance,a=t.parentFragment.priority,c=new u(e,n,o,r,a),s.push(c),o.twoway&&(h=new u(o,r,e,n,1),s.push(h),c.counterpart=h,h.counterpart=c))}}(w,C,I,d,K,X),G=function(t,e,n){function r(t,r,i,o,s){n(r,o,s,!0),e(r.component,t,i,o)}var i
...
while(o=o.parent)
return a=i(n,e),void 0!==a?(r(n,t,e,e,a),a):void 0}}(w,Z,U),J={FAILED_LOOKUP:!0},Q=function(t,e,n,r,i,o){function s(t,e,n){var s,u,c,h,f=t._cache
...
return a=i.split("."),u=a.pop(),c=a.join("."),h=s(t,c),(p=t._wrapped[c])&&(h=p.get()),null!==h&&void 0!==h?((f=t._cacheMap[c])?-1===f.indexOf(i)&&f.push(i):t._cacheMap[c]=[i],"object"!=typeof h||u in h?(d=!e.call(h,u),l=d?n(h[u]):h[u],l=r(t,i,l,!1),t._cache[i]=l,l):t._cache[i]=o):void 0}return t.get=s,s}(w,k,L,$,G,J),Y=function(){return"undefined"!=typeof console&&"function"==typeof console.warn&&"function"==typeof console.warn.apply?function(){console.warn.apply(console,arguments)}:function(){}}(),te=function(){var t=Object.prototype.toString
...
return v=o(l,p),m=new r(function(t){y=t}),t.start(this,y),i(this,a,c,!0),s(this,a,v,g),t.end(),h&&h.complete&&m.then(h.complete),m}}(C,Y,I,g,U,ke,Se),Ae=function(t,e,n){var r=function(t,e,n,r){var i=this
...
if(t=this.value,r=n(this.root,this.keypath),this.value=r,!this.updating){if(this.updating=!0,!e(r,t)||!this.ready)try{this.callback.call(this.context,r,t,this.keypath)}catch(i){if(this.debug||this.root.debug)throw i}this.updating=!1}}},r}(C,d,Q),Te=function(t){return function(e,n){var r,i,o,s,a,u,c
...
return this.proxies[t]||(this.proxies[t]={update:function(){e.reallyUpdate(t)}}),this.proxies[t]}},i}(C,d,Q,Te),Ce=function(t,e,n,r,i){var o=/\*/,s={}
...
l&&(t=a._patternObservers.indexOf(f),-1!==t&&a._patternObservers.splice(t,1)),n(f)}}}}(v,K,X,Ae,Ne),Re=function(t,e){return function(n,r,i){var o,s,a,u
if(t(n)){i=r,s=n,o=[]
...
this.selfUpdating=this.refs.length+this.softRefs.length<=1}},c}(C,Y,d,B,T,$,Ke,Xe),Ge=function(t,e,n,r,i){function o(t,e){return t.replace(/\$\{([0-9]+)\}/g,function(t,n){return e[n]?e[n].value||e[n].keypath:"undefined"})}function s(t){return"${"+t.replace(/[\.\[\]]/g,"-")+"}"}var a=function(r,i,o,s){var a,u,c,h=this
...
s.keypath&&(a=i(s.keypath,n,r))?(s.keypath=a,o=!0):s.indexRef===t&&(s.value=e,o=!0)}),o&&this.bubble()}},a}(E,O,$e,Ze,Be),Je=function(t,e,n,r,i,o,s){var a=function(i,o,a){var c,h,f,l,p,d=this
...
for(i=this.nodes.length,r=0;i>r;r+=1)if(o=this.nodes[r],1===o.nodeType&&(e(o,t)&&n.push(o),s=o.querySelectorAll(t)))for(a=s.length,u=0;a>u;u+=1)n.push(s[u])}},o}(F,ae,nn,qe,He),ln=function(t){return function(e,n){return e.a&&e.a.xmlns?e.a.xmlns:"svg"===e.e?t.svg:n.namespaceURI||t.html}}(s),pn=function(){var t,e,n,r
...
t(s),this.argsList=[i]}this.dirty=!1}return this.argsList}}(Y,Rn),Mn=function(t,e,n,r,i,o,s,a){var u=function(t){n.init(this,t)}
...
this.actual=t,this.ready=!0},update:function(){this.actual.update?this.actual.update.apply(this.root,this.params):(this.actual.teardown(!0),this.init())},teardown:function(t){this.actual.teardown(),!t&&this.fragment&&this.fragment.teardown()}},n}(Y,Mn),zn=function(t,e){return function(n,r,i){var o=new e(n,r,i)
o.fn&&(i.decorator=o,t.addDecorator(i.decorator))}}(C,Wn),Hn=function(t,e){var n,r,i,o,s,a,u,c,h
...
e.index=n.index,e.keypath=n.keypath,e.context=n.root.get(n.keypath),n.events[t].fire(e)}},n}(Y,Mn),$n=function(t){return function(e,n){var r,i,o
...
return i}}(r,u,I,Zn),Jn=function(t){return function(e,n){var r
if("string"==typeof e)this.node.style[t(e)]=n
else for(r in e)e.hasOwnProperty(r)&&(this.node.style[t(r)]=e[r])
return this}}(Zn),Qn=function(t){return t.replace(/-([a-zA-Z])/g,function(t,e){return e.toUpperCase()})},Yn=function(t,e,n){function r(t){return t}var i=function(i){var o
...
for(r=y.length;r--;)n=y[r],t.node.style[n.name]=n.interpolator(e)},complete:function(){w=!0,_()}}):w=!0,h.length||(t.node.removeEventListener(f,l,!1),E=!0,_())},0)},c.delay||0)}}(u,Y,a,Qn,ne,Yn,Zn,tr,er),rr=function(t,e,n,r,i,o){var s
...
return a&&(n("t.animateStyle returns a Promise as of 0.4.0. Transition authors should do t.animateStyle(...).then(callback)"),h.then(a)),h}}(r,u,Y,g,Zn,nr),ir=function(t,e){var n
...
return void t(u)}},u.prototype={init:n,getStyle:r,setStyle:i,animateStyle:o,processParams:s,resetStyle:a},u}(Y,Mn,Xn,Gn,Jn,rr,or,sr),ur=function(t,e){return function(n,r,i,o){var s,a,u
...
break}s={t:t.INVOCATION,x:s},u&&(s.o=u)}return s}}(F,qr,Fr,Wr),Hr=function(t,e){var n,r
...
return(i=e(n))?(r=n.pos,n.allowWhitespace(),n.getStringMatch("?")?(n.allowWhitespace(),(o=n.getExpression())?(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),s=n.getExpression(),s?{t:t.CONDITIONAL,o:[i,o,s]}:(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):null}}(F,$r),Xr=function(t){return function(){return t(this)}}(Kr),Zr=function(t,e,n,r,i,o,s){var a
...
return i}}(F,Rn,O,Q,ki),Oi=function(){function t(t,e){var n,r,i
...
t(r,r.root,i.parentKeypath,i.childKeypath),o=e(r.instance,i.childKeypath),s=e(r.root,i.parentKeypath),void 0!==o&&void 0===s&&n(r.root,i.parentKeypath,o)})}}(Z,Q,U),Ti=function(t){function e(e,r,i,o){if("string"!=typeof o){if(r.debug)throw new Error(n)
...
d=[],p=n(a,l.data||{},u.descriptor.a,d),r(a,l,p,c,u.descriptor.f),i(a,d),o(a,u.descriptor.v),(u.descriptor.t1||u.descriptor.t2||u.descriptor.o)&&e('The "intro", "outro" and "decorator" directives have no effect on components'),s(a)}}(F,Y,Si,Oi,Ai,Ti,Ni),Ri=function(t,e){function n(t){var e,n
e=t.root
...
return"function"==typeof i?(o=i,i=""):i=i||"",s=new e(function(t){a=t}),t.start(this,a),n(this,i),r(this,i),t.end(),this.fire("update",i),o&&s.then(o.bind(this)),s}}(C,g,B,T),Wi=function(t,e,n){function r(t,i,o,s,a){var u,c,h,f,l,p
...
return r=n.split(",").map(t),i=r.map(u).join(", ")+" ",e.replace(n,i)})}}(),Ji=function(t,e,n,r){return function(i,o){t.forEach(function(t){o[t]&&(i[t]=e(o[t]))}),n(i,"defaults",{value:e(o.defaults)}),o.css&&n(i,"css",{value:o.defaults.noCssTransform?o.css:r(o.css,i._guid)})}}(Zi,je,c,Gi),Qi=function(t,e){return/_super/.test(t)?function(){var n,r=this._super
...
u.css&&n(a,"css",{value:a.defaults.noCssTransform?u.css:o(u.css,a._guid)})}}(i,Zi,c,Qi,Yi,Gi),eo=function(t,e){return function(n,r){t(n.defaults.template)&&(n.partials||(n.partials={}),e(n.partials,n.defaults.template.partials),r.partials&&e(n.partials,r.partials),n.defaults.template=n.defaults.template.main)}}(te,Yi),no=function(t,e,n){return function(r){var i
...
return(r=n.matchPattern(e))?{t:t.NUMBER_LITERAL,v:r}:null}}(q),$=function(t){return function(e){var n=e.remaining()
return"true"===n.substr(0,4)?(e.pos+=4,{t:t.BOOLEAN_LITERAL,v:"true"}):"false"===n.substr(0,5)?(e.pos+=5,{t:t.BOOLEAN_LITERAL,v:"false"}):null}}(q),K=function(){var t,e,n
...
return s+='"',JSON.parse(s)}}}(),X=function(t){return t('"')}(K),Z=function(t){return t("'")}(K),G=function(t,e,n){return function(r){var i,o
return i=r.pos,r.matchString('"')?(o=n(r),r.matchString('"')?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):r.matchString("'")?(o=e(r),r.matchString("'")?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):null}}(q,X,Z),J={name:/^[a-zA-Z_$][a-zA-Z_$0-9]*/},Q=function(t,e,n){var r=/^[a-zA-Z_$][a-zA-Z_$0-9]*$/
return function(i){var o
return(o=t(i))?r.test(o.v)?o.v:'"'+o.v.replace(/"/g,'\\"')+'"':(o=e(i))?o.v:(o=i.matchPattern(n.name))?o:void 0}}(G,H,J),Y=function(t,e){return function(n){var r,i,o
return r=n.pos,n.allowWhitespace(),i=e(n),null===i?(n.pos=r,null):(n.allowWhitespace(),n.matchString(":")?(n.allowWhitespace(),o=n.readExpression(),null===o?(n.pos=r,null):{t:t.KEY_VALUE_PAIR,k:i,v:o}):(n.pos=r,null))}}(q,Q),te=function(t){return function e(n){var r,i,o,s
...
return r=n.pos,n.allowWhitespace(),n.matchString("{")?(i=e(n),n.allowWhitespace(),n.matchString("}")?{t:t.OBJECT_LITERAL,m:i}:(n.pos=r,null)):(n.pos=r,null)}}(q,te),ne=function(t){return function e(n){function r(t){o.push(t)}var i,o,s,a
...
return r=n.pos,n.allowWhitespace(),n.matchString("[")?(i=e(n),n.matchString("]")?{t:t.ARRAY_LITERAL,m:i}:(n.pos=r,null)):(n.pos=r,null)}}(q,ne),ie=function(t,e,n,r,i){return function(o){var s=t(o)||e(o)||n(o)||r(o)||i(o)
return s}}(H,$,G,ee,re),oe=function(t,e){var n,r,i,o,s
...
return r.matchString("(")&&(p=f.lastIndexOf("."),-1!==p?(f=f.substr(0,p),r.pos=a+f.length):r.pos-=1),{t:t.REFERENCE,n:f.replace(/^this\./,"./").replace(/^this$/,".")}}}(q,J),se=function(t,e){return function(n){var r,i
return r=n.pos,n.matchString("(")?(n.allowWhitespace(),i=n.readExpression(),i||n.error(e.expectedExpression),n.allowWhitespace(),n.matchString(")")||n.error(e.expectedParen),{t:t.BRACKETED,x:i}):null}}(q,z),ae=function(t,e,n){return function(r){return t(r)||e(r)||n(r)}}(ie,oe,se),ue=function(t,e,n){return function(r){var i,o,s
if(i=r.pos,r.allowWhitespace(),r.matchString(".")){if(r.allowWhitespace(),o=r.matchPattern(n.name))return{t:t.REFINEMENT,n:o}
r.error("Expected a property name")}return r.matchString("[")?(r.allowWhitespace(),s=r.readExpression(),s||r.error(e.expectedExpression),r.allowWhitespace(),r.matchString("]")||r.error("Expected ']'"),{t:t.REFINEMENT,x:s}):null}}(q,z,J),ce=function(t,e,n,r,i){return function(o){var s,a,u,c
if(a=e(o),!a)return null
for(;a;)if(s=o.pos,u=r(o))a={t:t.MEMBER,x:a,r:u}
else{if(!o.matchString("("))break
o.allowWhitespace(),c=n(o),o.allowWhitespace(),o.matchString(")")||o.error(i.expectedParen),a={t:t.INVOCATION,x:a},c&&(a.o=c)}return a}}(q,ae,ne,ue,z),he=function(t,e,n){var r,i
...
r=a}(),r}(q,z,ce),fe=function(t,e){var n,r
return r=function(e,n){return function(r){var i,o,s
if(o=n(r),!o)return null
...
o={t:t.INFIX_OPERATOR,s:e,o:[o,s]}}}},function(){var t,i,o,s,a
for(s="* / % + - << >> >>> < <= > >= in instanceof == != === !== & ^ | && ||".split(" "),a=e,t=0,i=s.length;i>t;t+=1)o=r(s[t],a),a=o
n=a}(),n}(q,he),le=function(t,e,n){return function(r){var i,o,s,a
return(o=e(r))?(i=r.pos,r.allowWhitespace(),r.matchString("?")?(r.allowWhitespace(),s=r.readExpression(),s||r.error(n.expectedExpression),r.allowWhitespace(),r.matchString(":")||r.error('Expected ":"'),r.allowWhitespace(),a=r.readExpression(),a||r.error(n.expectedExpression),{t:t.CONDITIONAL,o:[o,s,a]}):(r.pos=i,o)):null}}(q,fe,z),pe=function(t,e){function n(t){return JSON.stringify(String(t))}function r(n,i){var o,s
if(n.t===t.REFERENCE&&-1===i.indexOf(n.n)&&i.unshift(n.n),s=n.o||n.m)if(e(s))r(s,i)
else for(o=s.length;o--;)r(s[o],i)
...
return r(t,n),e={r:n,s:i(this,t,n)}}}(q,u),de=function(t,e,n,r,i){var o,s,a=/^\s+/
...
return r.extend=o.extend,r},t.Parser=o,o}(o,W,s,le,pe),ge=function(){var t=/^[^\s=]+/,e=/^\s+/
...
return function(t){var n=e[t.str.charAt(t.pos)]
return n?(t.pos+=1,n):null}}(q),ye=function(t){return{"if":t.SECTION_IF,unless:t.SECTION_UNLESS,"with":t.SECTION_WITH,each:t.SECTION_EACH}}(q),be=null,we=function(t,e,n){function r(e,n){for(var r,i=[];n.t===t.MEMBER&&n.r.t===t.REFINEMENT;)r=n.r,i.unshift(r.x?r.x.t===t.REFERENCE?r.x:e.flattenExpression(r.x):r.n),n=n.x
...
d.t===t.REFERENCE?f.r=d.n:d.t===t.NUMBER_LITERAL&&s.test(d.v)?f.r=d.v:(b=r(n,d))?f.rx=b:f.x=n.flattenExpression(d)}return(g=n.matchPattern(o))&&(f.i=g),f}}(q,me,ye,be),Ee=function(t,e,n,r,i){function o(t){var e
...
return function(n){var r
return n.matchString("</")?(r=n.matchPattern(e))?{t:t.CLOSING_TAG,e:r}:(n.pos-=2,void n.error("Illegal closing tag")):null}}(q),Te=function(t,e){function n(t){var e,n,i
...
return n.result}}(de,G,Q),Ce=function(t){return function(e){var n,r,i,o,s,a
...
return c=[n,r,u,i,o],u}(q,xe,Ee,_e,Oe,Ae,Te,Ce),Ie=function(){var t=/^[ \t\f\r\n]+/,e=/[ \t\f\r\n]+$/
...
return t}}(q),je=function(t,e,n,r,i,o,s,a){function u(e,n,r,i,o,c){var h,l,p,m,y,b,w,E,_
...
return f}(V,O,je,W,Me),Be=function(t,e){function n(t){var e,n=t._config.template
...
return n(t,function(t){return t[r.name][e]?t:void 0})}},e}(W,be),Ue=function(t,e){var n=["adaptors","components","computed","decorators","easing","events","interpolators","partials","transitions"],r=t(n,function(t){return new e(t,"computed"===t)})
return r}(Pe,De),Ve=function(){},qe=function(t){function e(e,n){var r
if(n in e){var i=e[n]
...
return i._parent=t,i._method=r,i}}(Ve),We=function(t,e){function n(e,n,i){if(n in e){if(i in e)throw new Error(r(n,i,!0))
...
return l.keys=Object.keys(n).concat(o.map(function(t){return t.name})).concat(["css"]),l.parseOptions=i,l.registries=o,l.extend=function(t,e,n){c("extend",t,e,n)},l.init=function(t,e,n){c("init",t,e,n),e._config&&(e._config.options=n)},l.reset=function(t){return l.filter(function(e){return e.reset&&e.reset(t)}).map(function(t){return t.name})},l}(B,U,r,Be,Me,Ue,qe,We),He=function(t,e,n,r){function i(t){return function(){return t}}var o=function(t,o,s,a){if(t===o)return i(o)
...
y&&y.stop()}}}return r=r||{},r.complete&&i.then(r.complete),r.complete=a,c=o(this,t,n,r),i.stop=function(){c.stop()},i}}(v,p,R,P,$e),Xe=function(t){return function(){return this.el&&t(this.el.__ractive_instances__,this),this.fragment.detach()}}(l),Ze=function(t){return this.el?this.fragment.find(t):null},Ge=function(t,e,n){var r,i,o,s,a,u,c,h
...
return r}(O,I,S),Je=function(t){return function(e,n){var r=this._isComponentQuery?!this.selector||e.name===this.selector:t(e.node,this.selector)
return r?(this.push(e.node||e.instance),n||this._makeDirty(),!0):void 0}}(Ge),Qe=function(){var t,e,n
...
return t(h,{selector:{value:a},live:{value:u},_isComponentQuery:{value:c},_test:{value:e}}),u?(t(h,{cancel:{value:n},_root:{value:s},_sort:{value:r},_makeDirty:{value:i},_remove:{value:o},_dirty:{value:!1,writable:!0}}),h):h}}(T,Je,Qe,en,nn,rn),sn=function(t){return function(e,n){var r,i
...
return function(n){return n.replace(t,"&lt;").replace(e,"&gt;")}}(),qn=function(t){return t&&t.parentNode&&t.parentNode.removeChild(t),t},Wn=function(t){return function(){return t(this.node)}}(qn),zn=function(t,e,n){var r=function(e){this.type=t.TEXT,this.text=e.template}
return r.prototype={detach:n,firstNode:function(){return this.node},render:function(){return this.node||(this.node=document.createTextNode(this.text)),this.node},toString:function(t){return t?e(this.text):this.text},unrender:function(t){return t?this.detach():void 0}},r}(q,Vn,Wn),Hn=function(t){return function(){this.keypath?this.root.viewmodel.unregister(this.keypath,this):t.removeUnresolved(this),this.resolver&&this.resolver.teardown()}}(w),$n=function(){return this.value},Kn=function(t){var e=function(e,n,r,i){this.root=e,this.ref=n,this.parentFragment=r,this.resolve=i,t.addUnresolved(this)}
return e.prototype={teardown:function(){t.removeUnresolved(this)}},e}(w),Xn=function(t,e){return t.substr(0,e.length+1)===e+"."},Zn=function(t){return function(e,n,r){return e===n?r:t(e,n)?e.replace(n+".",r+"."):void 0}}(Xn),Gn=function(t,e){function n(t){var n=e[t.message]||t.message||""
...
return i}(M,V),Jn=function(t,e,n){var r,i
...
this.explicitDependencies.concat(this.dependencies).forEach(function(e){return t.viewmodel.unregister(e,t,"computed")}),this.root.viewmodel.evaluators[this.keypath]=null}},a}(Gn,v,A,Jn),Yn=function(t,e,n,r,i){function o(t,e){return t.replace(/\$\{([0-9]+)\}/g,function(t,n){var r=e[n]
...
this.args.forEach(function(s){var a
s&&(s.keypath&&(a=i(s.keypath,n,r))?(s.keypath=a,o=!0):s.indexRef&&s.indexRef===t&&(s.value=e,o=!0))}),o&&this.bubble()}},a}(l,y,Kn,Qn,Zn),tr=function(t,e,n,r,i){var o=function(r,o,s){var a,u,c,h,f,l=this
...
c=n(o.root,u,o.parentFragment),void 0!==c?o.resolve(c):(o.ref=u,e.addUnresolved(o))}s.template.x&&(o.resolver=new i(o,l,s.template.x,a)),s.template.rx&&(o.resolver=new r(o,s.template.rx,a)),o.template.n!==t.SECTION_UNLESS||o.hasOwnProperty("value")||o.setValue(void 0)}}(q,w,y,er,Yn),rr=function(t){var e,n,r
...
this.fragments&&this.fragments.forEach(function(t){return t.rebind(e,n,r,i)}),this.resolver&&this.resolver.rebind(e,n,r,i),this.keypath?(o=t(this.keypath,r,i))&&this.resolve(o):void 0!==e&&this.indexRef===e&&this.setValue(n)}}(Zn),or=function(t,e,n,r){return{getValue:t,init:e,resolve:n,rebind:r}}($n,nr,rr,ir),sr=function(t,e,n,r,i,o,s){var a=function(e){this.type=t.INTERPOLATOR,o.init(this,e)}
...
return t?n(e):e}},a}(q,w,Vn,qn,Hn,or,Wn),ar=function(){this.parentFragment.bubble()},ur=function(){var t
...
n.context=i.keypath+"."+t,n.index=t,e=new f(n),i.fragmentsToRender.push(i.fragments[t]=e)}),this.fragmentsToCreate.length=0):o(this,t)&&(this.bubble(),this.rendered&&r.addView(this)),this.value=t,this.updating=!1)}}(q,a,u,w,o),yr=function(t,e){function n(t){t.unbind()}function r(t,e){var n,r=[]
...
return y.prototype={bubble:n,detach:r,find:i,findAll:o,findAllComponents:s,findComponent:a,findNextNode:u,firstNode:c,getValue:e.getValue,merge:h,rebind:e.rebind,render:f,resolve:e.resolve,setValue:l,splice:p,toString:d,unbind:g,unrender:v,update:m},y}(q,or,ar,ur,cr,hr,fr,lr,pr,dr,gr,vr,mr,yr,br,wr,Er,_r),kr=function(){var t,e
if(this.docFrag){for(t=this.nodes.length,e=0;t>e;e+=1)this.docFrag.appendChild(this.nodes[e])
...
if(o=i.querySelector(e))return o}return null}}(Ge),Or=function(t){return function(e,n){var r,i,o,s,a,u
for(i=this.nodes.length,r=0;i>r;r+=1)if(o=this.nodes[r],1===o.nodeType&&(t(o,e)&&n.push(o),s=o.querySelectorAll(e)))for(a=s.length,u=0;a>u;u+=1)n.push(s[u])}}(Ge),Ar=function(){return this.rendered&&this.nodes[0]?this.nodes[0]:this.parentFragment.findNextNode(this)},Tr=function(t,e){function n(t){return o[t]||(o[t]=e(t))}var r,i,o={}
...
return l.prototype={detach:n,find:r,findAll:i,firstNode:o,getValue:e.getValue,rebind:e.rebind,render:s,resolve:e.resolve,setValue:a,toString:u,unbind:f,unrender:c,update:h},l}(q,or,kr,Sr,Or,Ar,Rr,Ir,Lr,jr,Pr,Hn),Fr=function(){this.parentFragment.bubble()},Br=function(){var t,e=this.node
return e?((t=e.parentNode)&&t.removeChild(e),e):void 0},Dr=function(t){return function(e){return t(this.node,e)?this.node:this.fragment&&this.fragment.find?this.fragment.find(e):void 0}}(Ge),Ur=function(t,e){e._test(this,!0)&&e.live&&(this.liveQueries||(this.liveQueries=[])).push(e),this.fragment&&this.fragment.findAll(t,e)},Vr=function(t,e){this.fragment&&this.fragment.findAllComponents(t,e)},qr=function(t){return this.fragment?this.fragment.findComponent(t):void 0},Wr=function(){return null},zr=function(){return this.node},Hr=function(t){return this.attributes&&this.attributes[t]?this.attributes[t].value:void 0},$r=function(){var t,e,n,r
return t="altGlyph altGlyphDef altGlyphItem animateColor animateMotion animateTransform clipPath feBlend feColorMatrix feComponentTransfer feComposite feConvolveMatrix feDiffuseLighting feDisplacementMap feDistantLight feFlood feFuncA feFuncB feFuncG feFuncR feGaussianBlur feImage feMerge feMergeNode feMorphology feOffset fePointLight feSpecularLighting feSpotLight feTile feTurbulence foreignObject glyphRef linearGradient radialGradient textPath vkern".split(" "),e="attributeName attributeType baseFrequency baseProfile calcMode clipPathUnits contentScriptType contentStyleType diffuseConstant edgeMode externalResourcesRequired filterRes filterUnits glyphRef gradientTransform gradientUnits kernelMatrix kernelUnitLength keyPoints keySplines keyTimes lengthAdjust limitingConeAngle markerHeight markerUnits markerWidth maskContentUnits maskUnits numOctaves pathLength patternContentUnits patternTransform patternUnits pointsAtX pointsAtY pointsAtZ preserveAlpha preserveAspectRatio primitiveUnits refX refY repeatCount repeatDur requiredExtensions requiredFeatures specularConstant specularExponent spreadMethod startOffset stdDeviation stitchTiles surfaceScale systemLanguage tableValues targetX targetY textLength viewBox viewTarget xChannelSelector yChannelSelector zoomAndPan".split(" "),n=function(t){for(var e={},n=t.length;n--;)e[t[n].toLowerCase()]=t[n]
return e},r=n(t.concat(e)),function(t){var e=t.toLowerCase()
...
else if(r=r.substring(i+1),n.name=e(r),n.namespace=t[o.toLowerCase()],!n.namespace)throw'Unknown namespace ("'+o+'")'}}(k,$r),Zr=function(t){return function(e){var n=e.fragment.items
if(1===n.length)return n[0].type===t.INTERPOLATOR?n[0]:void 0}}(q),Gr=function(t){var e={"accept-charset":"acceptCharset",accesskey:"accessKey",bgcolor:"bgColor","class":"className",codebase:"codeBase",colspan:"colSpan",contenteditable:"contentEditable",datetime:"dateTime",dirname:"dirName","for":"htmlFor","http-equiv":"httpEquiv",ismap:"isMap",maxlength:"maxLength",novalidate:"noValidate",pubdate:"pubDate",readonly:"readOnly",rowspan:"rowSpan",tabindex:"tabIndex",usemap:"useMap"}
return function(n,r){var i
...
return e=function(t){o.call(this,t),this.init&&this.init()},e.prototype=n(i.prototype),r(e.prototype,t),e.extend=o.extend,e},o}(w,M,W,mi,l),bi=function(){this._ractive.binding.handleChange()},wi=function(t,e){var n=t.extend({getInitialValue:function(){return this.element.fragment?this.element.fragment.toString():""},render:function(){var t=this.element.node
...
return a}}(Ui),qi=function(t,e,n){var r,i,o
...
r.actual=e,r.ready=!0},update:function(){this.actual.update?this.actual.update.apply(this.root,this.params):(this.actual.teardown(!0),this.init())},teardown:function(t){this.actual.teardown(),!t&&this.fragment&&this.fragment.unbind()}},o}(Gn,o,ze),Wi=function(t){function e(t,e){for(var n=t.length;n--;)if(t[n]==e)return!0}return function(n){var r,i,o,s,a
...
this.dirty||(this.dirty=!0,t.scheduleTask(function(){e(n),n.dirty=!1})),this.parentFragment.bubble()}}(w,Wi),Hi=function(t){do if("select"===t.name)return t
...
this.type=t.ELEMENT,h=this.parentFragment=u.parentFragment,f=this.template=u.template,this.parent=u.pElement||h.pElement,this.root=l=h.root,this.index=u.index,this.name=e(f.e),"option"===this.name&&a(this,f),"select"===this.name&&(this.options=[],this.bubble=s),this.attributes=n(this,f.a),f.f&&(this.fragment=new c({template:f.f,root:l,owner:this,pElement:this})),l.twoway&&(p=r(this,f.a))&&(this.binding=p,d=this.root._twowayBindings[p.keypath]||(this.root._twowayBindings[p.keypath]=[]),d.push(p)),f.v&&(this.eventHandlers=i(this,f.v)),f.o&&(this.decorator=new o(this,f.o)),this.intro=f.t0||f.t1,this.outro=f.t0||f.t2}}(q,$r,vi,Ii,Vi,qi,zi,$i,o),Xi=function(t){return function(e,n){return e===n||t(e,n)}}(Xn),Zi=function(t,e){return function(n,r,i,o){var s=n[r]
s&&!t(s,o)&&t(s,i)&&(n[r]=e(s,i,o))}}(Xi,Zn),Gi=function(t){return function(e,n,r,i){function o(t){t.rebind(e,n,r,i)}var s,a,u,c
...
this.node&&(a=this.node._ractive)&&(t(a,"keypath",r,i),void 0!=e&&(a.index[e]=n))}}(Zi),Ji=function(t){var e,n,r;((e=t.getAttribute("width"))||(n=t.getAttribute("height")))&&t.node.addEventListener("load",r=function(){e&&(t.node.width=e.value),n&&(t.node.height=n.value),t.node.removeEventListener("load",r,!1)},!1)},Qi=function(t,e,n){var r,i={}
return n.push(function(){r=n.Fragment}),function(n,o,s){var a,u,c,h=this
return h.element=n,h.root=a=n.root,h.isIntro=s,u=o.n||o,"string"!=typeof u&&(c=new r({template:u,root:a,owner:n}),u=c.toString(),c.unbind()),h.name=u,o.a?h.params=o.a:o.d&&(c=new r({template:o.d,root:a,owner:n}),h.params=c.getValue(i),c.unbind()),h._fn=e.registries.transitions.find(a,u),h._fn?void 0:void t.error({debug:a.debug,message:"missingPlugin",args:{plugin:"transition",name:u}})}}(Gn,ze,o),Yi=function(t){return t.replace(/-([a-zA-Z])/g,function(t,e){return e.toUpperCase()})},to=function(t,e,n,r){var i,o,s
...
break}return o[t]}):i=null,i}(O,I,S,Yi),eo=function(t,e,n,r){var i,o
...
for(r=k.length;r--;)n=k[r],t.node.style[n.name]=n.interpolator(e)+n.suffix},complete:function(){w=!0,_()}}):w=!0,h.length||(t.node.removeEventListener(l,x,!1),E=!0,_())},0)},c.delay||0)}):c=null,c}(O,M,S,Yi,He,ro,to,io,oo),ao=function(t){function e(){u.hidden=document[i]}function n(){u.hidden=!0}function r(){u.hidden=!1}var i,o,s,a,u
...
a.registerTransition(m),a.scheduleTask(function(){return m.start()})}return"option"===this.name&&l(this),this.node.autofocus&&a.scheduleTask(function(){return n.node.focus()}),p(this),this.node}}(k,a,M,W,S,A,Ve,w,g,Ji,lo),go=function(t,e){function n(t){var n,r,i
...
return g.prototype={bubble:t,detach:e,find:n,findAll:r,findAllComponents:i,findComponent:o,findNextNode:s,firstNode:a,getAttribute:u,init:c,rebind:h,render:f,toString:l,unbind:p,unrender:d},g}(Fr,Br,Dr,Ur,Vr,qr,Wr,zr,Hr,Ki,Gi,po,go,mo,yo),wo=function(){function t(t,e){var r=n.exec(e)[0]
return null===t||r.length<t.length?r:t}var e=/^\s*$/,n=/^\s*/
return function(n){var r,i,o,s
...
return e.partials[o]=a.t}return t.error({debug:e.debug,message:"noTemplateForPartial",args:{name:o}}),[]}}(Gn,ze,Fe,wo),_o=function(t,e){var n
...
return r=this.fragment.toString(e),i=this.parentFragment.items[this.index-1],i&&i.type===t.TEXT?(o=i.template.split("\n").pop(),(s=/^\s+$/.exec(o))?n(r,s[0]):r):r},find:function(t){return this.fragment.find(t)},findAll:function(t,e){return this.fragment.findAll(t,e)},findComponent:function(t){return this.fragment.findComponent(t)},findAllComponents:function(t,e){return this.fragment.findAllComponents(t,e)},getValue:function(){return this.fragment.getValue()}},i}(q,Eo,_o,o),ko=function(t,e,n){var r
...
return a}}(q,Ne,y,Io),jo=function(t,e,n,r){var i,o,s,a
...
for(r in n)n.hasOwnProperty(r)&&e(t.instance,t.root,r,n[r])}}(Gn),Fo=function(t){var e,n
...
l=[],f=n(this,u.defaults.data||{},a.template.a,l),r(this,u,f,a.template.f),i(this,l),o(this,a.template.v),(a.template.t1||a.template.t2||a.template.o)&&e('The "intro", "outro" and "decorator" directives have no effect on components'),s(this)}}(q,M,Lo,jo,Po,Mo,Fo),Do=function(t,e){return function(n,r,i,o){var s,a,u=this.instance,c=u._parent
this.bindings.forEach(function(t){var n
t.root===c&&(n=e(t.keypath,i,o))&&t.rebind(n)}),this.complexParameters.forEach(function(t){t.rebind(n,r,i,o)}),(s=this.indexRefBindings[n])&&(t.addViewmodel(u.viewmodel),u.viewmodel.set(s,r)),(a=this.root._liveComponentQueries["_"+this.name])&&a._makeDirty()}}(w,Zn),Uo=function(){var t=this.instance
return t.render(this.parentFragment.getNode()),this.rendered=!0,t.detach()},Vo=function(){return this.instance.fragment.toString()},qo=function(){function t(t){t.unbind()}function e(t){var e,n
e=t.root
do(n=e._liveComponentQueries["_"+t.name])&&n._remove(t)
while(e=e._parent)}return function(){this.complexParameters.forEach(t),this.bindings.forEach(t),e(this),this.instance.fragment.unbind()}}(),Wo=function(t){this.instance.fire("teardown"),this.shouldDestroy=t,this.instance.unrender()},zo=function(t,e,n,r,i,o,s,a,u,c,h,f,l){var p=function(t,e){this.init(t,e)}
return p.prototype={detach:t,find:e,findAll:n,findAllComponents:r,findComponent:i,findNextNode:o,firstNode:s,init:a,rebind:u,render:c,toString:h,unbind:f,unrender:l},p}(So,Oo,Ao,To,No,Co,Ro,Bo,Do,Uo,Vo,qo,Wo),Ho=function(t,e){var n=function(e){this.type=t.COMMENT,this.value=e.template.c}
return n.prototype={detach:e,firstNode:function(){return this.node},render:function(){return this.node||(this.node=document.createComment(this.value)),this.node},toString:function(){return"<!--"+this.value+"-->"},unrender:function(t){t&&this.node.parentNode.removeChild(this.node)}},n}(q,Wn),$o=function(t,e,n,r,i,o,s,a,u,c){return function(h){if("string"==typeof h.template)return new e(h)
...
default:throw new Error("Something very strange happened. Please file an issue at https://github.com/ractivejs/ractive/issues. Thanks!")}}}(q,zn,sr,xr,Mr,bo,xo,ko,zo,Ho),Ko=function(t,e,n){return function(r){var i,o,s,a=this
...
for(s in o)this.indexRefs[s]=o[s]}this.priority=i?i.priority+1:1,r.indexRef&&(this.indexRefs||(this.indexRefs={}),this.indexRefs[r.indexRef]=r.index),"string"==typeof r.template?r.template=[r.template]:r.template||(r.template=[]),this.items=r.template.map(function(t,e){return n({parentFragment:a,pElement:r.pElement,template:t,index:e})}),this.value=this.argsList=null,this.dirtyArgs=this.dirtyValue=!0,this.inited=!0}}(q,W,$o),Xo=function(t){return function(e,n,r,i){t(this,"context",r,i),this.indexRefs&&void 0!==this.indexRefs[e]&&(this.indexRefs[e]=n),this.items.forEach(function(t){t.rebind&&t.rebind(e,n,r,i)})}}(Zi),Zo=function(){var t
return 1===this.items.length?t=this.items[0].render():(t=document.createDocumentFragment(),this.items.forEach(function(e){t.appendChild(e.render())})),this.rendered=!0,t},Go=function(t){return this.items?this.items.map(function(e){return e.toString(t)}).join(""):""},Jo=function(){function t(t){t.unbind&&t.unbind()}return function(){this.items.forEach(t)}}(),Qo=function(t){if(!this.rendered)throw new Error("Attempted to unrender a fragment that was not rendered")
...
return"string"!=typeof e&&t.errorOnly({debug:this.debug,messsage:"badArguments",arg:{arguments:e}}),r=this.get(e),this.set(e,!r,n)}}(Gn),hs=function(){return this.fragment.toString(!0)},fs=function(t,e,n){return function(){var r,i,o=this
...
f=n(u,c),f.forEach(function(e,n){-1===e&&p.mark(t+"."+n)}),this.set(t,s,!0),(l=this.deps["default"][t])&&l.filter(r).forEach(function(t){return t.merge(f)}),i.length!==s.length&&this.mark(t+".length",!0)}}(q,M,Ls),Ps=function(){function t(t,e,n){var r,i,o,s
...
n.balance&&o.mark(t+".length",!0),(i=o.deps["default"][t])&&i.filter(e).forEach(function(t){return t.splice(n)})}}(q),Ds=function(){var t,e=this
...
return new Function(n)}var e=/\$\{([^\}]+)\}/g
return function(e){return"function"==typeof e?{get:e}:"string"==typeof e?{get:t(e)}:("object"==typeof e&&"string"==typeof e.get&&(e={get:t(e.get),set:e.set}),e)}}(),qs=function(t,e,n){var r=function(t,e,n){this.ractive=t,this.viewmodel=t.viewmodel,this.key=e,this.getter=n.get,this.setter=n.set,this.dependencies=[],this.update()}
...
this.compute()&&!e(this.value,t)&&this.ractive.viewmodel.mark(this.key)}},r}(Gn,v,Jn),Ws=function(t,e){return function(n,r){var i,o
for(i in r)o=t(r[i]),n.viewmodel.computations[i]=new e(n,i,o)}}(Vs,qs),zs=function(){function t(t){return"string"==typeof t&&(t=[t]),t}var e={lookup:function(t,e){var n,r=t.adapt
...
void 0===n&&(n={}),a(e,n),t.init(e.constructor,e,n),e.viewmodel=new i(e),e.viewmodel.compute(),e.template&&(e.fragment=new o({template:e.template,root:e,owner:e})),e.viewmodel.applyChanges(),s(e)}}(ze,W,fn,ms,Hs,Yo),Ks=function(t){return function(e,n,r){e.beforeInit&&e.beforeInit(r),t(e,r)}}($s),Xs=function(t,e,n,r){function i(e,n,r){for(var i in r)if(!(i in u)&&r.hasOwnProperty(i)){var o=r[i]
...
return p}(r,i,h,f,x,T,gs,p,mi,Zs,je,$s,o)
"undefined"!=typeof e&&e.exports?e.exports=Gs:"function"==typeof define&&define.amd&&define(function(){return Gs}),t.Ractive=Gs,Gs.noConflict=function(){return t.Ractive=n,Gs}}("undefined"!=typeof window?window:this)},{}],100:[function(){},{}],101:[function(t,e,n){function r(t,e,n){if(!(this instanceof r))return new r(t,e,n)
var i,o=typeof t
...
var o=e.length
q(o%2===0,"Invalid hex string"),r>o/2&&(r=o/2)
for(var s=0;r>s;s++){var a=parseInt(e.substr(2*s,2),16)
q(!isNaN(a),"Invalid hex string"),t[n+s]=a}return s}function o(t,e,n,r){var i=F(L(e),t,n,r)
...
return i}function h(t,e,n){return W.fromByteArray(0===e&&n===t.length?t:t.slice(e,n))}function f(t,e,n){var r="",i=""
...
return i}function v(t,e,n,r){r||(q("boolean"==typeof n,"missing or invalid endian"),q(void 0!==e&&null!==e,"missing offset"),q(e+1<t.length,"Trying to read beyond buffer length"))
var i=t.length
if(!(e>=i)){var o
return n?(o=t[e],i>e+1&&(o|=t[e+1]<<8)):(o=t[e]<<8,i>e+1&&(o|=t[e+1])),o}}function m(t,e,n,r){r||(q("boolean"==typeof n,"missing or invalid endian"),q(void 0!==e&&null!==e,"missing offset"),q(e+3<t.length,"Trying to read beyond buffer length"))
var i=t.length
if(!(e>=i)){var o
return n?(i>e+2&&(o=t[e+2]<<16),i>e+1&&(o|=t[e+1]<<8),o|=t[e],i>e+3&&(o+=t[e+3]<<24>>>0)):(i>e+1&&(o=t[e+1]<<16),i>e+2&&(o|=t[e+2]<<8),i>e+3&&(o|=t[e+3]),o+=t[e]<<24>>>0),o}}function y(t,e,n,r){r||(q("boolean"==typeof n,"missing or invalid endian"),q(void 0!==e&&null!==e,"missing offset"),q(e+1<t.length,"Trying to read beyond buffer length"))
var i=t.length
if(!(e>=i)){var o=v(t,e,n,!0),s=32768&o
return s?-1*(65535-o+1):o}}function b(t,e,n,r){r||(q("boolean"==typeof n,"missing or invalid endian"),q(void 0!==e&&null!==e,"missing offset"),q(e+3<t.length,"Trying to read beyond buffer length"))
var i=t.length
if(!(e>=i)){var o=m(t,e,n,!0),s=2147483648&o
return s?-1*(4294967295-o+1):o}}function w(t,e,n,r){return r||(q("boolean"==typeof n,"missing or invalid endian"),q(e+3<t.length,"Trying to read beyond buffer length")),z.read(t,e,n,23,4)}function E(t,e,n,r){return r||(q("boolean"==typeof n,"missing or invalid endian"),q(e+7<t.length,"Trying to read beyond buffer length")),z.read(t,e,n,52,8)}function _(t,e,n,r,i){i||(q(void 0!==e&&null!==e,"missing value"),q("boolean"==typeof r,"missing or invalid endian"),q(void 0!==n&&null!==n,"missing offset"),q(n+1<t.length,"trying to write beyond buffer length"),D(e,65535))
var o=t.length
if(!(n>=o)){for(var s=0,a=Math.min(o-n,2);a>s;s++)t[n+s]=(e&255<<8*(r?s:1-s))>>>8*(r?s:1-s)
return n+2}}function x(t,e,n,r,i){i||(q(void 0!==e&&null!==e,"missing value"),q("boolean"==typeof r,"missing or invalid endian"),q(void 0!==n&&null!==n,"missing offset"),q(n+3<t.length,"trying to write beyond buffer length"),D(e,4294967295))
var o=t.length
if(!(n>=o)){for(var s=0,a=Math.min(o-n,4);a>s;s++)t[n+s]=e>>>8*(r?s:3-s)&255
return n+4}}function k(t,e,n,r,i){i||(q(void 0!==e&&null!==e,"missing value"),q("boolean"==typeof r,"missing or invalid endian"),q(void 0!==n&&null!==n,"missing offset"),q(n+1<t.length,"Trying to write beyond buffer length"),U(e,32767,-32768))
var o=t.length
if(!(n>=o))return e>=0?_(t,e,n,r,i):_(t,65535+e+1,n,r,i),n+2}function S(t,e,n,r,i){i||(q(void 0!==e&&null!==e,"missing value"),q("boolean"==typeof r,"missing or invalid endian"),q(void 0!==n&&null!==n,"missing offset"),q(n+3<t.length,"Trying to write beyond buffer length"),U(e,2147483647,-2147483648))
var o=t.length
if(!(n>=o))return e>=0?x(t,e,n,r,i):x(t,4294967295+e+1,n,r,i),n+4}function O(t,e,n,r,i){i||(q(void 0!==e&&null!==e,"missing value"),q("boolean"==typeof r,"missing or invalid endian"),q(void 0!==n&&null!==n,"missing offset"),q(n+3<t.length,"Trying to write beyond buffer length"),V(e,3.4028234663852886e38,-3.4028234663852886e38))
var o=t.length
if(!(n>=o))return z.write(t,e,n,r,23,4),n+4}function A(t,e,n,r,i){i||(q(void 0!==e&&null!==e,"missing value"),q("boolean"==typeof r,"missing or invalid endian"),q(void 0!==n&&null!==n,"missing offset"),q(n+7<t.length,"Trying to write beyond buffer length"),V(e,1.7976931348623157e308,-1.7976931348623157e308))
var o=t.length
...
break
default:throw new Error("Unknown encoding")}return n},r.concat=function(t,e){if(q(C(t),"Usage: Buffer.concat(list[, length])"),0===t.length)return new r(0)
if(1===t.length)return t[0]
var n
if(void 0===e)for(e=0,n=0;n<t.length;n++)e+=t[n].length
var i=new r(e),o=0
for(n=0;n<t.length;n++){var s=t[n]
s.copy(i,o),o+=s.length}return i},r.compare=function(t,e){q(r.isBuffer(t)&&r.isBuffer(e),"Arguments must be Buffers")
...
break
default:throw new Error("Unknown encoding")}return i},r.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}},r.prototype.equals=function(t){return q(r.isBuffer(t),"Argument must be a Buffer"),0===r.compare(this,t)},r.prototype.compare=function(t){return q(r.isBuffer(t),"Argument must be a Buffer"),r.compare(this,t)},r.prototype.copy=function(t,e,n,i){var o=this
if(n||(n=0),i||0===i||(i=this.length),e||(e=0),i!==n&&0!==t.length&&0!==o.length){q(i>=n,"sourceEnd < sourceStart"),q(e>=0&&e<t.length,"targetStart out of bounds"),q(n>=0&&n<o.length,"sourceStart out of bounds"),q(i>=0&&i<=o.length,"sourceEnd out of bounds"),i>this.length&&(i=this.length),t.length-e<i-n&&(i=t.length-e+n)
var s=i-n
...
var $=/[^+\/0-9A-z]/g},{"base64-js":102,ieee754:103}],102:[function(t,e,n){var r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
...
t.toByteArray=n,t.fromByteArray=i}("undefined"==typeof n?this.base64js={}:n)},{}],103:[function(t,e,n){n.read=function(t,e,n,r,i){var o,s,a=8*i-r-1,u=(1<<a)-1,c=u>>1,h=-7,f=n?i-1:0,l=n?-1:1,p=t[e+f]
...
return a})}()},{}],109:[function(t,e){e.exports=t(45)},{}],110:[function(t,e){function n(){}var r=e.exports={}
...
n.decode=n.parse=t("./decode"),n.encode=n.stringify=t("./encode")},{"./decode":112,"./encode":113}],115:[function(t,e){e.exports=t("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":116}],116:[function(t,e){e.exports=t(39)},{"./_stream_readable":118,"./_stream_writable":120,Zh58VX:110,"core-util-is":121,inherits:109}],117:[function(t,e){e.exports=t(40)},{"./_stream_transform":119,"core-util-is":121,inherits:109}],118:[function(t,e){e.exports=t(41)},{Zh58VX:110,buffer:101,"core-util-is":121,events:104,inherits:109,isarray:122,stream:128,"string_decoder/":123}],119:[function(t,e){e.exports=t(42)},{"./_stream_duplex":116,"core-util-is":121,inherits:109}],120:[function(t,e){e.exports=t(43)},{"./_stream_duplex":116,Zh58VX:110,buffer:101,"core-util-is":121,inherits:109,stream:128}],121:[function(t,e){e.exports=t(44)},{buffer:101}],122:[function(t,e){e.exports=t(46)},{}],123:[function(t,e){e.exports=t(47)},{buffer:101}],124:[function(t,e){e.exports=t("./lib/_stream_passthrough.js")},{"./lib/_stream_passthrough.js":117}],125:[function(t,e){e.exports=t(48)},{"./lib/_stream_duplex.js":116,"./lib/_stream_passthrough.js":117,"./lib/_stream_readable.js":118,"./lib/_stream_transform.js":119,"./lib/_stream_writable.js":120}],126:[function(t,e){e.exports=t("./lib/_stream_transform.js")},{"./lib/_stream_transform.js":119}],127:[function(t,e){e.exports=t("./lib/_stream_writable.js")},{"./lib/_stream_writable.js":120}],128:[function(t,e){function n(){r.call(this)}e.exports=n
...
var W=r.indexOf("?")
if(-1!==W?(this.search=r.substr(W),this.query=r.substr(W+1),e&&(this.query=O.parse(this.query)),r=r.slice(0,W)):e&&(this.search="",this.query={}),r&&(this.pathname=r),S[o]&&this.hostname&&!this.pathname&&(this.pathname="/"),this.pathname||this.search){var B=this.pathname||"",F=this.search||""
...
return t}}).call(this,t("Zh58VX"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./support/isBuffer":130,Zh58VX:110,inherits:109}]},{},[2])
